...
pub(super) fn calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_mixed_air_limit_snapshot(
    ...
    Snapshot {
        ...
        dehumidification_control_constant_sensible_heat_ratio_supply_temperature_mixed_air_limit_executed: false,
        cp389_retained_supply_temperature_state_owned: predecessor.resulting_supply_temperature_c.is_some(),
        preexisting_supply_temperature_c: predecessor.resulting_supply_temperature_c,
        cp389_retained_supply_temperature_owned_read: false,
        ...
        cp389_mixed_air_temperature_bit_corroborated: false,
