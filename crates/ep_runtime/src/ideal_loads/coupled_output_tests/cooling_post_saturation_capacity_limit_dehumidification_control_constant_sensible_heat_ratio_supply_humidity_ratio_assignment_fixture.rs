...
pub(super) fn calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment_snapshot(
    ...
    Snapshot {
        ...
        dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment_executed: false,
        cp391_retained_supply_temperature_state_owned: predecessor.resulting_supply_temperature_c.is_some(),
        cp391_retained_supply_enthalpy_state_owned: predecessor.resulting_supply_enthalpy_j_per_kg.is_some(),
        cp391_retained_supply_temperature_owned_read: false,
        supply_temperature_for_humidity_ratio_inversion_read: false,
        supply_temperature_c: None,
        cp391_retained_supply_enthalpy_owned_read: false,
