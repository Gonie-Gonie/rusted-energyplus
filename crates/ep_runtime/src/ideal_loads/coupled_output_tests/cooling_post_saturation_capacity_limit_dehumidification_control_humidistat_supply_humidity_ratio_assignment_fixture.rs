...
pub(super) fn calculation_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_supply_humidity_ratio_assignment_snapshot(
    predecessor: Predecessor,
) -> Snapshot {
    debug_assert!(!predecessor.dehumidification_control_humidistat_case_entered);
    Snapshot {
        ...
        cp394_retained_supply_humidity_ratio_state_owned: predecessor.resulting_supply_humidity_ratio.is_some(),
        cp394_retained_supply_temperature_state_owned: predecessor.resulting_supply_temperature_c.is_some(),
        cp394_retained_supply_enthalpy_state_owned: predecessor.resulting_supply_enthalpy_j_per_kg.is_some(),
