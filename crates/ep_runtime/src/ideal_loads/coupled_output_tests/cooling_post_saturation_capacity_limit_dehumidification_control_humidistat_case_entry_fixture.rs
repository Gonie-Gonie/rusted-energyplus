...
pub(super) fn calculation_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_entry_snapshot(
    predecessor: Predecessor,
) -> Snapshot {
    let entered = predecessor.predecessor_dehumidification_control_type
    ...
    Snapshot {
        ...
        dehumidification_control_humidistat_case_entered: entered,
