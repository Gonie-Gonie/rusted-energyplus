...
pub(super) fn calculation_cooling_post_saturation_capacity_limit_dehumidification_supply_humidity_ratio_pre_saturation_original_assignment_snapshot(
    predecessor: Predecessor,
) -> Snapshot {
    let assignment = predecessor.predecessor_dehumidification_control_switch_dispatched;
    let humidity_ratio = assignment
    ...
    Snapshot {
        ...
        post_saturation_capacity_limit_dehumidification_supply_humidity_ratio_pre_saturation_original_assignment_executed: assignment,
        ...
        cp410_retained_supply_temperature_state_owned: predecessor
            .resulting_supply_temperature_c
            .is_some(),
        cp410_retained_supply_humidity_ratio_owned_read: assignment,
        purchased_air_supply_humidity_ratio_read: assignment,
        purchased_air_supply_humidity_ratio_before_saturation_check: humidity_ratio,
        local_supply_humidity_ratio_original_assignment_performed: assignment,
        assigned_supply_humidity_ratio_original: humidity_ratio,
        resulting_supply_humidity_ratio_original: humidity_ratio,
