...
pub struct PurchasedAirUnitRuntimeState {
    ...
    #[doc = "Persistent bounded post-saturation dehumidification-control default-case break state."] #[rustfmt::skip] pub calc_cooling_post_saturation_capacity_limit_dehumidification_control_default_case_break: PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlDefaultCaseBreakRuntimeState,
