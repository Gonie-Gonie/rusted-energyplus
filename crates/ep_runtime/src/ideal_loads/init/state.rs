...
pub struct PurchasedAirUnitRuntimeState {
    ...
    /// Persistent bounded post-saturation Humidistat case-entry state.
    #[rustfmt::skip] pub calc_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_entry: PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlHumidistatCaseEntryRuntimeState,
    /// Persistent bounded post-saturation Humidistat supply-humidity-ratio assignment state.
    #[rustfmt::skip] pub calc_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_supply_humidity_ratio_assignment: PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlHumidistatSupplyHumidityRatioAssignmentRuntimeState,
