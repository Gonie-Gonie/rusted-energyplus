...
pub struct PurchasedAirRuntimeState {
    ...
    #[rustfmt::skip] heating_outdoor_air_maximum_flow_guard_latest_witnesses: BTreeMap<IdealLoadsAirSystemId, PurchasedAirCalcHeatingOutdoorAirMaximumFlowGuardSnapshot>,
}
...
pub struct PurchasedAirUnitRuntimeState {
    ...
    #[doc = "Persistent bounded heating outdoor-air maximum-flow guard state."] #[rustfmt::skip] pub calc_heating_outdoor_air_maximum_flow_guard: PurchasedAirCalcHeatingOutdoorAirMaximumFlowGuardRuntimeState,
