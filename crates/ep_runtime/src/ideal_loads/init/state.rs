...
pub struct PurchasedAirUnitRuntimeState {
    ...
    /// Persistent bounded final purchased-air saturation-limit assignment state.
    pub calc_cooling_supply_humidity_ratio_saturation_limit_assignment: PurchasedAirCalcCoolingSupplyHumidityRatioSaturationLimitAssignmentRuntimeState,
