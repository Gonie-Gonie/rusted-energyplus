...
#[rustfmt::skip] mod cooling_constant_shr_supply_humidity_ratio_mixed_air_limit; #[rustfmt::skip] mod cooling_constant_shr_supply_humidity_ratio_overdrying_limit;
...
#[rustfmt::skip] mod heating_outdoor_air_maximum_flow_first_warning_guard;
