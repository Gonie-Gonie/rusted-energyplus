...
#[rustfmt::skip] mod cooling_supply_humidity_ratio_pre_saturation_original_assignment; #[rustfmt::skip] mod cooling_supply_humidity_ratio_saturation_assignment; #[rustfmt::skip] mod cooling_supply_humidity_ratio_saturation_limit_assignment; #[rustfmt::skip] mod cooling_supply_enthalpy_post_saturation_assignment;
