...
#[rustfmt::skip] mod cooling_humidistat_case_entry; #[rustfmt::skip] mod cooling_humidistat_moisture_demand_assignment; #[rustfmt::skip] mod cooling_humidistat_supply_humidity_ratio_for_dehumidification_assignment; #[rustfmt::skip] mod cooling_humidistat_supply_humidity_ratio_for_dehumidification_minimum_limit;
