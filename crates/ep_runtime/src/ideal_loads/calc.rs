...
#[rustfmt::skip] mod cooling_positive_supply_humidity_ratio_mixed_air_assignment; #[rustfmt::skip] mod cooling_positive_supply_temperature_assignment; #[rustfmt::skip] mod cooling_positive_supply_temperature_minimum_limit; #[rustfmt::skip] mod cooling_positive_supply_temperature_mixed_air_limit;
...
#[rustfmt::skip]
pub use {cooling_positive_supply_humidity_ratio_mixed_air_assignment::*, cooling_positive_supply_temperature_assignment::*, cooling_positive_supply_temperature_minimum_limit::*, cooling_positive_supply_temperature_mixed_air_limit::*};
