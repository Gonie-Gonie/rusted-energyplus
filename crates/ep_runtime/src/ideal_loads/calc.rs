...
#[rustfmt::skip] mod cooling_positive_supply_capacity_limit_cp_air_assignment; #[rustfmt::skip] mod cooling_positive_supply_capacity_limit_guard; #[rustfmt::skip] mod cooling_positive_supply_capacity_limit_sensible_output_assignment; #[rustfmt::skip] mod cooling_positive_supply_capacity_limit_sensible_output_guard; #[rustfmt::skip] mod cooling_positive_supply_capacity_limit_sensible_output_maximum_capacity_assignment; #[rustfmt::skip] mod cooling_positive_supply_enthalpy_assignment; #[rustfmt::skip] mod cooling_positive_supply_humidity_ratio_mixed_air_assignment; #[rustfmt::skip] mod cooling_positive_supply_temperature_assignment; #[rustfmt::skip] mod cooling_positive_supply_temperature_minimum_limit; #[rustfmt::skip] mod cooling_positive_supply_temperature_mixed_air_limit;
