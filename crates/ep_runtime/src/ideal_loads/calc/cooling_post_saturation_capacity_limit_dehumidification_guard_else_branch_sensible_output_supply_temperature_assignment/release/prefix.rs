//! Lossless CP422-prefix reconstruction retained by CP423.

use super::super::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationGuardElseBranchSensibleOutputSupplyTemperatureAssignmentSnapshot as Snapshot;
...
pub(super) fn predecessor_cp422_snapshot(snapshot: Snapshot) -> Predecessor {
    Predecessor {
        source: SOURCE,
        ...
        resulting_supply_humidity_ratio: snapshot.predecessor_cp422_resulting_supply_humidity_ratio,
        resulting_supply_enthalpy_j_per_kg: snapshot.predecessor_cp422_resulting_supply_enthalpy_j_per_kg,
        resulting_supply_temperature_c: snapshot.predecessor_cp422_resulting_supply_temperature_c,
    }
}
