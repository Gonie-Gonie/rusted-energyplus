//! Exact CP422-prefix construction for CP423.
...
pub(super) fn build_snapshot(
    ...
    Snapshot {
        ...
        predecessor_cp422_resulting_supply_humidity_ratio: predecessor.resulting_supply_humidity_ratio,
        predecessor_cp422_resulting_supply_enthalpy_j_per_kg: predecessor.resulting_supply_enthalpy_j_per_kg,
        predecessor_cp422_resulting_supply_temperature_c: predecessor.resulting_supply_temperature_c,
        post_saturation_capacity_limit_dehumidification_guard_else_branch_sensible_output_supply_temperature_assignment_executed: route.assignment_executed,
        cp422_retained_supply_humidity_ratio_state_owned: predecessor.resulting_supply_humidity_ratio.is_some(),
        cp422_retained_supply_enthalpy_state_owned: predecessor.resulting_supply_enthalpy_j_per_kg.is_some(),
        cp422_retained_supply_temperature_state_owned: predecessor.resulting_supply_temperature_c.is_some(),
        cp329_retained_mixed_air_temperature_for_sensible_output_supply_temperature_owned_read: route.assignment_executed,
        mixed_air_temperature_for_sensible_output_supply_temperature_read: route.assignment_executed,
        mixed_air_temperature_for_sensible_output_supply_temperature_c: input.map(|value| value.mixed_air_temperature_c),
        cp422_retained_cooling_sensible_output_owned_read: route.assignment_executed,
        cooling_sensible_output_for_supply_temperature_read: route.assignment_executed,
        cooling_sensible_output_for_supply_temperature_w: input.map(|value| value.cooling_sensible_output_w),
        cp330_retained_supply_mass_flow_rate_for_sensible_output_supply_temperature_owned_read: route.assignment_executed,
        cp329_supply_mass_flow_rate_for_sensible_output_supply_temperature_bit_corroborated: route.assignment_executed,
        supply_mass_flow_rate_for_sensible_output_supply_temperature_read: route.assignment_executed,
        supply_mass_flow_rate_for_sensible_output_supply_temperature_kg_per_s: input.map(|value| value.supply_mass_flow_rate_kg_per_s),
        cp419_retained_cp_air_for_sensible_output_supply_temperature_owned_read: route.assignment_executed,
        cp_air_for_sensible_output_supply_temperature_read: route.assignment_executed,
        cp_air_for_sensible_output_supply_temperature_j_per_kg_k: input.map(|value| value.cp_air_j_per_kg_k),
        supply_mass_flow_rate_times_cp_air_for_sensible_output_supply_temperature_calculated: route.assignment_executed,
        supply_mass_flow_rate_times_cp_air_for_sensible_output_supply_temperature_w_per_k: denominator,
        cooling_sensible_output_over_air_capacity_rate_calculated: route.assignment_executed,
        cooling_sensible_output_over_air_capacity_rate_k: drop,
        sensible_output_supply_temperature_calculated: route.assignment_executed,
        calculated_sensible_output_supply_temperature_c: calculated,
        sensible_output_supply_temperature_assignment_performed: route.assignment_executed,
        assigned_sensible_output_supply_temperature_c: assigned,
        ...
        resulting_supply_temperature_c: calculated.or(predecessor.resulting_supply_temperature_c),
    }
}
