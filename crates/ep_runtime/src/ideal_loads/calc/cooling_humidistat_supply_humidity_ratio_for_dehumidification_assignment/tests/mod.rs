...
pub(super) fn operands(route: Route, flow: f64, zone_humidity: f64) -> Option<Operands> {
...
pub(super) fn predecessor(route: Route, ordinal: usize, demand: f64) -> Predecessor {
...
pub(super) fn completed_cp359_case(
