//! Persistent CP360 runtime-state validation.
...
use crate::ideal_loads::calc::cooling_humidistat_supply_humidity_ratio_for_dehumidification_assignment::transition::{
...
pub(super) fn pending_state_is_consistent(
    ...
    let state = &unit.calc_cooling_humidistat_supply_humidity_ratio_for_dehumidification_assignment;
    let prior = &unit.calc_cooling_humidistat_moisture_demand_assignment;
    state_is_consistent(state, witness, predecessor.system, selector)
        ...
        && pending_count(
            ...
            prior.dehumidification_control_humidistat_moisture_demand_assignment_count,
        )
        && pending_count(
