//! Bounded CP424 positive-supply guard else-branch entry.
...
pub(in crate::ideal_loads) use release::{
    cooling_supply_mass_flow_positive_guard_else_branch_entry_snapshot_is_exact,
...
pub use state::PurchasedAirCalcCoolingSupplyMassFlowPositiveGuardElseBranchEntryRuntimeState;
#[allow(unused_imports)]
pub(in crate::ideal_loads::calc) use transition::{
    PurchasedAirCalcCoolingSupplyMassFlowPositiveGuardElseBranchEntryRetainedRoute,
    advance_cooling_supply_mass_flow_positive_guard_else_branch_entry_state,
    advance_cooling_supply_mass_flow_positive_guard_else_branch_entry_state_with_validated_route,
    cooling_supply_mass_flow_positive_guard_else_branch_entry_route_from_committed_predecessor,
};

/// EnergyPlus structural source statement represented by CP424.
pub const PURCHASED_AIR_CALC_COOLING_SUPPLY_MASS_FLOW_POSITIVE_GUARD_ELSE_BRANCH_ENTRY_SOURCE: &str =
    "EnergyPlus 26.1 PurchasedAirManager.cc:2339";
/// First executable statement deliberately excluded after CP424.
pub const PURCHASED_AIR_CALC_COOLING_SUPPLY_MASS_FLOW_POSITIVE_GUARD_ELSE_BRANCH_ENTRY_FIRST_EXCLUDED_SOURCE: &str =
    "EnergyPlus 26.1 PurchasedAirManager.cc:2340";
/// Sole structural source-control site represented by CP424.
pub const PURCHASED_AIR_CALC_COOLING_SUPPLY_MASS_FLOW_POSITIVE_GUARD_ELSE_BRANCH_ENTRY_SOURCE_ORDER: &[&str] = &[
    "enter-cooling-supply-mass-flow-positive-guard-else-branch-after-guard-false-fallthrough",
];

/// One CP423-to-CP424 source-ordered structural else-entry witness.
#[allow(missing_docs)]
...
/// Final selected-unit CP424 lifecycle summary.
#[allow(missing_docs)]
#[derive(Clone, Debug, PartialEq)]
pub struct PurchasedAirCalcCoolingSupplyMassFlowPositiveGuardElseBranchEntryLifecycleSummary
{
    pub source: &'static str,
    pub first_excluded_source: &'static str,
    pub state: PurchasedAirCalcCoolingSupplyMassFlowPositiveGuardElseBranchEntryRuntimeState,
}

/// Returns the bounded selected-unit CP424 lifecycle summary.
pub fn purchased_air_calc_cooling_supply_mass_flow_positive_guard_else_branch_entry_lifecycle_summary(
...
> {
    let unit = runtime.units.get(&system).ok_or(
        PurchasedAirCalcCoolingSupplyMassFlowPositiveGuardElseBranchEntryError::UnknownSystem {
            system,
        },
    )?;
    Ok(PurchasedAirCalcCoolingSupplyMassFlowPositiveGuardElseBranchEntryLifecycleSummary {
        source: PURCHASED_AIR_CALC_COOLING_SUPPLY_MASS_FLOW_POSITIVE_GUARD_ELSE_BRANCH_ENTRY_SOURCE,
        first_excluded_source: PURCHASED_AIR_CALC_COOLING_SUPPLY_MASS_FLOW_POSITIVE_GUARD_ELSE_BRANCH_ENTRY_FIRST_EXCLUDED_SOURCE,
        state: unit.calc_cooling_supply_mass_flow_positive_guard_else_branch_entry.clone(),
    })
}
