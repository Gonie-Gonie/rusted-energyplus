...
/// Fail-closed CP384 public release error.
#[allow(missing_docs)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationTotalOutputMaximumCapacityAssignmentError {
    UnknownSystem {
    ...
    CoolingPostSaturationCapacityLimitDehumidificationTotalOutputGuardSnapshotMismatch {
        system: IdealLoadsAirSystemId,
    },
    RetainedMaximumTotalCoolingCapacityLineageMismatch {
        system: IdealLoadsAirSystemId,
    },
...
pub(super) fn predecessor_mismatch(
    ...
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationTotalOutputMaximumCapacityAssignmentError::CoolingPostSaturationCapacityLimitDehumidificationTotalOutputGuardSnapshotMismatch { system }
}
...
pub(super) fn call_order_error(
    ...
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationTotalOutputMaximumCapacityAssignmentError::PredecessorCallOrder {
        system,
