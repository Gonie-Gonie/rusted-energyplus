//! Lossless CP437-to-CP436 predecessor reconstruction.

use super::{Predecessor, Snapshot};

/// Reconstructs the exact CP436 predecessor embedded in CP437.
#[rustfmt::skip]
pub(super) fn predecessor_cp436_snapshot(snapshot: Snapshot) -> Predecessor {
    Predecessor {
        source: crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_OUTDOOR_AIR_MAXIMUM_FLOW_BODY_VOLUME_FLOW_ASSIGNMENT_SOURCE,
        first_excluded_source: crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_OUTDOOR_AIR_MAXIMUM_FLOW_BODY_VOLUME_FLOW_ASSIGNMENT_FIRST_EXCLUDED_SOURCE,
        source_order: crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_OUTDOOR_AIR_MAXIMUM_FLOW_BODY_VOLUME_FLOW_ASSIGNMENT_SOURCE_ORDER,
        ...
        resulting_supply_humidity_ratio: snapshot.predecessor_cp436_resulting_supply_humidity_ratio,
        resulting_supply_enthalpy_j_per_kg: snapshot.predecessor_cp436_resulting_supply_enthalpy_j_per_kg,
        resulting_supply_temperature_c: snapshot.predecessor_cp436_resulting_supply_temperature_c,
    }
}
