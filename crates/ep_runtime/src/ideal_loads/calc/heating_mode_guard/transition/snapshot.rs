//! Lossless CP430 prefix plus exact CP431 local guard fields.
...
pub(super) fn build_snapshot(
    ...
    let temperature_control_type = input.and_then(|value| value.temperature_control_type);
    Snapshot {
        ...
        predecessor_cp430_resulting_supply_humidity_ratio: predecessor.resulting_supply_humidity_ratio,
        predecessor_cp430_resulting_supply_enthalpy_j_per_kg: predecessor.resulting_supply_enthalpy_j_per_kg,
        predecessor_cp430_resulting_supply_temperature_c: predecessor.resulting_supply_temperature_c,
        heating_or_no_load_case_entered: predecessor.heating_or_no_load_case_entered,
        heating_mode_guard_evaluated: route.guard_evaluated,
        cp311_retained_minimum_outdoor_air_sensible_output_owned_read: route.guard_evaluated,
        cp312_same_call_minimum_outdoor_air_sensible_output_bit_corroborated: route.guard_evaluated,
        minimum_outdoor_air_sensible_output_for_heating_mode_guard_read: route.guard_evaluated,
        minimum_outdoor_air_sensible_output_for_heating_mode_guard_w:
            numeric.map(|value| value.minimum_outdoor_air_sensible_output_w),
        cp310_retained_heating_setpoint_demand_owned_read: route.guard_evaluated,
        heating_setpoint_demand_for_heating_mode_guard_read: route.guard_evaluated,
        heating_setpoint_demand_for_heating_mode_guard_w:
            numeric.map(|value| value.heating_setpoint_demand_w),
        ...
        prevalidated_temperature_control_type_owned_read: route.sensible_comparison_satisfied,
        ...
        temperature_control_type_permits_heating:
            temperature_control_type.map(|value| value != crate::ideal_loads::PurchasedAirTemperatureControlType::SingleCool),
        single_cool_blocked: route.single_cool_blocked,
        heating_operating_mode_body_entered: route.body_entered,
        heating_mode_guard_false_fallthrough: route.false_fallthrough,
