//! Lossless CP430-prefix reconstruction retained by CP431.
...
pub(super) fn predecessor_cp430_snapshot(snapshot: Snapshot) -> Predecessor {
    Predecessor {
        source: crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_OR_NO_LOAD_CASE_ENTRY_SOURCE,
        first_excluded_source: crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_OR_NO_LOAD_CASE_ENTRY_FIRST_EXCLUDED_SOURCE,
        source_order: crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_OR_NO_LOAD_CASE_ENTRY_SOURCE_ORDER,
        ...
        resulting_supply_humidity_ratio: snapshot.predecessor_cp430_resulting_supply_humidity_ratio,
        resulting_supply_enthalpy_j_per_kg: snapshot.predecessor_cp430_resulting_supply_enthalpy_j_per_kg,
        resulting_supply_temperature_c: snapshot.predecessor_cp430_resulting_supply_temperature_c,
