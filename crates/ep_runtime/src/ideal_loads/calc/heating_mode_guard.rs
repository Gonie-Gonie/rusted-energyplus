//! Bounded CP431 heating-mode guard.
...
pub use release::{
    ...
    advance_direct_no_oa_calc_heating_mode_guard,
    heating_mode_guard_predecessor_cp430_snapshot,
};
#[allow(unused_imports)]
pub(in crate::ideal_loads) use release::{
    heating_mode_guard_snapshot_is_exact,
...
pub(in crate::ideal_loads::calc) use transition::{
    PurchasedAirCalcHeatingModeGuardRetainedRoute,
    advance_heating_mode_guard_state,
...
/// First executable statement deliberately excluded after CP431.
pub const PURCHASED_AIR_CALC_HEATING_MODE_GUARD_FIRST_EXCLUDED_SOURCE: &str =
    "EnergyPlus 26.1 PurchasedAirManager.cc:2349";
/// Exact left-to-right short-circuit sites represented by CP431.
pub const PURCHASED_AIR_CALC_HEATING_MODE_GUARD_SOURCE_ORDER: &[&str] = &[
...
/// One CP430-to-CP431 source-ordered heating-mode-guard witness.
#[allow(missing_docs)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct PurchasedAirCalcHeatingModeGuardSnapshot {
...
/// Final selected-unit CP431 lifecycle summary.
#[allow(missing_docs)]
#[derive(Clone, Debug, PartialEq)]
pub struct PurchasedAirCalcHeatingModeGuardLifecycleSummary {
    pub source: &'static str,
    pub first_excluded_source: &'static str,
    pub state: PurchasedAirCalcHeatingModeGuardRuntimeState,
}

/// Returns the bounded selected-unit CP431 lifecycle summary.
pub fn purchased_air_calc_heating_mode_guard_lifecycle_summary(
...
> {
    let unit = runtime
        .units
        .get(&system)
        .ok_or(PurchasedAirCalcHeatingModeGuardError::UnknownSystem { system })?;
    Ok(PurchasedAirCalcHeatingModeGuardLifecycleSummary {
        source: PURCHASED_AIR_CALC_HEATING_MODE_GUARD_SOURCE,
        first_excluded_source:
            PURCHASED_AIR_CALC_HEATING_MODE_GUARD_FIRST_EXCLUDED_SOURCE,
        state: unit.calc_heating_mode_guard.clone(),
    })
}
