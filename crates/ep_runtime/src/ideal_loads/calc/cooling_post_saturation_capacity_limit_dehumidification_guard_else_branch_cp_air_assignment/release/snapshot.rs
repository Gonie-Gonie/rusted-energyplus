//! CP419 predecessor reconstruction and bit-exact snapshot comparison.

use super::super::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationGuardElseBranchCpAirAssignmentSnapshot as Snapshot;
...
pub(super) fn cp418_shape(snapshot: Snapshot) -> Predecessor {
    use crate::ideal_loads::{
        PURCHASED_AIR_CALC_COOLING_POST_SATURATION_CAPACITY_LIMIT_DEHUMIDIFICATION_GUARD_ELSE_BRANCH_ENTRY_FIRST_EXCLUDED_SOURCE as PREDECESSOR_EXCLUDED,
        PURCHASED_AIR_CALC_COOLING_POST_SATURATION_CAPACITY_LIMIT_DEHUMIDIFICATION_GUARD_ELSE_BRANCH_ENTRY_SOURCE as PREDECESSOR_SOURCE,
        PURCHASED_AIR_CALC_COOLING_POST_SATURATION_CAPACITY_LIMIT_DEHUMIDIFICATION_GUARD_ELSE_BRANCH_ENTRY_SOURCE_ORDER as PREDECESSOR_ORDER,
    };
    Predecessor {
        ...
        resulting_supply_humidity_ratio: snapshot.predecessor_cp418_resulting_supply_humidity_ratio,
        resulting_supply_enthalpy_j_per_kg: snapshot.predecessor_cp418_resulting_supply_enthalpy_j_per_kg,
        resulting_supply_temperature_c: snapshot.predecessor_cp418_resulting_supply_temperature_c,
        post_saturation_capacity_limit_dehumidification_guard_else_branch_entered: snapshot.predecessor_post_saturation_capacity_limit_dehumidification_guard_else_branch_entered,
    }
}
...
pub(super) fn direct_subset_values_are_valid(snapshot: Snapshot) -> bool {
    !snapshot
        ...
        || (snapshot
            ...
            && snapshot.cp_air_j_per_kg_k.is_some_and(f64::is_finite))
}
