//! Pure CP391-to-CP392 supply-humidity-ratio assignment.
...
use routes::{
    predecessor_has_supply_enthalpy, predecessor_has_supply_temperature, predecessor_route,
};

pub(in crate::ideal_loads::calc) fn advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment_state(
    state: &mut State,
    ...
    let snapshot = Snapshot {
        ...
        dehumidification_control_constant_sensible_heat_ratio_overdrying_limit_executed: predecessor
            .dehumidification_control_constant_sensible_heat_ratio_overdrying_limit_executed,
        cp390_retained_supply_enthalpy_state_owned: predecessor
        ...
        cp390_retained_supply_enthalpy_owned_read: predecessor
            .cp390_retained_supply_enthalpy_owned_read,
        supply_enthalpy_for_overdrying_limit_maximum_read: predecessor
        ...
        cp390_retained_supply_temperature_owned_read: predecessor
            .cp390_retained_supply_temperature_owned_read,
        supply_temperature_for_minimum_humidity_ratio_enthalpy_read: predecessor
        ...
        psychrometric_minimum_supply_enthalpy_evaluated: predecessor
            .psychrometric_minimum_supply_enthalpy_evaluated,
        psychrometric_minimum_supply_enthalpy_j_per_kg: predecessor
            .psychrometric_minimum_supply_enthalpy_j_per_kg,
        source_shaped_two_argument_maximum_evaluated: predecessor
        ...
        predecessor_cp391_resulting_supply_enthalpy_j_per_kg: predecessor
            .resulting_supply_enthalpy_j_per_kg,
        predecessor_cp391_resulting_supply_temperature_c: predecessor
            .resulting_supply_temperature_c,
        dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment_executed: route.active,
        cp391_retained_supply_temperature_state_owned: has_temperature,
        cp391_retained_supply_enthalpy_state_owned: has_enthalpy,
        cp391_retained_supply_temperature_owned_read: route.active,
        ...
        cp391_retained_supply_enthalpy_owned_read: route.active,
        supply_enthalpy_for_humidity_ratio_inversion_read: route.active,
        supply_enthalpy_j_per_kg: active.map(|value| value.supply_enthalpy_j_per_kg),
        ...
        resulting_supply_humidity_ratio: psychrometric_supply_humidity_ratio,
        resulting_supply_enthalpy_j_per_kg: prepared.resulting_supply_enthalpy_j_per_kg,
