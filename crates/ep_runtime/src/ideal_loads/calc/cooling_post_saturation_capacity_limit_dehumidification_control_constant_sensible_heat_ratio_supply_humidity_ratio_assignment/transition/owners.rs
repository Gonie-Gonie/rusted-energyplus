//! Exact CP391 retained-state validation for CP392.
...
pub(super) fn prepare_exact_input(
    ...
    if resulting_supply_enthalpy_j_per_kg.is_some()
    ...
    let active = if route.active {
        Some(PreparedActive {
            ...
            supply_enthalpy_j_per_kg: resulting_supply_enthalpy_j_per_kg?,
        })
    } else {
        None
    };
