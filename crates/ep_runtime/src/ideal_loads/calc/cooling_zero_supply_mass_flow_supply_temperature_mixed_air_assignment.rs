//! Bounded CP427 zero-flow supply-temperature mixed-air assignment.
...
#[cfg(test)]
pub(in crate::ideal_loads::calc) use tests::cp427_all_snapshots_for_successor_tests;
...
pub(in crate::ideal_loads) use release::{
    cooling_zero_supply_mass_flow_supply_temperature_mixed_air_assignment_snapshot_is_exact,
...
pub(in crate::ideal_loads::calc) use release::{
    ...
    cooling_zero_supply_mass_flow_supply_temperature_mixed_air_assignment_retained_route_matches_snapshot_bounded,
    cooling_zero_supply_mass_flow_supply_temperature_mixed_air_assignment_snapshot_route,
};
pub use state::PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyTemperatureMixedAirAssignmentRuntimeState;
#[allow(unused_imports)]
pub(in crate::ideal_loads::calc) use transition::{
    PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyTemperatureMixedAirAssignmentRetainedRoute,
    advance_cooling_zero_supply_mass_flow_supply_temperature_mixed_air_assignment_state,
...
/// EnergyPlus source statement represented by CP427.
pub const PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_SUPPLY_TEMPERATURE_MIXED_AIR_ASSIGNMENT_SOURCE: &str =
    "EnergyPlus 26.1 PurchasedAirManager.cc:2342";
/// First executable statement deliberately excluded after CP427.
pub const PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_SUPPLY_TEMPERATURE_MIXED_AIR_ASSIGNMENT_FIRST_EXCLUDED_SOURCE: &str =
    "EnergyPlus 26.1 PurchasedAirManager.cc:2343";
/// Exact source/dependency order represented by CP427.
pub const PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_SUPPLY_TEMPERATURE_MIXED_AIR_ASSIGNMENT_SOURCE_ORDER: &[&str] = &[
...
/// One CP426-to-CP427 source-ordered assignment witness.
#[allow(missing_docs)]
...
/// Final selected-unit CP427 lifecycle summary.
#[allow(missing_docs)]
#[derive(Clone, Debug, PartialEq)]
pub struct PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyTemperatureMixedAirAssignmentLifecycleSummary {
    pub source: &'static str,
    pub first_excluded_source: &'static str,
    pub state: PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyTemperatureMixedAirAssignmentRuntimeState,
}

/// Returns the bounded selected-unit CP427 lifecycle summary.
pub fn purchased_air_calc_cooling_zero_supply_mass_flow_supply_temperature_mixed_air_assignment_lifecycle_summary(
    runtime: &PurchasedAirRuntimeState,
    system: IdealLoadsAirSystemId,
) -> Result<PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyTemperatureMixedAirAssignmentLifecycleSummary, PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyTemperatureMixedAirAssignmentError> {
    let unit = runtime.units.get(&system).ok_or(
        PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyTemperatureMixedAirAssignmentError::UnknownSystem { system },
    )?;
    Ok(PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyTemperatureMixedAirAssignmentLifecycleSummary {
        source: PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_SUPPLY_TEMPERATURE_MIXED_AIR_ASSIGNMENT_SOURCE,
        first_excluded_source: PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_SUPPLY_TEMPERATURE_MIXED_AIR_ASSIGNMENT_FIRST_EXCLUDED_SOURCE,
        state: unit.calc_cooling_zero_supply_mass_flow_supply_temperature_mixed_air_assignment.clone(),
    })
}
