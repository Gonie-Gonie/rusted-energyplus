//! Sealed bounded CP435 route capability for CP436.
...
/// Returns CP435's committed route without recursive snapshot-route replay.
pub(in crate::ideal_loads::calc) fn heating_outdoor_air_maximum_flow_guard_committed_latest_route(
    ...
    let predecessor = predecessor_cp434_snapshot(latest);
