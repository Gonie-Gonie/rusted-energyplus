//! Exact CP428-prefix construction for CP429.
...
pub(super) fn build_snapshot(
    ...
    let assigned_cooling_total_output_w = route.assignment_executed.then_some(0.0_f64);
    Snapshot {
        source: SOURCE,
        ...
        predecessor_cp428_resulting_supply_humidity_ratio: predecessor.resulting_supply_humidity_ratio,
        predecessor_cp428_resulting_supply_enthalpy_j_per_kg: predecessor.resulting_supply_enthalpy_j_per_kg,
        predecessor_cp428_resulting_supply_temperature_c: predecessor.resulting_supply_temperature_c,
        cooling_zero_supply_mass_flow_total_output_positive_zero_assignment_executed: route.assignment_executed,
        cp428_retained_supply_humidity_ratio_state_owned: predecessor.resulting_supply_humidity_ratio.is_some(),
        cp428_retained_supply_enthalpy_state_owned: predecessor.resulting_supply_enthalpy_j_per_kg.is_some(),
        cp428_retained_supply_temperature_state_owned: predecessor.resulting_supply_temperature_c.is_some(),
        cooling_total_output_positive_zero_assignment_performed: route.assignment_executed,
