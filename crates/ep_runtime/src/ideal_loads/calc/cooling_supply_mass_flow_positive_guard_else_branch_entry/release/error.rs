//! CP424 public release errors.

use ep_model::{DehumidificationControlType, HumidificationControlType, IdealLoadsAirSystemId};

/// Fail-closed CP424 public release error.
#[allow(missing_docs)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PurchasedAirCalcCoolingSupplyMassFlowPositiveGuardElseBranchEntryError {
    ...
    CoolingPostSaturationCapacityLimitDehumidificationGuardElseBranchSensibleOutputSupplyTemperatureAssignmentSnapshotMismatch { system: IdealLoadsAirSystemId },
...
impl std::fmt::Display for PurchasedAirCalcCoolingSupplyMassFlowPositiveGuardElseBranchEntryError {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(formatter, "CP424 positive-supply guard else-entry release failed: {self:?}")
    }
}

impl std::error::Error for PurchasedAirCalcCoolingSupplyMassFlowPositiveGuardElseBranchEntryError {}
