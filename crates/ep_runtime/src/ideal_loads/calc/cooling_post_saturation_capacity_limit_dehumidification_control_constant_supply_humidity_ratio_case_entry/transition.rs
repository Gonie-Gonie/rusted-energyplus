//! Pure CP397-to-CP398 constant-supply-humidity-ratio shared case-entry evidence transition.
...
pub(in crate::ideal_loads::calc) fn advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_case_entry_state(
    state: &mut State,
    ...
    let predecessor_cp397_resulting_supply_humidity_ratio =
        predecessor.resulting_supply_humidity_ratio;
    let predecessor_cp397_resulting_supply_enthalpy_j_per_kg =
        predecessor.resulting_supply_enthalpy_j_per_kg;
    let predecessor_cp397_resulting_supply_temperature_c =
    ...
    let snapshot = Snapshot {
        ...
        source_order: PURCHASED_AIR_CALC_COOLING_POST_SATURATION_CAPACITY_LIMIT_DEHUMIDIFICATION_CONTROL_CONSTANT_SUPPLY_HUMIDITY_RATIO_CASE_ENTRY_SOURCE_ORDER,
        system: state.system,
        ...
        dehumidification_control_none_or_constant_supply_humidity_ratio_shared_case_entered:
            route.active,
        resulting_supply_humidity_ratio: predecessor_cp397_resulting_supply_humidity_ratio,
        resulting_supply_enthalpy_j_per_kg: predecessor_cp397_resulting_supply_enthalpy_j_per_kg,
        resulting_supply_temperature_c: predecessor_cp397_resulting_supply_temperature_c,
    };
