//! Exact CP397 route preservation and compressed CP398 route reconstruction.
...
pub(in crate::ideal_loads::calc) fn predecessor_route(
    ...
    let route = crate::ideal_loads::calc::cooling_post_saturation_capacity_limit_dehumidification_control_none_case_entry_snapshot_route(predecessor)?;
    Some(RetainedRoute {
...
pub(in crate::ideal_loads::calc) fn compressed_snapshot_route(
    ...
    let none = predecessor_index_is_none(index);
    ...
    if snapshot
        ...
        || snapshot.predecessor_dehumidification_control_humidistat_case_exited_via_break
            != humidistat
        || snapshot.predecessor_dehumidification_control_none_case_entered != none
        || snapshot
...
const fn predecessor_index_is_none(index: usize) -> bool {
