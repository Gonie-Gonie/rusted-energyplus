//! CP355 private lineage and CP329 mixed-air owner validation.
...
use crate::ideal_loads::calc::cooling_constant_shr_supply_humidity_ratio_mixed_air_limit::transition::{
...
pub(super) fn active_lineage_is_exact(
    ...
    option_matches(
        assignment.supply_humidity_ratio_before_mixed_air_limit,
        predecessor_result,
    ) && option_matches(
        assignment.mixed_air_humidity_ratio,
        operands.mixed_air_humidity_ratio,
    )
}
