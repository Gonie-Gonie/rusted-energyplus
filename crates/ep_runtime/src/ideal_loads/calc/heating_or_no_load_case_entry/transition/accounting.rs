//! Transactional CP430 route, source-site, and W/H/T accounting.
...
pub(super) fn next_transition_fits(
    ...
    if route.entered {
        state.heating_or_no_load_case_entry_count.checked_add(1).is_some()
