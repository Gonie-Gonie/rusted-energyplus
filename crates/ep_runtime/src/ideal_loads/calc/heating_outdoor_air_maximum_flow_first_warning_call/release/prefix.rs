//! Lossless CP439-to-CP438 predecessor reconstruction.
...
/// Reconstructs the exact CP438 predecessor embedded in CP439.
pub(super) fn predecessor_cp438_snapshot(snapshot: Snapshot) -> Predecessor {
    Predecessor {
        source: SOURCE,
