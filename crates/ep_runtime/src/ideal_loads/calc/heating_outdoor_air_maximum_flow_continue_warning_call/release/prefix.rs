//! Lossless CP440-to-CP439 predecessor reconstruction.
...
/// Reconstructs the exact CP439 predecessor embedded in CP440.
pub(super) fn predecessor_cp439_snapshot(snapshot: Snapshot) -> Predecessor {
    Predecessor {
        source: SOURCE,
