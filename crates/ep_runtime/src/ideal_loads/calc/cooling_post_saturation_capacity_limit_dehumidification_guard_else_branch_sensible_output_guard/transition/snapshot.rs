//! CP420-prefix construction for CP421.
...
use super::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationGuardElseBranchSensibleOutputGuardRetainedRoute as Route;
...
pub(super) fn build_snapshot(
    ...
    route: Route,
    cooling_sensible_output_for_capacity_guard_w: Option<f64>,
    ...
    Snapshot {
        ...
        predecessor_cp420_resulting_supply_humidity_ratio: predecessor.resulting_supply_humidity_ratio,
        predecessor_cp420_resulting_supply_enthalpy_j_per_kg: predecessor.resulting_supply_enthalpy_j_per_kg,
        predecessor_cp420_resulting_supply_temperature_c: predecessor.resulting_supply_temperature_c,
        post_saturation_capacity_limit_dehumidification_guard_else_branch_sensible_output_capacity_guard_evaluated: active,
        cp420_retained_cooling_sensible_output_owned_read: active,
        cooling_sensible_output_read: active,
        cp420_cooling_sensible_output_for_capacity_guard_w: cooling_sensible_output_for_capacity_guard_w,
        ...
        cooling_sensible_output_maximum_total_cooling_capacity_comparison_evaluated: active,
        cooling_sensible_output_greater_than_or_equal_to_maximum_total_cooling_capacity: comparison,
        post_saturation_capacity_limit_dehumidification_guard_else_branch_sensible_output_capacity_adjustment_body_entered: comparison == Some(true),
        post_saturation_capacity_limit_dehumidification_guard_else_branch_sensible_output_capacity_guard_false_fallthrough: comparison == Some(false),
        cp420_retained_supply_humidity_ratio_state_owned: predecessor.resulting_supply_humidity_ratio.is_some(),
        cp420_retained_supply_enthalpy_state_owned: predecessor.resulting_supply_enthalpy_j_per_kg.is_some(),
        cp420_retained_supply_temperature_state_owned: predecessor.resulting_supply_temperature_c.is_some(),
