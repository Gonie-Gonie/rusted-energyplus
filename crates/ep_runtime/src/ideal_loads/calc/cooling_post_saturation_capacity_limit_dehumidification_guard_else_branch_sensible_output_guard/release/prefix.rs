//! Lossless CP420 predecessor reconstruction.

use super::super::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationGuardElseBranchSensibleOutputGuardSnapshot as Snapshot;
...
pub(super) fn predecessor_cp420_snapshot(snapshot: Snapshot) -> Predecessor {
    Predecessor {
        source: SOURCE,
        ...
        resulting_supply_humidity_ratio: snapshot.predecessor_cp420_resulting_supply_humidity_ratio,
        resulting_supply_enthalpy_j_per_kg: snapshot.predecessor_cp420_resulting_supply_enthalpy_j_per_kg,
        resulting_supply_temperature_c: snapshot.predecessor_cp420_resulting_supply_temperature_c,
    }
}
