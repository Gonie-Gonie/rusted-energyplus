//! Pure CP408-to-CP409 shared-case break transition.
...
pub(in crate::ideal_loads::calc) fn advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_case_break_state(
    state: &mut State,
    ...
    let predecessor_cp408_resulting_supply_humidity_ratio =
        predecessor.resulting_supply_humidity_ratio;
    let predecessor_cp408_resulting_supply_enthalpy_j_per_kg =
        predecessor.resulting_supply_enthalpy_j_per_kg;
    let predecessor_cp408_resulting_supply_temperature_c =
    ...
    let snapshot = Snapshot {
        ...
        dehumidification_control_none_or_constant_supply_humidity_ratio_shared_case_exited_via_break: route.active,
        resulting_supply_humidity_ratio: predecessor_cp408_resulting_supply_humidity_ratio,
        resulting_supply_enthalpy_j_per_kg: predecessor_cp408_resulting_supply_enthalpy_j_per_kg,
        resulting_supply_temperature_c: predecessor_cp408_resulting_supply_temperature_c,
    };
