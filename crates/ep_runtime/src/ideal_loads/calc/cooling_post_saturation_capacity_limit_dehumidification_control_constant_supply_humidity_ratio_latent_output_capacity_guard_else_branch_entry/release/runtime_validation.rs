...
pub(in crate::ideal_loads::calc) fn committed_latest_snapshot_is_consistent(
    ...
    system.id == unit.system
        ...
        && super::snapshot_validation::cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_capacity_guard_else_branch_entry_snapshot_is_exact_direct_release(
            latest,
        )
}
