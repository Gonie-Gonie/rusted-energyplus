//! Pure CP409-to-CP410 untyped-default case-break transition.
...
pub(in crate::ideal_loads::calc) fn advance_cooling_post_saturation_capacity_limit_dehumidification_control_default_case_break_state(
    state: &mut State,
    ...
    let predecessor_cp409_resulting_supply_humidity_ratio =
        predecessor.resulting_supply_humidity_ratio;
    let predecessor_cp409_resulting_supply_enthalpy_j_per_kg =
        predecessor.resulting_supply_enthalpy_j_per_kg;
    let predecessor_cp409_resulting_supply_temperature_c =
    ...
    let snapshot = Snapshot {
        ...
        resulting_supply_humidity_ratio: predecessor_cp409_resulting_supply_humidity_ratio,
        resulting_supply_enthalpy_j_per_kg: predecessor_cp409_resulting_supply_enthalpy_j_per_kg,
        resulting_supply_temperature_c: predecessor_cp409_resulting_supply_temperature_c,
    };
