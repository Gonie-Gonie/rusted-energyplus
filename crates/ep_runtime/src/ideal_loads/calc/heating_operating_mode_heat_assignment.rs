//! Bounded CP432 heating operating-mode Heat assignment.
...
pub(in crate::ideal_loads) use release::{
    heating_operating_mode_heat_assignment_snapshot_is_exact,
...
pub(in crate::ideal_loads::calc) use transition::{
    PurchasedAirCalcHeatingOperatingModeHeatAssignmentRetainedRoute,
...
/// First executable statement deliberately excluded after CP432.
pub const PURCHASED_AIR_CALC_HEATING_OPERATING_MODE_HEAT_ASSIGNMENT_FIRST_EXCLUDED_SOURCE: &str =
    "EnergyPlus 26.1 PurchasedAirManager.cc:2351";
/// Sole source site represented by CP432.
pub const PURCHASED_AIR_CALC_HEATING_OPERATING_MODE_HEAT_ASSIGNMENT_SOURCE_ORDER: &[&str] =
    &["assign-local-operating-mode-heat"];

/// One CP431-to-CP432 source-ordered Heat-assignment witness.
#[allow(missing_docs)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct PurchasedAirCalcHeatingOperatingModeHeatAssignmentSnapshot {
...
/// Final selected-unit CP432 lifecycle summary.
#[allow(missing_docs)]
#[derive(Clone, Debug, PartialEq)]
pub struct PurchasedAirCalcHeatingOperatingModeHeatAssignmentLifecycleSummary {
    pub source: &'static str,
    pub first_excluded_source: &'static str,
    pub state: PurchasedAirCalcHeatingOperatingModeHeatAssignmentRuntimeState,
}

/// Returns the bounded selected-unit CP432 lifecycle summary.
pub fn purchased_air_calc_heating_operating_mode_heat_assignment_lifecycle_summary(
...
> {
    let unit = runtime
        .units
        .get(&system)
        .ok_or(PurchasedAirCalcHeatingOperatingModeHeatAssignmentError::UnknownSystem { system })?;
    Ok(PurchasedAirCalcHeatingOperatingModeHeatAssignmentLifecycleSummary {
        ...
        state: unit.calc_heating_operating_mode_heat_assignment.clone(),
    })
}
