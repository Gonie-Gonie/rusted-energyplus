//! Pure CP392-to-CP393 constant-SHR case-break evidence transition.
...
pub(in crate::ideal_loads::calc) fn advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_case_break_state(
    state: &mut State,
    ...
    let predecessor_cp392_resulting_supply_humidity_ratio =
        predecessor.resulting_supply_humidity_ratio;
    let predecessor_cp392_resulting_supply_enthalpy_j_per_kg =
        predecessor.resulting_supply_enthalpy_j_per_kg;
    let predecessor_cp392_resulting_supply_temperature_c =
    ...
    let snapshot = Snapshot {
        ...
        source_order: PURCHASED_AIR_CALC_COOLING_POST_SATURATION_CAPACITY_LIMIT_DEHUMIDIFICATION_CONTROL_CONSTANT_SENSIBLE_HEAT_RATIO_CASE_BREAK_SOURCE_ORDER,
        system: state.system,
        ...
        predecessor_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment_executed: predecessor
        ...
        dehumidification_control_constant_sensible_heat_ratio_case_exited_via_break: route.active,
        resulting_supply_humidity_ratio: predecessor_cp392_resulting_supply_humidity_ratio,
        resulting_supply_enthalpy_j_per_kg: predecessor_cp392_resulting_supply_enthalpy_j_per_kg,
        resulting_supply_temperature_c: predecessor_cp392_resulting_supply_temperature_c,
    };
