//! Lossless CP438-to-CP437 predecessor reconstruction.

use super::{Predecessor, Snapshot};

/// Reconstructs the exact CP437 predecessor embedded in CP438.
#[rustfmt::skip]
pub(super) fn predecessor_cp437_snapshot(snapshot: Snapshot) -> Predecessor {
    Predecessor {
        source: crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_OUTDOOR_AIR_MAXIMUM_FLOW_FIRST_WARNING_GUARD_SOURCE,
        first_excluded_source: crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_OUTDOOR_AIR_MAXIMUM_FLOW_FIRST_WARNING_GUARD_FIRST_EXCLUDED_SOURCE,
        source_order: crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_OUTDOOR_AIR_MAXIMUM_FLOW_FIRST_WARNING_GUARD_SOURCE_ORDER,
        ...
        resulting_supply_humidity_ratio: snapshot.predecessor_cp437_resulting_supply_humidity_ratio,
        resulting_supply_enthalpy_j_per_kg: snapshot.predecessor_cp437_resulting_supply_enthalpy_j_per_kg,
        resulting_supply_temperature_c: snapshot.predecessor_cp437_resulting_supply_temperature_c,
    }
}
