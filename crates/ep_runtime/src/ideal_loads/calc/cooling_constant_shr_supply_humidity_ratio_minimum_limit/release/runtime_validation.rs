//! Persistent CP355 runtime-state validation.
...
pub(super) fn pending_state_is_consistent(
    ...
    let state = &unit.calc_cooling_constant_shr_supply_humidity_ratio_minimum_limit;
    let prior = &unit.calc_cooling_constant_shr_supply_humidity_ratio_overdrying_limit;
