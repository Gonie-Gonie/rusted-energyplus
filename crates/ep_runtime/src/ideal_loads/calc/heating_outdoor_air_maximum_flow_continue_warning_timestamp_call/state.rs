//! Persistent CP441 continue-warning-timestamp-call-site state.

use ep_model::IdealLoadsAirSystemId;

use super::PurchasedAirCalcHeatingOutdoorAirMaximumFlowContinueWarningTimestampCallSnapshot as Snapshot;
use super::transition::PurchasedAirCalcHeatingOutdoorAirMaximumFlowContinueWarningTimestampCallRetainedRoute as Route;

/// Persistent bounded state and exact CP440/CP441 route accounting.
#[allow(missing_docs)]
#[derive(Clone, Debug, PartialEq)]
pub struct PurchasedAirCalcHeatingOutdoorAirMaximumFlowContinueWarningTimestampCallRuntimeState {
    pub system: IdealLoadsAirSystemId,
    pub transition_count: usize,
    pub inactive_transition_count: usize,
    pub heating_outdoor_air_maximum_flow_continue_warning_timestamp_call_site_count: usize,
    ...
    pub predecessor_continue_warning_call_route_counts: [usize; 36],
    pub heating_outdoor_air_maximum_flow_continue_warning_timestamp_call_route_counts: [usize; 36],
    pub source_site_execution_count: usize,
    pub cp440_supply_humidity_ratio_state_owner_count: usize,
    pub unchanged_supply_humidity_ratio_preservation_count: usize,
    pub cp440_supply_enthalpy_state_owner_count: usize,
    pub unchanged_supply_enthalpy_preservation_count: usize,
    pub cp440_supply_temperature_state_owner_count: usize,
    pub unchanged_supply_temperature_preservation_count: usize,
    pub cp440_outdoor_air_flow_maximum_heating_output_error_count_state_owner_count: usize,
...
impl PurchasedAirCalcHeatingOutdoorAirMaximumFlowContinueWarningTimestampCallRuntimeState {
    /// Creates zeroed CP441 state for one system.
    #[must_use]
    pub const fn new(system: IdealLoadsAirSystemId) -> Self {
        Self {
            ...
            heating_outdoor_air_maximum_flow_continue_warning_timestamp_call_site_count: 0,
            ...
            predecessor_continue_warning_call_route_counts: [0; 36],
            heating_outdoor_air_maximum_flow_continue_warning_timestamp_call_route_counts: [0; 36],
            source_site_execution_count: 0,
            cp440_supply_humidity_ratio_state_owner_count: 0,
            unchanged_supply_humidity_ratio_preservation_count: 0,
            cp440_supply_enthalpy_state_owner_count: 0,
            unchanged_supply_enthalpy_preservation_count: 0,
            cp440_supply_temperature_state_owner_count: 0,
            unchanged_supply_temperature_preservation_count: 0,
            cp440_outdoor_air_flow_maximum_heating_output_error_count_state_owner_count: 0,
