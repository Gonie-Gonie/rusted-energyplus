//! Lossless CP431-prefix reconstruction retained by CP432.
...
pub(super) fn predecessor_cp431_snapshot(snapshot: Snapshot) -> Predecessor {
    Predecessor {
        source: crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_MODE_GUARD_SOURCE,
        first_excluded_source: crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_MODE_GUARD_FIRST_EXCLUDED_SOURCE,
        source_order: crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_MODE_GUARD_SOURCE_ORDER,
        ...
        resulting_supply_humidity_ratio: snapshot.predecessor_cp431_resulting_supply_humidity_ratio,
        resulting_supply_enthalpy_j_per_kg: snapshot.predecessor_cp431_resulting_supply_enthalpy_j_per_kg,
        resulting_supply_temperature_c: snapshot.predecessor_cp431_resulting_supply_temperature_c,
    }
}
