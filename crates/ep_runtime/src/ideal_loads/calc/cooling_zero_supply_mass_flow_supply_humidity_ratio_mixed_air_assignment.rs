//! Bounded CP426 zero-flow supply-humidity-ratio mixed-air assignment.
...
pub(in crate::ideal_loads) use release::{
    cooling_zero_supply_mass_flow_supply_humidity_ratio_mixed_air_assignment_snapshot_is_exact,
...
pub(in crate::ideal_loads::calc) use release::{
    ...
    cooling_zero_supply_mass_flow_supply_humidity_ratio_mixed_air_assignment_retained_route_matches_snapshot_bounded,
    cooling_zero_supply_mass_flow_supply_humidity_ratio_mixed_air_assignment_snapshot_route,
};
pub use state::PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyHumidityRatioMixedAirAssignmentRuntimeState;
#[allow(unused_imports)]
pub(in crate::ideal_loads::calc) use transition::{
    PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyHumidityRatioMixedAirAssignmentRetainedRoute,
    advance_cooling_zero_supply_mass_flow_supply_humidity_ratio_mixed_air_assignment_state,
...
/// EnergyPlus source statement represented by CP426.
pub const PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_SUPPLY_HUMIDITY_RATIO_MIXED_AIR_ASSIGNMENT_SOURCE: &str =
    "EnergyPlus 26.1 PurchasedAirManager.cc:2341";
/// First executable statement deliberately excluded after CP426.
pub const PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_SUPPLY_HUMIDITY_RATIO_MIXED_AIR_ASSIGNMENT_FIRST_EXCLUDED_SOURCE: &str =
    "EnergyPlus 26.1 PurchasedAirManager.cc:2342";
/// Exact source/dependency order represented by CP426.
pub const PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_SUPPLY_HUMIDITY_RATIO_MIXED_AIR_ASSIGNMENT_SOURCE_ORDER: &[&str] = &[
...
/// One CP425-to-CP426 source-ordered assignment witness.
#[allow(missing_docs)]
...
/// Final selected-unit CP426 lifecycle summary.
#[allow(missing_docs)]
#[derive(Clone, Debug, PartialEq)]
pub struct PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyHumidityRatioMixedAirAssignmentLifecycleSummary {
    pub source: &'static str,
    pub first_excluded_source: &'static str,
    pub state: PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyHumidityRatioMixedAirAssignmentRuntimeState,
}

/// Returns the bounded selected-unit CP426 lifecycle summary.
pub fn purchased_air_calc_cooling_zero_supply_mass_flow_supply_humidity_ratio_mixed_air_assignment_lifecycle_summary(
    runtime: &PurchasedAirRuntimeState,
    system: IdealLoadsAirSystemId,
) -> Result<PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyHumidityRatioMixedAirAssignmentLifecycleSummary, PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyHumidityRatioMixedAirAssignmentError> {
    let unit = runtime.units.get(&system).ok_or(
        PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyHumidityRatioMixedAirAssignmentError::UnknownSystem { system },
    )?;
    Ok(PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyHumidityRatioMixedAirAssignmentLifecycleSummary {
        source: PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_SUPPLY_HUMIDITY_RATIO_MIXED_AIR_ASSIGNMENT_SOURCE,
        first_excluded_source: PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_SUPPLY_HUMIDITY_RATIO_MIXED_AIR_ASSIGNMENT_FIRST_EXCLUDED_SOURCE,
        state: unit.calc_cooling_zero_supply_mass_flow_supply_humidity_ratio_mixed_air_assignment.clone(),
    })
}
