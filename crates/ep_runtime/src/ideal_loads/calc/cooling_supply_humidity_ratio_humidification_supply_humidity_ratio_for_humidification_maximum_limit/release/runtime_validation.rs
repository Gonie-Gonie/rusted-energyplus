//! Persistent CP374 runtime-state validation.
...
use crate::ideal_loads::calc::cooling_supply_humidity_ratio_humidification_supply_humidity_ratio_for_humidification_maximum_limit::transition::predecessor_route;
...
pub(super) fn next_transition_fits(state: &State, predecessor: Predecessor) -> bool {
    ...
    let operands = active.then_some(ActiveOperands {
        maximum_heating_supply_air_humidity_ratio: 0.0,
    });
...
#[allow(dead_code)]
pub(in crate::ideal_loads) fn cooling_supply_humidity_ratio_humidification_supply_humidity_ratio_for_humidification_maximum_limit_latest_metadata_is_consistent(
    state: &State,
...
fn route_count_pairs(
    ...
    [
        ...
        (state.dehumidification_control_humidistat_supply_humidity_ratio_for_humidification_maximum_limit_count, prior.dehumidification_control_humidistat_supply_humidity_ratio_for_humidification_assignment_count, Route::DehumidificationControlHumidistatSupplyHumidityRatioForHumidificationMaximumLimitExecuted),
        (state.dehumidification_control_none_supply_humidity_ratio_for_humidification_maximum_limit_count, prior.dehumidification_control_none_supply_humidity_ratio_for_humidification_assignment_count, Route::DehumidificationControlNoneSupplyHumidityRatioForHumidificationMaximumLimitExecuted),
