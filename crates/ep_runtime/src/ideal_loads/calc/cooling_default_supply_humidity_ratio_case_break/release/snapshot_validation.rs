//! Exact numeric-free CP368 snapshot validation.
...
pub(in crate::ideal_loads) fn cooling_default_supply_humidity_ratio_case_break_snapshot_is_exact_direct_release(
    snapshot: Snapshot,
) -> bool {
    matches!(
