//! Persistent CP368 default supply-humidity-ratio case-break state.

use ep_model::IdealLoadsAirSystemId;

use super::PurchasedAirCalcCoolingDefaultSupplyHumidityRatioCaseBreakSnapshot;

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::ideal_loads::calc) enum PurchasedAirCalcCoolingDefaultSupplyHumidityRatioCaseBreakRetainedRoute
{
    UnitOff,
    NonCooling,
...
pub struct PurchasedAirCalcCoolingDefaultSupplyHumidityRatioCaseBreakRuntimeState {
    ...
    pub dehumidification_control_default_supply_humidity_ratio_case_break_count: usize,
    pub source_site_execution_count: usize,
    pub latest: Option<PurchasedAirCalcCoolingDefaultSupplyHumidityRatioCaseBreakSnapshot>,
    pub(super) latest_route:
        Option<PurchasedAirCalcCoolingDefaultSupplyHumidityRatioCaseBreakRetainedRoute>,
...
impl PurchasedAirCalcCoolingDefaultSupplyHumidityRatioCaseBreakRuntimeState {
    /// Creates zeroed CP368 state for one system.
    #[must_use]
    pub const fn new(system: IdealLoadsAirSystemId) -> Self {
        Self {
            ...
            dehumidification_control_default_supply_humidity_ratio_case_break_count: 0,
