//! Transactional CP433 route, source-site, and W/H/T accounting.
...
pub(super) fn next_transition_fits(
    ...
    if route.entered {
        state
            .heating_mode_guard_else_branch_entry_count
            .checked_add(1)
            .is_some()
