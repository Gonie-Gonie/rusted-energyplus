//! Pure CP357-to-CP358 Humidistat case-entry evidence transition.
...
pub(in crate::ideal_loads::calc) fn advance_cooling_humidistat_case_entry_state(
    state: &mut State,
    ...
    match route {
        ...
        Route::DehumidificationControlHumidistatCaseEntered => {
            state.dehumidification_control_humidistat_case_entry_count += 1;
            state.source_site_execution_count +=
                PURCHASED_AIR_CALC_COOLING_HUMIDISTAT_CASE_ENTRY_SOURCE_ORDER.len();
            state.witnessed_dehumidification_control_humidistat_case_entry_count += 1;
        }
    ...
    let snapshot = Snapshot {
        ...
        dehumidification_control_constant_sensible_heat_ratio_case_completed_skip: route
            == Route::DehumidificationControlConstantSensibleHeatRatioCaseCompletedSkip,
        dehumidification_control_humidistat_case_entered: route
            == Route::DehumidificationControlHumidistatCaseEntered,
...
pub(in crate::ideal_loads::calc) fn predecessor_route(predecessor: Predecessor) -> Option<Route> {
    if predecessor.source != PURCHASED_AIR_CALC_COOLING_CONSTANT_SHR_CASE_BREAK_SOURCE
    ...
    match predecessor.predecessor_dehumidification_control_type? {
        ...
        {
            Some(Route::DehumidificationControlHumidistatCaseEntered)
        }
    ...
    match route {
        ...
        Route::DehumidificationControlHumidistatCaseEntered => {
            checked_pair(
                ...
                .checked_add(PURCHASED_AIR_CALC_COOLING_HUMIDISTAT_CASE_ENTRY_SOURCE_ORDER.len())
                .is_some()
        }
