//! CP365-to-CP366 retained/private constant-supply lineage validation.
...
pub(super) fn case_break_links_to_predecessor(
    ...
    snapshot_route(case_break) == Some(route)
        ...
        && case_break.dehumidification_control_constant_supply_humidity_ratio_case_exited_via_break
