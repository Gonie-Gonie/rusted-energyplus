//! Pure CP365-to-CP366 constant-supply-humidity-ratio case-break transition.
...
pub(in crate::ideal_loads::calc) fn advance_cooling_constant_supply_humidity_ratio_case_break_state(
    state: &mut State,
    ...
    match route {
        ...
        Route::DehumidificationControlConstantSupplyHumidityRatioCaseBreak => {
            state.dehumidification_control_constant_supply_humidity_ratio_case_break_count += 1;
    ...
    let snapshot = Snapshot {
        ...
        first_excluded_source:
            PURCHASED_AIR_CALC_COOLING_CONSTANT_SUPPLY_HUMIDITY_RATIO_CASE_BREAK_FIRST_EXCLUDED_SOURCE,
        source_order: PURCHASED_AIR_CALC_COOLING_CONSTANT_SUPPLY_HUMIDITY_RATIO_CASE_BREAK_SOURCE_ORDER,
        system: state.system,
        ...
        dehumidification_control_humidistat_case_completed_skip: route
            == Route::DehumidificationControlHumidistatCaseCompletedSkip,
        dehumidification_control_constant_supply_humidity_ratio_case_exited_via_break: route
            == Route::DehumidificationControlConstantSupplyHumidityRatioCaseBreak,
    };
...
pub(in crate::ideal_loads::calc) fn predecessor_snapshots_match_bit_exact(
    ...
    crate::ideal_loads::calc::cooling_constant_supply_humidity_ratio_assignment::
