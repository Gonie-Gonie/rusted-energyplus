//! CP427 public release errors.

use ep_model::{DehumidificationControlType, HumidificationControlType, IdealLoadsAirSystemId};

/// Fail-closed CP427 public release error.
#[allow(missing_docs)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyTemperatureMixedAirAssignmentError {
    ...
    CoolingZeroSupplyMassFlowSupplyHumidityRatioMixedAirAssignmentSnapshotMismatch {
        system: IdealLoadsAirSystemId,
    },
    ...
    MixedAirTemperatureOwnerUnavailableOrInconsistent { system: IdealLoadsAirSystemId },
    RuntimeStateInvariantViolation { system: IdealLoadsAirSystemId },
}

impl std::fmt::Display for PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyTemperatureMixedAirAssignmentError {
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(formatter, "CP427 zero-flow supply-temperature assignment release failed: {self:?}")
    }
}

impl std::error::Error for PurchasedAirCalcCoolingZeroSupplyMassFlowSupplyTemperatureMixedAirAssignmentError {}
