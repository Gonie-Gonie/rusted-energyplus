//! Persistent CP357 constant-SHR case-break state.

use ep_model::IdealLoadsAirSystemId;

use super::PurchasedAirCalcCoolingConstantShrCaseBreakSnapshot;

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::ideal_loads::calc) enum PurchasedAirCalcCoolingConstantShrCaseBreakRetainedRoute {
    UnitOff,
    NonCooling,
    PositiveGuardFalseFallthrough,
    DehumidificationControlNoneCaseCompletedSkip,
    DehumidificationControlConstantSensibleHeatRatioCaseBreak,
...
pub struct PurchasedAirCalcCoolingConstantShrCaseBreakRuntimeState {
    ...
    pub latest: Option<PurchasedAirCalcCoolingConstantShrCaseBreakSnapshot>,
    pub(super) latest_route: Option<PurchasedAirCalcCoolingConstantShrCaseBreakRetainedRoute>,
    ...
    pub(super) witnessed_dehumidification_control_constant_sensible_heat_ratio_case_break_count:
        usize,
...
impl PurchasedAirCalcCoolingConstantShrCaseBreakRuntimeState {
    /// Creates zeroed CP357 state for one system.
    #[must_use]
    pub const fn new(system: IdealLoadsAirSystemId) -> Self {
        Self {
            ...
            witnessed_dehumidification_control_constant_sensible_heat_ratio_case_break_count: 0,
