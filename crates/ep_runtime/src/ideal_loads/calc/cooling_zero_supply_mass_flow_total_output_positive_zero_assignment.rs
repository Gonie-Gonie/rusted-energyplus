//! Bounded CP429 zero-flow total-output positive-zero assignment.
...
pub(in crate::ideal_loads) use release::{
    cooling_zero_supply_mass_flow_total_output_positive_zero_assignment_snapshot_is_exact,
...
pub use state::PurchasedAirCalcCoolingZeroSupplyMassFlowTotalOutputPositiveZeroAssignmentRuntimeState;
#[allow(unused_imports)]
pub(in crate::ideal_loads::calc) use transition::{
    PurchasedAirCalcCoolingZeroSupplyMassFlowTotalOutputPositiveZeroAssignmentRetainedRoute,
    advance_cooling_zero_supply_mass_flow_total_output_positive_zero_assignment_state,
...
/// EnergyPlus source statement represented by CP429.
pub const PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_TOTAL_OUTPUT_POSITIVE_ZERO_ASSIGNMENT_SOURCE: &str =
    "EnergyPlus 26.1 PurchasedAirManager.cc:2344";
/// First executable statement deliberately excluded after CP429.
pub const PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_TOTAL_OUTPUT_POSITIVE_ZERO_ASSIGNMENT_FIRST_EXCLUDED_SOURCE: &str =
    "EnergyPlus 26.1 PurchasedAirManager.cc:2348";
/// Exact source/dependency order represented by CP429.
pub const PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_TOTAL_OUTPUT_POSITIVE_ZERO_ASSIGNMENT_SOURCE_ORDER: &[&str] =
    &["assign-local-cooling-total-output-positive-zero-for-zero-supply-mass-flow"];

/// One CP428-to-CP429 source-ordered assignment witness.
#[allow(missing_docs)]
...
/// Final selected-unit CP429 lifecycle summary.
#[allow(missing_docs)]
#[derive(Clone, Debug, PartialEq)]
pub struct PurchasedAirCalcCoolingZeroSupplyMassFlowTotalOutputPositiveZeroAssignmentLifecycleSummary {
    pub source: &'static str,
    pub first_excluded_source: &'static str,
    pub state: PurchasedAirCalcCoolingZeroSupplyMassFlowTotalOutputPositiveZeroAssignmentRuntimeState,
}

/// Returns the bounded selected-unit CP429 lifecycle summary.
pub fn purchased_air_calc_cooling_zero_supply_mass_flow_total_output_positive_zero_assignment_lifecycle_summary(
    runtime: &PurchasedAirRuntimeState,
    system: IdealLoadsAirSystemId,
) -> Result<PurchasedAirCalcCoolingZeroSupplyMassFlowTotalOutputPositiveZeroAssignmentLifecycleSummary, PurchasedAirCalcCoolingZeroSupplyMassFlowTotalOutputPositiveZeroAssignmentError> {
    let unit = runtime.units.get(&system).ok_or(
        PurchasedAirCalcCoolingZeroSupplyMassFlowTotalOutputPositiveZeroAssignmentError::UnknownSystem { system },
    )?;
    Ok(PurchasedAirCalcCoolingZeroSupplyMassFlowTotalOutputPositiveZeroAssignmentLifecycleSummary {
        source: PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_TOTAL_OUTPUT_POSITIVE_ZERO_ASSIGNMENT_SOURCE,
        first_excluded_source: PURCHASED_AIR_CALC_COOLING_ZERO_SUPPLY_MASS_FLOW_TOTAL_OUTPUT_POSITIVE_ZERO_ASSIGNMENT_FIRST_EXCLUDED_SOURCE,
        state: unit.calc_cooling_zero_supply_mass_flow_total_output_positive_zero_assignment.clone(),
    })
}
