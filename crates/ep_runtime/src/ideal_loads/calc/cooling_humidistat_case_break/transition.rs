//! Pure CP362-to-CP363 Humidistat case-break evidence transition.
...
pub(in crate::ideal_loads::calc) fn advance_cooling_humidistat_case_break_state(
    state: &mut State,
    ...
    match route {
        ...
        Route::DehumidificationControlConstantSensibleHeatRatioCaseCompletedSkip => {
            state.dehumidification_control_constant_sensible_heat_ratio_case_completed_skip_count += 1;
            state.witnessed_dehumidification_control_constant_sensible_heat_ratio_case_completed_skip_count += 1;
        }
        Route::DehumidificationControlHumidistatCaseBreak => {
            state.dehumidification_control_humidistat_case_break_count += 1;
            state.source_site_execution_count +=
                PURCHASED_AIR_CALC_COOLING_HUMIDISTAT_CASE_BREAK_SOURCE_ORDER.len();
            state
    ...
    let snapshot = Snapshot {
        ...
        predecessor_dehumidification_control_constant_sensible_heat_ratio_case_completed_skip: predecessor
        ...
        dehumidification_control_constant_sensible_heat_ratio_case_completed_skip: route
            == Route::DehumidificationControlConstantSensibleHeatRatioCaseCompletedSkip,
        dehumidification_control_humidistat_case_exited_via_break: route
            == Route::DehumidificationControlHumidistatCaseBreak,
...
pub(in crate::ideal_loads::calc) fn predecessor_route(predecessor: Predecessor) -> Option<Route> {
    ...
    match predecessor.predecessor_dehumidification_control_type? {
        ...
        DehumidificationControlType::ConstantSensibleHeatRatio
            if predecessor.dehumidification_control_constant_sensible_heat_ratio_case_completed_skip =>
        {
        ...
        DehumidificationControlType::Humidistat
            if predecessor
                .dehumidification_control_humidistat_supply_humidity_ratio_mixed_air_limit_executed =>
        {
            Some(Route::DehumidificationControlHumidistatCaseBreak)
        }
    ...
    match route {
        ...
        Route::DehumidificationControlHumidistatCaseBreak => {
            checked_pair(
                ...
                .checked_add(PURCHASED_AIR_CALC_COOLING_HUMIDISTAT_CASE_BREAK_SOURCE_ORDER.len())
                .is_some()
        }
