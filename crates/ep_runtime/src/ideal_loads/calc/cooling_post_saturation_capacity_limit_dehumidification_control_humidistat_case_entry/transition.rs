//! Pure CP393-to-CP394 Humidistat case-entry evidence transition.
...
pub(in crate::ideal_loads::calc) fn advance_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_entry_state(
    state: &mut State,
    ...
    let predecessor_cp393_resulting_supply_humidity_ratio =
        predecessor.resulting_supply_humidity_ratio;
    let predecessor_cp393_resulting_supply_enthalpy_j_per_kg =
        predecessor.resulting_supply_enthalpy_j_per_kg;
    let predecessor_cp393_resulting_supply_temperature_c =
    ...
    let snapshot = Snapshot {
        ...
        dehumidification_control_humidistat_case_entered: route.active,
        resulting_supply_humidity_ratio: predecessor_cp393_resulting_supply_humidity_ratio,
        resulting_supply_enthalpy_j_per_kg: predecessor_cp393_resulting_supply_enthalpy_j_per_kg,
        resulting_supply_temperature_c: predecessor_cp393_resulting_supply_temperature_c,
    };
