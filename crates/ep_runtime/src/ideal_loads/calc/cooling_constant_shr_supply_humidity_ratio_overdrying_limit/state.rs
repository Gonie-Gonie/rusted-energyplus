//! Persistent CP354 constant-SHR supply-humidity-ratio limit state.

use ep_model::IdealLoadsAirSystemId;

use super::PurchasedAirCalcCoolingConstantShrSupplyHumidityRatioOverdryingLimitSnapshot;

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::ideal_loads::calc) enum PurchasedAirCalcCoolingConstantShrSupplyHumidityRatioOverdryingLimitRetainedRoute
{
    UnitOff,
    NonCooling,
    PositiveGuardFalseFallthrough,
    DehumidificationControlNoneCaseCompletedSkip,
    DehumidificationControlConstantSensibleHeatRatioSupplyHumidityRatioOverdryingLimitExecuted,
...
pub struct PurchasedAirCalcCoolingConstantShrSupplyHumidityRatioOverdryingLimitRuntimeState {
    ...
    pub dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_overdrying_limit_count:
        usize,
    ...
    pub supply_humidity_ratio_for_overdrying_limit_minimum_read_count: usize,
    ...
    pub(super) latest_route:
        Option<PurchasedAirCalcCoolingConstantShrSupplyHumidityRatioOverdryingLimitRetainedRoute>,
    ...
    pub(super) witnessed_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_overdrying_limit_count:
        usize,
...
impl PurchasedAirCalcCoolingConstantShrSupplyHumidityRatioOverdryingLimitRuntimeState {
    /// Creates zeroed CP354 state for one system.
    #[must_use]
    pub const fn new(system: IdealLoadsAirSystemId) -> Self {
        Self {
            ...
            supply_humidity_ratio_for_overdrying_limit_minimum_read_count: 0,
