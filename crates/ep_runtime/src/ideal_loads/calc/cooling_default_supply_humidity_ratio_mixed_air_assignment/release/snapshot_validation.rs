//! Exact numeric-free CP367 snapshot validation.
...
pub(in crate::ideal_loads) fn cooling_default_supply_humidity_ratio_mixed_air_assignment_snapshot_is_exact_direct_release(
    snapshot: Snapshot,
) -> bool {
    matches!(
