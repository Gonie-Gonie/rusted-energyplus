//! Pure CP366-to-CP367 default supply-humidity-ratio mixed-air assignment transition.
...
pub(in crate::ideal_loads::calc) fn advance_cooling_default_supply_humidity_ratio_mixed_air_assignment_state(
    state: &mut State,
    ...
    let snapshot = Snapshot {
        ...
        first_excluded_source:
            PURCHASED_AIR_CALC_COOLING_DEFAULT_SUPPLY_HUMIDITY_RATIO_MIXED_AIR_ASSIGNMENT_FIRST_EXCLUDED_SOURCE,
        source_order: PURCHASED_AIR_CALC_COOLING_DEFAULT_SUPPLY_HUMIDITY_RATIO_MIXED_AIR_ASSIGNMENT_SOURCE_ORDER,
        system: state.system,
...
pub(in crate::ideal_loads::calc) fn predecessor_snapshots_match_bit_exact(
    ...
    crate::ideal_loads::calc::cooling_constant_supply_humidity_ratio_case_break::
        cooling_constant_supply_humidity_ratio_case_break_snapshots_match_exact(left, right)
}
