//! Persistent CP367 default supply-humidity-ratio mixed-air assignment state.

use ep_model::IdealLoadsAirSystemId;

use super::PurchasedAirCalcCoolingDefaultSupplyHumidityRatioMixedAirAssignmentSnapshot;

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::ideal_loads::calc) enum PurchasedAirCalcCoolingDefaultSupplyHumidityRatioMixedAirAssignmentRetainedRoute
{
    UnitOff,
    NonCooling,
...
pub struct PurchasedAirCalcCoolingDefaultSupplyHumidityRatioMixedAirAssignmentRuntimeState {
    ...
    pub latest: Option<PurchasedAirCalcCoolingDefaultSupplyHumidityRatioMixedAirAssignmentSnapshot>,
    pub(super) latest_route:
        Option<PurchasedAirCalcCoolingDefaultSupplyHumidityRatioMixedAirAssignmentRetainedRoute>,
...
impl PurchasedAirCalcCoolingDefaultSupplyHumidityRatioMixedAirAssignmentRuntimeState {
    /// Creates zeroed CP367 state for one system.
    #[must_use]
