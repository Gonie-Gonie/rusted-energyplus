//! Persistent CP340 Cooling capacity-limit sensible-output guard state.

use ep_model::IdealLoadsAirSystemId;

use super::PurchasedAirCalcCoolingPositiveSupplyCapacityLimitSensibleOutputGuardSnapshot;

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::ideal_loads::calc) enum PurchasedAirCalcCoolingPositiveSupplyCapacityLimitSensibleOutputGuardRetainedRoute
{
    UnitOff,
    NonCooling,
...
pub struct PurchasedAirCalcCoolingPositiveSupplyCapacityLimitSensibleOutputGuardRuntimeState {
    ...
    pub capacity_limit_sensible_output_guard_evaluation_count: usize,
    pub source_site_execution_count: usize,
    pub cooling_sensible_output_read_count: usize,
    pub maximum_total_cooling_capacity_read_count: usize,
    pub cooling_sensible_output_maximum_capacity_comparison_count: usize,
    pub capacity_limit_sensible_output_guard_false_fallthrough_count: usize,
    pub capacity_limit_sensible_output_adjustment_body_entry_count: usize,
    pub latest:
    ...
    pub(super) witnessed_capacity_limit_sensible_output_adjustment_body_entry_count: usize,
}

impl PurchasedAirCalcCoolingPositiveSupplyCapacityLimitSensibleOutputGuardRuntimeState {
    /// Creates zeroed CP340 state for one system.
    #[must_use]
    pub const fn new(system: IdealLoadsAirSystemId) -> Self {
        Self {
            ...
            capacity_limit_sensible_output_guard_evaluation_count: 0,
            source_site_execution_count: 0,
            cooling_sensible_output_read_count: 0,
            maximum_total_cooling_capacity_read_count: 0,
            cooling_sensible_output_maximum_capacity_comparison_count: 0,
            capacity_limit_sensible_output_guard_false_fallthrough_count: 0,
            capacity_limit_sensible_output_adjustment_body_entry_count: 0,
            latest: None,
            latest_route: None,
            ...
            witnessed_capacity_limit_sensible_output_adjustment_body_entry_count: 0,
        }
    }
}
