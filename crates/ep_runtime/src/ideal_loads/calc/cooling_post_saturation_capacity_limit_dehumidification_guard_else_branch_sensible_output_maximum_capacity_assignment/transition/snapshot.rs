//! CP421-prefix construction for CP422.
...
use super::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationGuardElseBranchSensibleOutputMaximumCapacityAssignmentRetainedRoute as Route;
...
pub(super) fn build_snapshot(
    ...
    resulting_cooling_sensible_output_w: Option<f64>,
) -> Snapshot {
    Snapshot {
        source: SOURCE,
        ...
        predecessor_cp421_resulting_supply_humidity_ratio: predecessor.resulting_supply_humidity_ratio,
        predecessor_cp421_resulting_supply_enthalpy_j_per_kg: predecessor.resulting_supply_enthalpy_j_per_kg,
        predecessor_cp421_resulting_supply_temperature_c: predecessor.resulting_supply_temperature_c,
        post_saturation_capacity_limit_dehumidification_guard_else_branch_sensible_output_maximum_capacity_assignment_executed: route.assignment_executed,
        cp421_retained_supply_humidity_ratio_state_owned: predecessor.resulting_supply_humidity_ratio.is_some(),
        cp421_retained_supply_enthalpy_state_owned: predecessor.resulting_supply_enthalpy_j_per_kg.is_some(),
        cp421_retained_supply_temperature_state_owned: predecessor.resulting_supply_temperature_c.is_some(),
        preexisting_cooling_sensible_output_for_maximum_capacity_assignment_w: preexisting_cooling_sensible_output_w,
        cp421_retained_maximum_total_cooling_capacity_owned_read: route.assignment_executed,
        maximum_total_cooling_capacity_for_sensible_output_assignment_read: route.assignment_executed,
        maximum_total_cooling_capacity_for_sensible_output_assignment_w: maximum_total_cooling_capacity_w,
        cooling_sensible_output_maximum_capacity_assignment_performed: route.assignment_executed,
        assigned_cooling_sensible_output_from_maximum_capacity_w: maximum_total_cooling_capacity_w,
        resulting_cooling_sensible_output_after_maximum_capacity_assignment_w: resulting_cooling_sensible_output_w,
