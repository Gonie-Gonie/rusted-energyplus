//! Bounded CP434 heating operating-mode Deadband assignment.
...
pub(in crate::ideal_loads) use release::{
    heating_operating_mode_deadband_assignment_snapshot_is_exact,
...
pub(in crate::ideal_loads::calc) use transition::{
    ...
    advance_heating_operating_mode_deadband_assignment_state,
...
/// EnergyPlus executable Deadband-mode assignment represented by CP434.
pub const PURCHASED_AIR_CALC_HEATING_OPERATING_MODE_DEADBAND_ASSIGNMENT_SOURCE: &str =
    "EnergyPlus 26.1 PurchasedAirManager.cc:2351";
/// First executable statement deliberately excluded after CP434.
pub const PURCHASED_AIR_CALC_HEATING_OPERATING_MODE_DEADBAND_ASSIGNMENT_FIRST_EXCLUDED_SOURCE:
    &str = "EnergyPlus 26.1 PurchasedAirManager.cc:2361";
/// Sole source site represented by CP434.
pub const PURCHASED_AIR_CALC_HEATING_OPERATING_MODE_DEADBAND_ASSIGNMENT_SOURCE_ORDER: &[&str] =
    &["assign-local-operating-mode-deadband"];

/// One CP433-to-CP434 source-ordered Deadband-assignment witness.
#[allow(missing_docs)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct PurchasedAirCalcHeatingOperatingModeDeadbandAssignmentSnapshot {
...
/// Final selected-unit CP434 lifecycle summary.
#[allow(missing_docs)]
#[derive(Clone, Debug, PartialEq)]
pub struct PurchasedAirCalcHeatingOperatingModeDeadbandAssignmentLifecycleSummary {
    pub source: &'static str,
    pub first_excluded_source: &'static str,
    pub state: PurchasedAirCalcHeatingOperatingModeDeadbandAssignmentRuntimeState,
}

/// Returns the bounded selected-unit CP434 lifecycle summary.
pub fn purchased_air_calc_heating_operating_mode_deadband_assignment_lifecycle_summary(
...
> {
    let unit = runtime.units.get(&system).ok_or(
        PurchasedAirCalcHeatingOperatingModeDeadbandAssignmentError::UnknownSystem { system },
    )?;
    Ok(
        PurchasedAirCalcHeatingOperatingModeDeadbandAssignmentLifecycleSummary {
            ...
            state: unit.calc_heating_operating_mode_deadband_assignment.clone(),
        },
    )
}
