//! Exact CP394 route preservation and CP395 predecessor reconstruction.

use crate::ideal_loads::{
    PURCHASED_AIR_CALC_COOLING_POST_SATURATION_CAPACITY_LIMIT_DEHUMIDIFICATION_CONTROL_HUMIDISTAT_CASE_ENTRY_FIRST_EXCLUDED_SOURCE as PREDECESSOR_EXCLUDED,
    PURCHASED_AIR_CALC_COOLING_POST_SATURATION_CAPACITY_LIMIT_DEHUMIDIFICATION_CONTROL_HUMIDISTAT_CASE_ENTRY_SOURCE as PREDECESSOR_SOURCE,
    PURCHASED_AIR_CALC_COOLING_POST_SATURATION_CAPACITY_LIMIT_DEHUMIDIFICATION_CONTROL_HUMIDISTAT_CASE_ENTRY_SOURCE_ORDER as PREDECESSOR_ORDER,
...
pub(in crate::ideal_loads::calc) fn predecessor_route(
    ...
    let route = crate::ideal_loads::calc::cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_entry_snapshot_route(predecessor)?;
    Some(RetainedRoute {
...
pub(in crate::ideal_loads::calc) fn compressed_snapshot_route(
    ...
    if snapshot.dehumidification_control_humidistat_supply_humidity_ratio_assignment_executed
        != route.active
    {
        return None;
    }
...
pub(in crate::ideal_loads::calc) fn predecessor_snapshot(snapshot: Snapshot) -> Predecessor {
    Predecessor {
        ...
        predecessor_cp393_resulting_supply_humidity_ratio: snapshot
            .predecessor_cp393_resulting_supply_humidity_ratio,
        predecessor_cp393_resulting_supply_enthalpy_j_per_kg: snapshot
            .predecessor_cp393_resulting_supply_enthalpy_j_per_kg,
        predecessor_cp393_resulting_supply_temperature_c: snapshot
            .predecessor_cp393_resulting_supply_temperature_c,
        dehumidification_control_humidistat_case_entered: snapshot
