...
use super::snapshot_validation::{
    cooling_supply_mass_flow_ems_override_guard_snapshot_is_exact_direct_release, snapshot_route,
};
...
pub(super) fn call_order_is_pending_guard(
    ...
    unit.init_call_count == unit.calc_entry.call_count
        ...
        && unit
            ...
            .transition_count
            .checked_add(1)
            == Some(unit.calc_cooling_supply_mass_flow_maximum.transition_count)
...
pub(super) fn pending_guard_state_is_consistent(
    ...
    partition_is_consistent(
        ...
        state.non_cooling_skip_count,
        state.cooling_body_entry_count,
    ) && guard_latest_is_valid(state, unit.controlled_zone, witness)
        ...
        && state
            ...
            == Some(
                unit.calc_cooling_supply_mass_flow_maximum
                    .unit_off_skip_count,
            )
        && state
...
) -> Option<crate::ideal_loads::calc::cooling_supply_mass_flow_maximum::
