//! Exact CP387 route refinement for CP388.

use ep_model::DehumidificationControlType as D;

use crate::ideal_loads::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioCpAirAssignmentSnapshot as Predecessor;
...
pub(in crate::ideal_loads::calc) fn predecessor_route(
    ...
    if !crate::ideal_loads::calc::cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_cp_air_assignment_snapshot_is_exact(predecessor) {
        return None;
    }
