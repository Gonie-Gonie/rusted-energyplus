//! Exact direct CP396 prefix validation for CP397.
...
use crate::ideal_loads::calc::cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_break_snapshots_match_bit_exact;
...
pub(super) fn direct_prefix_is_retained_and_complete(
    ...
    let Some(witness) = runtime
        .cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_break_latest_witness(system.id)
    else {
        return false;
    };
    ...
    classify_no_oa_sensible_subset(system).is_supported()
        ...
        && cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_break_snapshot_is_exact_direct_release(predecessor)
