//! Lossless CP403 snapshot construction and CP402 reconstruction.

use super::routes::RetainedRoute;
use crate::ideal_loads::{
    PURCHASED_AIR_CALC_COOLING_POST_SATURATION_CAPACITY_LIMIT_DEHUMIDIFICATION_CONTROL_CONSTANT_SUPPLY_HUMIDITY_RATIO_LATENT_OUTPUT_GUARD_FIRST_EXCLUDED_SOURCE as PREDECESSOR_EXCLUDED,
    PURCHASED_AIR_CALC_COOLING_POST_SATURATION_CAPACITY_LIMIT_DEHUMIDIFICATION_CONTROL_CONSTANT_SUPPLY_HUMIDITY_RATIO_LATENT_OUTPUT_GUARD_SOURCE as PREDECESSOR_SOURCE,
    PURCHASED_AIR_CALC_COOLING_POST_SATURATION_CAPACITY_LIMIT_DEHUMIDIFICATION_CONTROL_CONSTANT_SUPPLY_HUMIDITY_RATIO_LATENT_OUTPUT_GUARD_SOURCE_ORDER as PREDECESSOR_ORDER,
...
pub(super) fn build_snapshot(
    ...
    let assigned_supply_temperature_c = mixed_air_temperature_c.map(super::source_assignment);
    Snapshot {
        source: SOURCE,
        ...
        predecessor_cp402_cooling_latent_output_w: predecessor.cooling_latent_output_w,
        ...
        predecessor_maximum_total_cooling_capacity_w: predecessor.maximum_total_cooling_capacity_w,
        ...
        predecessor_dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_adjustment_body_entered: predecessor.dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_adjustment_body_entered,
        ...
        predecessor_cp402_resulting_supply_humidity_ratio: predecessor.resulting_supply_humidity_ratio,
        predecessor_cp402_resulting_supply_enthalpy_j_per_kg: predecessor.resulting_supply_enthalpy_j_per_kg,
        predecessor_cp402_resulting_supply_temperature_c: predecessor.resulting_supply_temperature_c,
        dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_adjustment_supply_temperature_mixed_air_assignment_executed: assignment,
        cp329_retained_mixed_air_temperature_owned_read: assignment,
        cp402_same_call_mixed_air_temperature_bit_corroborated: assignment,
        mixed_air_temperature_read: assignment,
        mixed_air_temperature_c,
        supply_temperature_assigned: assignment,
        assigned_supply_temperature_c,
        cp402_retained_supply_humidity_ratio_state_owned: predecessor.resulting_supply_humidity_ratio.is_some(),
        cp402_retained_supply_enthalpy_state_owned: predecessor.resulting_supply_enthalpy_j_per_kg.is_some(),
        cp402_retained_supply_temperature_state_owned: predecessor.resulting_supply_temperature_c.is_some(),
...
pub(in crate::ideal_loads::calc) fn predecessor_snapshot(snapshot: Snapshot) -> Predecessor {
    Predecessor {
        ...
        dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_guard_evaluated: snapshot.predecessor_dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_guard_evaluated,
        cp401_retained_cooling_latent_output_owned_read: snapshot.predecessor_cp401_retained_cooling_latent_output_owned_read,
        cooling_latent_output_read: snapshot.predecessor_cooling_latent_output_read,
        cooling_latent_output_w: snapshot.predecessor_cp402_cooling_latent_output_w,
        cp321_maximum_total_cooling_capacity_owned_read: snapshot.predecessor_cp321_maximum_total_cooling_capacity_owned_read,
        cp340_same_call_maximum_total_cooling_capacity_bit_corroborated: snapshot.predecessor_cp340_same_call_maximum_total_cooling_capacity_bit_corroborated,
        maximum_total_cooling_capacity_read: snapshot.predecessor_maximum_total_cooling_capacity_read,
        maximum_total_cooling_capacity_w: snapshot.predecessor_maximum_total_cooling_capacity_w,
        cooling_latent_output_maximum_total_cooling_capacity_comparison_evaluated: snapshot.predecessor_cooling_latent_output_maximum_total_cooling_capacity_comparison_evaluated,
        cooling_latent_output_greater_than_or_equal_to_maximum_total_cooling_capacity: snapshot.predecessor_cooling_latent_output_greater_than_or_equal_to_maximum_total_cooling_capacity,
        dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_adjustment_body_entered: snapshot.predecessor_dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_adjustment_body_entered,
        dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_guard_false_fallthrough: snapshot.predecessor_dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_guard_false_fallthrough,
        cp401_retained_supply_humidity_ratio_state_owned: snapshot.predecessor_cp401_retained_supply_humidity_ratio_state_owned,
        cp401_retained_supply_enthalpy_state_owned: snapshot.predecessor_cp401_retained_supply_enthalpy_state_owned,
        cp401_retained_supply_temperature_state_owned: snapshot.predecessor_cp401_retained_supply_temperature_state_owned,
        resulting_supply_humidity_ratio: snapshot.predecessor_cp402_resulting_supply_humidity_ratio,
        resulting_supply_enthalpy_j_per_kg: snapshot.predecessor_cp402_resulting_supply_enthalpy_j_per_kg,
        resulting_supply_temperature_c: snapshot.predecessor_cp402_resulting_supply_temperature_c,
    }
}
