//! Bounded CP433 heating-mode guard else-branch entry.
...
pub(in crate::ideal_loads) use release::{
    heating_mode_guard_else_branch_entry_snapshot_is_exact,
...
pub use state::PurchasedAirCalcHeatingModeGuardElseBranchEntryRuntimeState;
#[allow(unused_imports)]
pub(in crate::ideal_loads::calc) use transition::{
    PurchasedAirCalcHeatingModeGuardElseBranchEntryRetainedRoute,
    advance_heating_mode_guard_else_branch_entry_state,
...
/// First executable statement deliberately excluded after CP433.
pub const PURCHASED_AIR_CALC_HEATING_MODE_GUARD_ELSE_BRANCH_ENTRY_FIRST_EXCLUDED_SOURCE: &str =
    "EnergyPlus 26.1 PurchasedAirManager.cc:2351";
/// Sole structural source-control site represented by CP433.
pub const PURCHASED_AIR_CALC_HEATING_MODE_GUARD_ELSE_BRANCH_ENTRY_SOURCE_ORDER: &[&str] =
    &["enter-heating-mode-guard-else-branch-after-guard-false-fallthrough"];

/// One CP432-to-CP433 source-ordered heating-mode guard else-entry witness.
#[allow(missing_docs)]
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct PurchasedAirCalcHeatingModeGuardElseBranchEntrySnapshot {
...
/// Final selected-unit CP433 lifecycle summary.
#[allow(missing_docs)]
#[derive(Clone, Debug, PartialEq)]
pub struct PurchasedAirCalcHeatingModeGuardElseBranchEntryLifecycleSummary {
    pub source: &'static str,
    pub first_excluded_source: &'static str,
    pub state: PurchasedAirCalcHeatingModeGuardElseBranchEntryRuntimeState,
}

/// Returns the bounded selected-unit CP433 lifecycle summary.
pub fn purchased_air_calc_heating_mode_guard_else_branch_entry_lifecycle_summary(
...
> {
    let unit = runtime
        .units
        .get(&system)
        .ok_or(PurchasedAirCalcHeatingModeGuardElseBranchEntryError::UnknownSystem { system })?;
    Ok(PurchasedAirCalcHeatingModeGuardElseBranchEntryLifecycleSummary {
        ...
        state: unit.calc_heating_mode_guard_else_branch_entry.clone(),
    })
}
