//! Exact CP395 route preservation and compressed CP396 route reconstruction.
...
pub(in crate::ideal_loads::calc) fn predecessor_route(
    ...
    let route = crate::ideal_loads::calc::cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_supply_humidity_ratio_assignment_snapshot_route(predecessor)?;
    Some(RetainedRoute {
...
pub(in crate::ideal_loads::calc) fn compressed_snapshot_route(
    ...
    if snapshot
        ...
        || snapshot
            ...
            != constant_shr
        || snapshot.predecessor_dehumidification_control_humidistat_case_entered != active
        || snapshot
            .predecessor_dehumidification_control_humidistat_supply_humidity_ratio_assignment_executed
            != active
        || snapshot.dehumidification_control_humidistat_case_exited_via_break != active
    {
        return None;
    }
    Some(RetainedRoute {
