//! Persistent CP352 runtime-state validation.
...
use crate::ideal_loads::calc::cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_enthalpy_assignment::transition::{
...
pub(in crate::ideal_loads::calc) fn next_transition_fits(
    ...
    predecessor_route(predecessor).is_some_and(|route| {
        pure_next_transition_fits(state, route) && input_fits_route(route, active_operands)
    })
}
