...
use super::{
    ...
    PurchasedAirCalcCoolingConstantShrCaseBreakError as CoolingConstantShrCaseBreakError,
    PurchasedAirCalcCoolingConstantShrSupplyHumidityRatioMinimumLimitError as CoolingConstantShrSupplyHumidityRatioMinimumLimitError,
    ...
    PurchasedAirCalcCoolingDefaultSupplyHumidityRatioCaseBreakError as CoolingDefaultSupplyHumidityRatioCaseBreakError,
    PurchasedAirCalcCoolingDefaultSupplyHumidityRatioMixedAirAssignmentError as CoolingDefaultSupplyHumidityRatioMixedAirAssignmentError,
    ...
    PurchasedAirCalcCoolingHumidistatCaseBreakError as CoolingHumidistatCaseBreakError,
    PurchasedAirCalcCoolingHumidistatCaseEntryError as CoolingHumidistatCaseEntryError,
    ...
    PurchasedAirCalcCoolingPositiveSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioCpAirAssignmentError as CoolingSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioCpAirAssignmentError,
    PurchasedAirCalcCoolingPositiveSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioOverdryingLimitError as CoolingSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioOverdryingLimitError,
    PurchasedAirCalcCoolingPositiveSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioSensibleOutputAssignmentError as CoolingSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioSensibleOutputAssignmentError,
    PurchasedAirCalcCoolingPositiveSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyEnthalpyAssignmentError as CoolingSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyEnthalpyAssignmentError,
    PurchasedAirCalcCoolingPositiveSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioTotalOutputAssignmentError as CoolingSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioTotalOutputAssignmentError,
    ...
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioCaseBreakError as CoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioCaseBreakError,
    ...
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioOverdryingLimitError as CoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioOverdryingLimitError,
    ...
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyHumidityRatioAssignmentError as CoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyHumidityRatioAssignmentError,
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyTemperatureAssignmentError as CoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyTemperatureAssignmentError,
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyTemperatureMixedAirLimitError as CoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyTemperatureMixedAirLimitError,
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlHumidistatCaseEntryError as CoolingPostSaturationCapacityLimitDehumidificationControlHumidistatCaseEntryError,
    ...
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationTotalOutputGuardError as CoolingPostSaturationCapacityLimitDehumidificationTotalOutputGuardError,
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationTotalOutputMaximumCapacityAssignmentError as CoolingPostSaturationCapacityLimitDehumidificationTotalOutputMaximumCapacityAssignmentError,
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationTotalOutputSupplyEnthalpyAssignmentError as CoolingPostSaturationCapacityLimitDehumidificationTotalOutputSupplyEnthalpyAssignmentError,
    ...
    PurchasedAirCalcCoolingSupplyHumidityRatioHumidificationSupplyHumidityRatioMaximumAssignmentError as CoolingSupplyHumidityRatioHumidificationSupplyHumidityRatioMaximumAssignmentError,
    PurchasedAirCalcCoolingSupplyHumidityRatioPreSaturationOriginalAssignmentError as CoolingSupplyHumidityRatioPreSaturationOriginalAssignmentError,
    PurchasedAirCalcCoolingSupplyHumidityRatioSaturationAssignmentError as CoolingSupplyHumidityRatioSaturationAssignmentError,
    PurchasedAirCalcCoolingSupplyHumidityRatioSaturationLimitAssignmentError as CoolingSupplyHumidityRatioSaturationLimitAssignmentError,
...
mod cooling_default_supply_humidity_ratio_case_break;
mod cooling_default_supply_humidity_ratio_mixed_air_assignment;
...
mod cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_cp_air_assignment;
mod cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit;
mod cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_sensible_output_assignment;
mod cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_enthalpy_assignment;
mod cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_total_output_assignment;
...
mod cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_case_break;
mod cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_cp_air_assignment;
mod cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit;
...
mod cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment;
mod cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_assignment;
mod cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_mixed_air_limit;
mod cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_entry;
...
mod cooling_post_saturation_capacity_limit_dehumidification_total_output_guard;
mod cooling_post_saturation_capacity_limit_dehumidification_total_output_maximum_capacity_assignment;
mod cooling_post_saturation_capacity_limit_dehumidification_total_output_supply_enthalpy_assignment;
...
mod cooling_supply_humidity_ratio_humidification_supply_humidity_ratio_maximum_assignment;
mod cooling_supply_humidity_ratio_pre_saturation_original_assignment;
...
use cooling_constant_shr_supply_humidity_ratio_mixed_air_limit::advance_cooling_constant_shr_supply_humidity_ratio_mixed_air_limit;
use cooling_constant_shr_case_break::advance_cooling_constant_shr_case_break;
use cooling_constant_supply_humidity_ratio_case_entry::advance_cooling_constant_supply_humidity_ratio_case_entry;
use cooling_humidistat_case_break::advance_cooling_humidistat_case_break;
use cooling_humidistat_case_entry::advance_cooling_humidistat_case_entry;
...
use cooling_supply_humidity_ratio_humidification_supply_humidity_ratio_maximum_assignment::advance_cooling_supply_humidity_ratio_humidification_supply_humidity_ratio_maximum_assignment;
use cooling_supply_humidity_ratio_pre_saturation_original_assignment::advance_cooling_supply_humidity_ratio_pre_saturation_original_assignment;
use cooling_supply_humidity_ratio_saturation_assignment::advance_cooling_supply_humidity_ratio_saturation_assignment;
use cooling_supply_humidity_ratio_saturation_limit_assignment::{
    advance_cooling_supply_humidity_ratio_saturation_limit_assignment,
...
use cooling_post_saturation_capacity_limit_dehumidification_guard::advance_cooling_post_saturation_capacity_limit_dehumidification_guard;
use cooling_post_saturation_capacity_limit_dehumidification_total_output_assignment::advance_cooling_post_saturation_capacity_limit_dehumidification_total_output_assignment;
use cooling_post_saturation_capacity_limit_dehumidification_total_output_guard::advance_cooling_post_saturation_capacity_limit_dehumidification_total_output_guard;
use cooling_post_saturation_capacity_limit_dehumidification_total_output_maximum_capacity_assignment::advance_cooling_post_saturation_capacity_limit_dehumidification_total_output_maximum_capacity_assignment;
...
use cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_case_break::advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_case_break;
use cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_entry::advance_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_entry;
...
use cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_assignment::advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_assignment;
use cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_mixed_air_limit::advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_mixed_air_limit;
use cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit::advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit;
use cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment::advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment;
...
use cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_cp_air_assignment::advance_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_cp_air_assignment;
use cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit::advance_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit;
use cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_sensible_output_assignment::advance_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_sensible_output_assignment;
use cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_enthalpy_assignment::advance_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_enthalpy_assignment;
use cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_total_output_assignment::advance_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_total_output_assignment;
...
pub enum DirectZonePurchasedAirScheduledCouplingError {
    ...
    /// The bounded constant-sensible-heat-ratio CpAir assignment rejected its release state.
    CalculationCoolingPositiveSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioCpAirAssignment(
        CoolingSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioCpAirAssignmentError,
    ),
    /// The bounded constant-sensible-heat-ratio sensible-output assignment rejected its release state.
    CalculationCoolingPositiveSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioSensibleOutputAssignment(
        CoolingSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioSensibleOutputAssignmentError,
    ),
    /// The bounded constant-sensible-heat-ratio total-output assignment rejected its release state.
    CalculationCoolingPositiveSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioTotalOutputAssignment(
        CoolingSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioTotalOutputAssignmentError,
    ),
    /// The bounded constant-sensible-heat-ratio supply-enthalpy assignment rejected its release state.
    CalculationCoolingPositiveSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyEnthalpyAssignment(
        CoolingSupplyPostCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyEnthalpyAssignmentError,
    ),
    /// The bounded constant-SHR overdrying limit rejected its release state.
    ...
    /// The bounded constant-SHR supply-humidity-ratio minimum limit rejected its release state.
    CalculationCoolingConstantShrSupplyHumidityRatioMinimumLimit(
        CoolingConstantShrSupplyHumidityRatioMinimumLimitError,
    ),
    /// The bounded constant-SHR supply-humidity-ratio mixed-air limit rejected its release state.
    CalculationCoolingConstantShrSupplyHumidityRatioMixedAirLimit(
        CoolingConstantShrSupplyHumidityRatioMixedAirLimitError,
    ),
    /// The bounded constant-SHR case break rejected its release state.
    CalculationCoolingConstantShrCaseBreak(CoolingConstantShrCaseBreakError),
    /// The bounded Humidistat case entry rejected its release state.
    CalculationCoolingHumidistatCaseEntry(CoolingHumidistatCaseEntryError),
    /// The bounded Humidistat moisture-demand assignment rejected its release state.
    CalculationCoolingHumidistatMoistureDemandAssignment(
        CoolingHumidistatMoistureDemandAssignmentError,
    ),
    /// The bounded Humidistat supply-humidity-ratio-for-dehumidification assignment rejected its release state.
    CalculationCoolingHumidistatSupplyHumidityRatioForDehumidificationAssignment(
        CoolingHumidistatSupplyHumidityRatioForDehumidificationAssignmentError,
    ),
    /// The bounded Humidistat supply-humidity-ratio-for-dehumidification minimum limit rejected its release state.
    ...
    /// The bounded Humidistat case break rejected its release state.
    CalculationCoolingHumidistatCaseBreak(CoolingHumidistatCaseBreakError),
    /// The bounded constant-supply-humidity-ratio case entry rejected its release state.
    CalculationCoolingConstantSupplyHumidityRatioCaseEntry(
        CoolingConstantSupplyHumidityRatioCaseEntryError,
    ),
    /// The bounded constant-supply-humidity-ratio assignment rejected its release state.
    ...
    /// The bounded default supply-humidity-ratio mixed-air assignment rejected its release state.
    CalculationCoolingDefaultSupplyHumidityRatioMixedAirAssignment(
        CoolingDefaultSupplyHumidityRatioMixedAirAssignmentError,
    ),
    /// The bounded default supply-humidity-ratio case break rejected its release state.
    ...
    /// The bounded Cooling humidification-control Humidistat guard rejected its release state.
    ...
    /// The bounded humidifying-setpoint moisture-demand assignment rejected its release state.
    CalculationCoolingSupplyHumidityRatioHumidificationMoistureDemandAssignment(
        CoolingSupplyHumidityRatioHumidificationMoistureDemandAssignmentError,
    ),
    /// The bounded humidification supply-humidity-ratio assignment rejected its release state.
    ...
    /// The bounded humidification supply-humidity-ratio maximum assignment rejected its release state.
    CalculationCoolingSupplyHumidityRatioHumidificationSupplyHumidityRatioMaximumAssignment(
        CoolingSupplyHumidityRatioHumidificationSupplyHumidityRatioMaximumAssignmentError,
    ),
    /// The bounded pre-saturation original supply-humidity-ratio assignment rejected its release state.
    CalculationCoolingSupplyHumidityRatioPreSaturationOriginalAssignment(
        CoolingSupplyHumidityRatioPreSaturationOriginalAssignmentError,
    ),
    /// The bounded saturation supply-humidity-ratio assignment rejected its release state.
    CalculationCoolingSupplyHumidityRatioSaturationAssignment(
        CoolingSupplyHumidityRatioSaturationAssignmentError,
    ),
    /// The bounded saturation-limit assignment rejected its release state.
    CalculationCoolingSupplyHumidityRatioSaturationLimitAssignment(
        CoolingSupplyHumidityRatioSaturationLimitAssignmentError,
    ),
    /// The bounded post-saturation supply-enthalpy assignment rejected its release state.
    ...
    /// The bounded post-saturation capacity-limit dehumidification guard rejected its release state.
    CalculationCoolingPostSaturationCapacityLimitDehumidificationGuard(
        CoolingPostSaturationCapacityLimitDehumidificationGuardError,
    ),
    /// The bounded post-saturation dehumidification total-output assignment rejected its release state.
    CalculationCoolingPostSaturationCapacityLimitDehumidificationTotalOutputAssignment(
        CoolingPostSaturationCapacityLimitDehumidificationTotalOutputAssignmentError,
    ),
    /// The bounded post-saturation dehumidification total-output capacity guard rejected its release state.
    CalculationCoolingPostSaturationCapacityLimitDehumidificationTotalOutputGuard(
        CoolingPostSaturationCapacityLimitDehumidificationTotalOutputGuardError,
    ),
    /// The bounded post-saturation dehumidification total-output maximum-capacity assignment rejected its release state.
    CalculationCoolingPostSaturationCapacityLimitDehumidificationTotalOutputMaximumCapacityAssignment(
        CoolingPostSaturationCapacityLimitDehumidificationTotalOutputMaximumCapacityAssignmentError,
    ),
    /// The bounded post-saturation capacity-limited supply-enthalpy assignment rejected its release state.
    CalculationCoolingPostSaturationCapacityLimitDehumidificationTotalOutputSupplyEnthalpyAssignment(
        CoolingPostSaturationCapacityLimitDehumidificationTotalOutputSupplyEnthalpyAssignmentError,
    ),
    /// The bounded post-saturation dehumidification-control switch rejected its release state.
    CalculationCoolingPostSaturationCapacityLimitDehumidificationControlSwitch(
        CoolingPostSaturationCapacityLimitDehumidificationControlSwitchError,
    ),
    /// The bounded post-saturation constant-SHR case-entry and `CpAir` assignment rejected its release state.
    ...
    /// The bounded post-saturation constant-SHR supply-temperature assignment rejected its release state.
    CalculationCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyTemperatureAssignment(
        CoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyTemperatureAssignmentError,
    ),
    /// The bounded post-saturation constant-SHR supply-temperature mixed-air limit rejected its release state.
    CalculationCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyTemperatureMixedAirLimit(
        CoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyTemperatureMixedAirLimitError,
    ),
    /// The bounded post-saturation constant-SHR supply-enthalpy overdrying limit rejected its release state.
    CalculationCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioOverdryingLimit(
        CoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioOverdryingLimitError,
    ),
    /// The bounded post-saturation constant-SHR supply-humidity-ratio assignment rejected its release state.
    CalculationCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyHumidityRatioAssignment(
        CoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyHumidityRatioAssignmentError,
    ),
    /// The bounded post-saturation constant-SHR case break rejected its release state.
    CalculationCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioCaseBreak(
        CoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioCaseBreakError,
    ),
    /// The bounded post-saturation Humidistat case entry rejected its release state.
    CalculationCoolingPostSaturationCapacityLimitDehumidificationControlHumidistatCaseEntry(
        CoolingPostSaturationCapacityLimitDehumidificationControlHumidistatCaseEntryError,
    ),
...
> {
    ...
    let calculation_cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_cp_air_assignment =
        advance_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_cp_air_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_sensible_output_assignment =
        advance_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_sensible_output_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_total_output_assignment =
        advance_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_total_output_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_enthalpy_assignment =
        advance_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_enthalpy_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit =
        advance_positive_supply_post_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_constant_shr_supply_humidity_ratio_minimum_limit =
        advance_cooling_constant_shr_supply_humidity_ratio_minimum_limit(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_constant_shr_supply_humidity_ratio_mixed_air_limit =
        advance_cooling_constant_shr_supply_humidity_ratio_mixed_air_limit(
            input.purchased_air_runtime_state,
            binding.system,
            calculation_cooling_constant_shr_supply_humidity_ratio_minimum_limit,
        )?;
    let calculation_cooling_constant_shr_case_break = advance_cooling_constant_shr_case_break(
        input.purchased_air_runtime_state,
        binding.system,
        calculation_cooling_constant_shr_supply_humidity_ratio_mixed_air_limit,
    )?;
    let calculation_cooling_humidistat_case_entry = advance_cooling_humidistat_case_entry(
        input.purchased_air_runtime_state,
        binding.system,
        calculation_cooling_constant_shr_case_break,
    )?;
    let calculation_cooling_humidistat_moisture_demand_assignment =
        advance_cooling_humidistat_moisture_demand_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_humidistat_supply_humidity_ratio_for_dehumidification_assignment =
        advance_cooling_humidistat_supply_humidity_ratio_for_dehumidification_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_humidistat_supply_humidity_ratio_for_dehumidification_minimum_limit =
        advance_cooling_humidistat_supply_humidity_ratio_for_dehumidification_minimum_limit(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_humidistat_case_break = advance_cooling_humidistat_case_break(
        input.purchased_air_runtime_state,
        binding.system,
    ...
    let calculation_cooling_constant_supply_humidity_ratio_assignment =
        advance_cooling_constant_supply_humidity_ratio_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_default_supply_humidity_ratio_case_break =
        advance_cooling_default_supply_humidity_ratio_case_break(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_supply_humidity_ratio_humidification_control_humidistat_guard =
        advance_cooling_supply_humidity_ratio_humidification_control_humidistat_guard(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_supply_humidity_ratio_humidification_moisture_demand_assignment =
        advance_cooling_supply_humidity_ratio_humidification_moisture_demand_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_supply_humidity_ratio_humidification_supply_humidity_ratio_for_humidification_assignment =
        advance_cooling_supply_humidity_ratio_humidification_supply_humidity_ratio_for_humidification_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_supply_humidity_ratio_humidification_supply_humidity_ratio_maximum_assignment =
        advance_cooling_supply_humidity_ratio_humidification_supply_humidity_ratio_maximum_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_supply_humidity_ratio_pre_saturation_original_assignment =
        advance_cooling_supply_humidity_ratio_pre_saturation_original_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_supply_humidity_ratio_saturation_assignment =
        advance_cooling_supply_humidity_ratio_saturation_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_supply_enthalpy_post_saturation_assignment =
        advance_cooling_supply_enthalpy_post_saturation_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_post_saturation_capacity_limit_dehumidification_guard =
        advance_cooling_post_saturation_capacity_limit_dehumidification_guard(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_post_saturation_capacity_limit_dehumidification_total_output_assignment =
        advance_cooling_post_saturation_capacity_limit_dehumidification_total_output_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_post_saturation_capacity_limit_dehumidification_total_output_guard =
        advance_cooling_post_saturation_capacity_limit_dehumidification_total_output_guard(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_post_saturation_capacity_limit_dehumidification_total_output_maximum_capacity_assignment =
        advance_cooling_post_saturation_capacity_limit_dehumidification_total_output_maximum_capacity_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_post_saturation_capacity_limit_dehumidification_total_output_supply_enthalpy_assignment =
        advance_cooling_post_saturation_capacity_limit_dehumidification_total_output_supply_enthalpy_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_switch =
        advance_cooling_post_saturation_capacity_limit_dehumidification_control_switch(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_cp_air_assignment =
        advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_cp_air_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_assignment =
        advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_mixed_air_limit =
        advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_mixed_air_limit(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit =
        advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment =
        advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_case_break =
        advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_case_break(
            input.purchased_air_runtime_state,
            binding.system,
    ...
    let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_entry =
        advance_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_entry(
            input.purchased_air_runtime_state,
            binding.system,
