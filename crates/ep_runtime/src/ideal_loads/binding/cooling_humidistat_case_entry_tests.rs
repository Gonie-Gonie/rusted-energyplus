...
#[test]
fn scheduled_binding_places_cp358_after_cp357_and_preserves_cp345_numerical_owner() {
    for (cooling_limit, maximum_capacity_w) in [
        ...
        let summary_result = purchased_air_calc_cooling_humidistat_case_entry_lifecycle_summary(
            &runtime,
