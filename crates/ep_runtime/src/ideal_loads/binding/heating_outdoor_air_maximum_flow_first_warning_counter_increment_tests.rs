#[test]
fn scheduled_binding_advances_cp438_after_cp437_before_unchanged_coupling() {
...
#[test]
fn cp438_adapter_accepts_only_the_cp437_snapshot_and_no_scalar_input() {
    let source =
...
#[test]
fn cp438_historical_128_to_129_transition_is_preserved_in_current_131_snapshot_binding() {
