...
fn run_case(
    ...
    .expect("source-ordered CP351 coupling");
    (runtime, output)
}

#[test]
fn scheduled_binding_completes_cp351_direct_none_route_without_operand_or_numeric_work() {
...
#[test]
fn scheduled_binding_preserves_cp351_u_n_and_p_routes_as_complete_null() {
    for (
        cooling_limit,
        maximum_capacity_w,
        independent_load_w,
