...
#[path = "test_coupled_runtime_cp399.rs"]
mod coupled_runtime_tests_cp399;
#[path = "test_coupled_runtime_cp400.rs"]
mod coupled_runtime_tests_cp400;
#[path = "test_coupled_runtime_cp401.rs"]
mod coupled_runtime_tests_cp401;
#[path = "test_coupled_runtime_cp402.rs"]
mod coupled_runtime_tests_cp402;
#[path = "test_coupled_runtime_cp403.rs"]
mod coupled_runtime_tests_cp403;
#[path = "test_coupled_runtime_cp404.rs"]
mod coupled_runtime_tests_cp404;
#[path = "test_coupled_runtime_cp405.rs"]
mod coupled_runtime_tests_cp405;
#[path = "test_coupled_runtime_cp406.rs"]
mod coupled_runtime_tests_cp406;
#[path = "test_coupled_runtime_cp407.rs"]
mod coupled_runtime_tests_cp407;
#[path = "test_coupled_runtime_cp408.rs"]
mod coupled_runtime_tests_cp408;
#[path = "test_coupled_runtime_cp409.rs"]
mod coupled_runtime_tests_cp409;
#[path = "test_coupled_runtime_cp410.rs"]
mod coupled_runtime_tests_cp410;
#[path = "test_coupled_runtime_cp411.rs"]
mod coupled_runtime_tests_cp411;
#[path = "test_coupled_runtime_cp412.rs"]
mod coupled_runtime_tests_cp412;
#[path = "test_coupled_runtime_cp413.rs"]
mod coupled_runtime_tests_cp413;
#[path = "test_coupled_runtime_cp414.rs"]
mod coupled_runtime_tests_cp414;
#[path = "test_coupled_runtime_cp415.rs"]
mod coupled_runtime_tests_cp415;
#[path = "test_coupled_runtime_cp416.rs"]
mod coupled_runtime_tests_cp416;
#[path = "test_coupled_runtime_cp417.rs"]
mod coupled_runtime_tests_cp417;
#[path = "test_coupled_runtime_cp418.rs"]
mod coupled_runtime_tests_cp418;
#[path = "test_coupled_runtime_cp419.rs"]
mod coupled_runtime_tests_cp419;
#[path = "test_coupled_runtime_cp420.rs"]
mod coupled_runtime_tests_cp420;
#[path = "test_coupled_runtime_cp421.rs"]
mod coupled_runtime_tests_cp421;
#[path = "test_coupled_runtime_cp422.rs"]
mod coupled_runtime_tests_cp422;
#[path = "test_coupled_runtime_cp423.rs"]
mod coupled_runtime_tests_cp423;
#[path = "test_coupled_runtime_cp424.rs"]
mod coupled_runtime_tests_cp424;
#[path = "test_coupled_runtime_cp425.rs"]
mod coupled_runtime_tests_cp425;
#[path = "test_coupled_runtime_cp426.rs"]
mod coupled_runtime_tests_cp426;
#[path = "test_coupled_runtime_cp427.rs"]
mod coupled_runtime_tests_cp427;
#[path = "test_coupled_runtime_cp428.rs"]
mod coupled_runtime_tests_cp428;
#[path = "test_coupled_runtime_cp429.rs"]
mod coupled_runtime_tests_cp429;
#[path = "test_coupled_runtime_cp430.rs"]
mod coupled_runtime_tests_cp430;
#[path = "test_coupled_runtime_cp431.rs"]
mod coupled_runtime_tests_cp431;
#[path = "test_coupled_runtime_cp432.rs"]
mod coupled_runtime_tests_cp432;
#[path = "test_coupled_runtime_cp433.rs"]
mod coupled_runtime_tests_cp433;
#[path = "test_coupled_runtime_cp434.rs"]
...
#[path = "test_coupled_runtime_cp440.rs"]
...
fn exact_model_runs_one_source_threshold_coupling_per_fixed_timestep() {
    ...
    }
    {
        let predecessor = &simulation
            ...
            .calc_heating_outdoor_air_maximum_flow_first_warning_guard_lifecycle
            .state;
        let cp438 = &simulation
            .summary
            .calc_heating_outdoor_air_maximum_flow_first_warning_counter_increment_lifecycle;
        let state = &cp438.state;
        assert_eq!(
            cp438.source,
            crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_OUTDOOR_AIR_MAXIMUM_FLOW_FIRST_WARNING_COUNTER_INCREMENT_SOURCE
        );
        assert_eq!(state.transition_count, required_steps);
        assert_eq!(state.transition_count, predecessor.transition_count);
        assert_eq!(
        ...
        let latest = state.latest.expect("latest exact-release CP438 snapshot");
        assert!(!latest.heating_outdoor_air_maximum_flow_first_warning_counter_increment_executed);
        assert!(
            !latest.cp437_retained_outdoor_air_flow_maximum_heating_output_error_count_state_owned
        );
        assert!(!latest.outdoor_air_flow_maximum_heating_output_error_count_increment_performed);
        assert!(
            latest
    ...
    }
    {
        let predecessor = &simulation
            ...
            .calc_heating_outdoor_air_maximum_flow_first_warning_call_lifecycle
            .state;
        let cp440 = &simulation
            .summary
            .calc_heating_outdoor_air_maximum_flow_continue_warning_call_lifecycle;
        let state = &cp440.state;
        assert_eq!(
            cp440.source,
            crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_OUTDOOR_AIR_MAXIMUM_FLOW_CONTINUE_WARNING_CALL_SOURCE
        );
        assert_eq!(state.transition_count, required_steps);
        assert_eq!(state.transition_count, predecessor.transition_count);
        assert_eq!(
        ...
        assert_eq!(
            ...
            predecessor.heating_outdoor_air_maximum_flow_first_warning_call_route_counts
        );
        assert_eq!(state.inactive_transition_count, required_steps);
        assert_eq!(
        ...
        assert_eq!(state.source_site_execution_count, 0);
        assert_eq!(
            state.cp439_outdoor_air_flow_maximum_heating_output_error_count_state_owner_count,
            0
        );
        assert_eq!(
            state.unchanged_outdoor_air_flow_maximum_heating_output_error_count_preservation_count,
        ...
        let latest = state.latest.expect("latest exact-release CP440 snapshot");
        assert!(!latest.heating_outdoor_air_maximum_flow_continue_warning_call_site_reached);
    }
    {
        let predecessor = &simulation
            .summary
            .calc_heating_outdoor_air_maximum_flow_continue_warning_call_lifecycle
            .state;
        let cp441 = &simulation
            .summary
            .calc_heating_outdoor_air_maximum_flow_continue_warning_timestamp_call_lifecycle;
        let state = &cp441.state;
        assert_eq!(
            cp441.source,
            crate::ideal_loads::PURCHASED_AIR_CALC_HEATING_OUTDOOR_AIR_MAXIMUM_FLOW_CONTINUE_WARNING_TIMESTAMP_CALL_SOURCE
        );
        assert_eq!(state.transition_count, required_steps);
        assert_eq!(state.transition_count, predecessor.transition_count);
        assert_eq!(
        ...
        let latest = state.latest.expect("latest exact-release CP441 snapshot");
        assert!(
