//! Release validation for the bounded constant-supply-humidity-ratio case entry.
...
pub(super) fn validate_lifecycle(
    ...
    predecessor_lifecycle: &PurchasedAirCalcCoolingHumidistatCaseBreakLifecycleSummary,
    ...
    if binding.system.dehumidification_control_type != DehumidificationControlType::None
        ...
        || lifecycle.first_excluded_source
            != PURCHASED_AIR_CALC_COOLING_CONSTANT_SUPPLY_HUMIDITY_RATIO_CASE_ENTRY_FIRST_EXCLUDED_SOURCE
        || predecessor_lifecycle.source != PURCHASED_AIR_CALC_COOLING_HUMIDISTAT_CASE_BREAK_SOURCE
        ...
        || !cooling_humidistat_case_break_snapshot_is_exact_direct_release(*predecessor_latest)
        || *predecessor_latest != latest_output.calculation_cooling_humidistat_case_break
        || !cooling_constant_supply_humidity_ratio_case_entry_snapshot_is_exact_direct_release(
            *latest,
        )
        || !cooling_constant_supply_humidity_ratio_case_entry_snapshot_links_to_predecessor(
...
fn validate_counts(
    ...
    predecessor: &PurchasedAirCalcCoolingHumidistatCaseBreakRuntimeState,
    timestep_count: usize,
) -> Result<(), Error> {
    ...
    for (field, expected, actual) in [
        ...
        (
            ...
            predecessor.dehumidification_control_humidistat_case_break_count,
