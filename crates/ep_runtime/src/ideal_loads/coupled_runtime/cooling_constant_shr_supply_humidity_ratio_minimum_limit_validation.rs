//! Release validation for the bounded constant-SHR supply-humidity-ratio minimum limit.
...
pub(super) fn validate_lifecycle(
    lifecycle: &PurchasedAirCalcCoolingConstantShrSupplyHumidityRatioMinimumLimitLifecycleSummary,
...
fn violation(field: &'static str, expected: usize, actual: usize) -> Error {
    Error::CalcCoolingConstantShrSupplyHumidityRatioMinimumLimitLifecycleInvariant {
        field,
        expected,
        actual,
    }
