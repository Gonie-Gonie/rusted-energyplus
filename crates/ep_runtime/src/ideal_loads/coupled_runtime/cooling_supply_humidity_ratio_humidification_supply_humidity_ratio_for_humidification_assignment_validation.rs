//! Release validation for the bounded humidification supply-humidity-ratio assignment.
...
use crate::ideal_loads::{
    ...
    PurchasedAirCalcCoolingSupplyHumidityRatioHumidificationMoistureDemandAssignmentSnapshot as PredecessorSnapshot,
...
fn validate_counts(
    ...
    for (field, expected, actual) in [
        ...
        (
            ...
            predecessor.humidification_moisture_demand_assignment_count,
            state.supply_humidity_ratio_for_humidification_assignment_count,
        ),
        (
            "direct_dehumidification_control_humidistat_supply_humidity_ratio_for_humidification_assignment_count",
            0,
            state.dehumidification_control_humidistat_supply_humidity_ratio_for_humidification_assignment_count,
        ),
        (
            "direct_dehumidification_control_none_supply_humidity_ratio_for_humidification_assignment_count",
            0,
            state.dehumidification_control_none_supply_humidity_ratio_for_humidification_assignment_count,
        ),
        (
        ...
        (
            "direct_supply_humidity_ratio_for_humidification_assignment_count",
            0,
            state.supply_humidity_ratio_for_humidification_assignment_count,
        ),
    ] {
...
pub(in crate::ideal_loads) fn expected_snapshot(predecessor: PredecessorSnapshot) -> Snapshot {
    Snapshot {
        ...
        predecessor_dehumidification_control_type_first_read:
            predecessor.predecessor_dehumidification_control_type_first_read,
        predecessor_first_dehumidification_control_type:
            predecessor.predecessor_first_dehumidification_control_type,
        predecessor_dehumidification_control_type_humidistat:
            predecessor.predecessor_dehumidification_control_type_humidistat,
        predecessor_dehumidification_control_type_second_read:
            predecessor.predecessor_dehumidification_control_type_second_read,
        predecessor_second_dehumidification_control_type:
            predecessor.predecessor_second_dehumidification_control_type,
        predecessor_dehumidification_control_type_none:
            predecessor.predecessor_dehumidification_control_type_none,
        predecessor_dehumidification_control_body_entered:
            predecessor.predecessor_dehumidification_control_body_entered,
...
mod tests {
    ...
    fn partition_overflow_and_source_corruption_fail_closed() {
        ...
        active.dehumidification_control_none_supply_humidity_ratio_for_humidification_assignment_count = 1;
        active.supply_humidity_ratio_for_humidification_assignment_count = 1;
        ...
        active.supply_humidity_ratio_for_humidification_calculation_count = 1;
