//! Exact CP409-to-CP410 compressed carrier lineage helpers.
...
fn control_flags(snapshot: Snapshot) -> [bool; 32] {
    [
...
fn predecessor_control_flags(snapshot: Predecessor) -> [bool; 32] {
    [
        snapshot.unit_off_skipped,
        snapshot.non_cooling_skipped,
        snapshot.positive_guard_false_fallthrough_skipped,
