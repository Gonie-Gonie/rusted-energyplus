//! Coupled-runtime validation for CP379 post-saturation supply-enthalpy evidence.
...
pub(in crate::ideal_loads) fn validate_lifecycle(
    lifecycle: &Lifecycle,
    humidity_predecessor: &HumidityLifecycle,
    temperature_predecessor: &TemperatureLifecycle,
    ...
    lifecycle::validate(
        lifecycle,
        humidity_predecessor,
        temperature_predecessor,
        timestep_count,
        latest_output,
        binding,
    )
