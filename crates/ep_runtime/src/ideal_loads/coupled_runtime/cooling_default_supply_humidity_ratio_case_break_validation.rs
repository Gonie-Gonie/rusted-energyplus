//! Release validation for the bounded default supply-humidity-ratio case break.
...
pub(super) fn snapshot_matches_release(
    ...
    let predecessor = output.calculation_cooling_default_supply_humidity_ratio_mixed_air_assignment;
...
pub(super) fn validate_lifecycle(
    ...
    predecessor_lifecycle: &PurchasedAirCalcCoolingDefaultSupplyHumidityRatioMixedAirAssignmentLifecycleSummary,
    ...
    if binding.system.dehumidification_control_type != DehumidificationControlType::None
        ...
        || *predecessor_latest
            != latest_output.calculation_cooling_default_supply_humidity_ratio_mixed_air_assignment
        || !cooling_default_supply_humidity_ratio_case_break_snapshot_is_exact_direct_release(
            *latest,
        )
...
fn validate_counts(
    ...
    predecessor: &PurchasedAirCalcCoolingDefaultSupplyHumidityRatioMixedAirAssignmentRuntimeState,
    timestep_count: usize,
) -> Result<(), Error> {
    validate_route_partition(state)?;
    validate_predecessor_route_partition(predecessor)?;
    for (field, expected, actual) in [
        ...
        (
            ...
            0,
            predecessor.mixed_air_humidity_ratio_read_count,
        ),
        (
...
fn validate_predecessor_route_partition(
...
pub(super) fn expected_snapshot(
    ...
    PurchasedAirCalcCoolingDefaultSupplyHumidityRatioCaseBreakSnapshot {
        ...
        predecessor_dehumidification_control_default_supply_humidity_ratio_mixed_air_assignment_executed:
            predecessor.dehumidification_control_default_supply_humidity_ratio_mixed_air_assignment_executed,
