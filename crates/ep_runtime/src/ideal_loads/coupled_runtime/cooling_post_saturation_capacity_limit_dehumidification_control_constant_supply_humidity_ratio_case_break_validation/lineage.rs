//! Exact CP408-to-CP409 compressed carrier lineage helpers.
...
fn control_flags(snapshot: Snapshot) -> [bool; 31] {
    [
...
fn predecessor_control_flags(snapshot: Predecessor) -> [bool; 31] {
    [
        snapshot.unit_off_skipped,
        snapshot.non_cooling_skipped,
        snapshot.positive_guard_false_fallthrough_skipped,
...
fn clear_values(snapshot: &mut Snapshot) {
    snapshot.predecessor_cp408_resulting_supply_humidity_ratio = None;
    snapshot.predecessor_cp408_resulting_supply_enthalpy_j_per_kg = None;
    snapshot.predecessor_cp408_resulting_supply_temperature_c = None;
