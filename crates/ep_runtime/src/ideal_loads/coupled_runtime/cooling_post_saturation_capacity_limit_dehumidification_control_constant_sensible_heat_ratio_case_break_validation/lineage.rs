//! Exact CP392-to-CP393 compact carrier lineage helpers.
...
fn control_flags(snapshot: Snapshot) -> [bool; 25] {
    [
        ...
        snapshot.predecessor_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment_executed,
    ]
}

fn predecessor_control_flags(snapshot: Predecessor) -> [bool; 25] {
    [
        snapshot.unit_off_skipped,
        snapshot.non_cooling_skipped,
        snapshot.positive_guard_false_fallthrough_skipped,
...
fn clear_values(snapshot: &mut Snapshot) {
    snapshot.predecessor_cp392_resulting_supply_humidity_ratio = None;
    snapshot.predecessor_cp392_resulting_supply_enthalpy_j_per_kg = None;
    snapshot.predecessor_cp392_resulting_supply_temperature_c = None;
