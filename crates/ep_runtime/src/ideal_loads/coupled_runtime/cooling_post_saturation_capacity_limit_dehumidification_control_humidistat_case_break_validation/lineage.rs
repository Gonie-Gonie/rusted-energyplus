//! Exact CP395-to-CP396 compact carrier lineage helpers.
...
fn clear_values(snapshot: &mut Snapshot) {
    snapshot.predecessor_cp395_resulting_supply_humidity_ratio = None;
    snapshot.predecessor_cp395_resulting_supply_enthalpy_j_per_kg = None;
    snapshot.predecessor_cp395_resulting_supply_temperature_c = None;
