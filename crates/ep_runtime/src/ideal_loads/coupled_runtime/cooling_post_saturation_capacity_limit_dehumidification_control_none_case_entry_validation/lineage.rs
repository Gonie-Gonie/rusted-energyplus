//! Exact CP396-to-CP397 compact carrier lineage helpers.
...
pub(super) fn none_case_shape_is_exact(snapshot: Snapshot, predecessor: Predecessor) -> bool {
...
fn clear_values(snapshot: &mut Snapshot) {
    snapshot.predecessor_cp396_resulting_supply_humidity_ratio = None;
    snapshot.predecessor_cp396_resulting_supply_enthalpy_j_per_kg = None;
    snapshot.predecessor_cp396_resulting_supply_temperature_c = None;
