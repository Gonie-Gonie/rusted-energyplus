//! JSON serialization for one CP354 snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingConstantShrSupplyHumidityRatioOverdryingLimitSnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "predecessor_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit_executed":
            snapshot.predecessor_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit_executed,
        ...
        "dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_overdrying_limit_executed":
            snapshot.dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_overdrying_limit_executed,
        ...
        "supply_humidity_ratio_before_overdrying_limit":
            json_number(snapshot.supply_humidity_ratio_before_overdrying_limit),
        "supply_humidity_ratio_before_overdrying_limit_ieee_bits":
            ieee_bits(snapshot.supply_humidity_ratio_before_overdrying_limit),
        ...
        "psychrometric_supply_humidity_ratio":
            json_number(snapshot.psychrometric_supply_humidity_ratio),
        "psychrometric_supply_humidity_ratio_ieee_bits":
            ieee_bits(snapshot.psychrometric_supply_humidity_ratio),
...
mod tests {
    ...
    #[test]
    fn direct_none_release_serializes_seven_null_values_and_bits() {
    ...
    fn snapshot(
        ...
        PurchasedAirCalcCoolingConstantShrSupplyHumidityRatioOverdryingLimitSnapshot {
            ...
            supply_humidity_ratio_for_overdrying_limit_minimum_read: active,
            supply_humidity_ratio_before_overdrying_limit: numeric,
            ...
            supply_enthalpy_j_per_kg: numeric,
            psychrometric_supply_humidity_ratio_evaluated: active,
            psychrometric_supply_humidity_ratio: numeric,
            source_shaped_two_argument_minimum_evaluated: active,
            minimum_supply_humidity_ratio: numeric,
