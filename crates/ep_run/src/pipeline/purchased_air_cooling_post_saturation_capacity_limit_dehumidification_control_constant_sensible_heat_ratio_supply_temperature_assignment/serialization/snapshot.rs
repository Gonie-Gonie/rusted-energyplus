//! JSON serialization for one CP389 supply-temperature assignment snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyTemperatureAssignmentSnapshot;
use serde_json::{Value, json};

pub(super) fn snapshot_json(
    snapshot: PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyTemperatureAssignmentSnapshot,
) -> Value {
    json!({
        ...
        "dehumidification_control_constant_sensible_heat_ratio_supply_temperature_assignment_executed": snapshot.dehumidification_control_constant_sensible_heat_ratio_supply_temperature_assignment_executed,
        "cp379_retained_supply_temperature_state_owned": snapshot.cp379_retained_supply_temperature_state_owned,
        ...
        "cp388_retained_cooling_sensible_output_owned_read": snapshot.cp388_retained_cooling_sensible_output_owned_read,
        ...
        "cp387_retained_cp_air_owned_read": snapshot.cp387_retained_cp_air_owned_read,
        ...
        "cp_air_times_supply_mass_flow_rate_calculated": snapshot.cp_air_times_supply_mass_flow_rate_calculated,
        "cp_air_times_supply_mass_flow_rate_w_per_k": json_number(snapshot.cp_air_times_supply_mass_flow_rate_w_per_k),
        "cp_air_times_supply_mass_flow_rate_w_per_k_ieee_bits": ieee_bits(snapshot.cp_air_times_supply_mass_flow_rate_w_per_k),
        ...
        "calculated_supply_temperature_c": json_number(snapshot.calculated_supply_temperature_c),
        "calculated_supply_temperature_c_ieee_bits": ieee_bits(snapshot.calculated_supply_temperature_c),
