//! JSON serialization for one compact CP393 case-break snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioCaseBreakSnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "predecessor_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment_executed": snapshot.predecessor_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment_executed,
        "predecessor_cp392_resulting_supply_humidity_ratio": json_number(snapshot.predecessor_cp392_resulting_supply_humidity_ratio),
        "predecessor_cp392_resulting_supply_humidity_ratio_ieee_bits": ieee_bits(snapshot.predecessor_cp392_resulting_supply_humidity_ratio),
        "predecessor_cp392_resulting_supply_enthalpy_j_per_kg": json_number(snapshot.predecessor_cp392_resulting_supply_enthalpy_j_per_kg),
        "predecessor_cp392_resulting_supply_enthalpy_j_per_kg_ieee_bits": ieee_bits(snapshot.predecessor_cp392_resulting_supply_enthalpy_j_per_kg),
        "predecessor_cp392_resulting_supply_temperature_c": json_number(snapshot.predecessor_cp392_resulting_supply_temperature_c),
        "predecessor_cp392_resulting_supply_temperature_c_ieee_bits": ieee_bits(snapshot.predecessor_cp392_resulting_supply_temperature_c),
        "dehumidification_control_constant_sensible_heat_ratio_case_exited_via_break": snapshot.dehumidification_control_constant_sensible_heat_ratio_case_exited_via_break,
