...
fn six_compact_carriers_serialize_with_adjacent_ieee_sidecars() {
    ...
    assert!(value["predecessor_cp392_resulting_supply_humidity_ratio"].is_null());
...
fn six_nonfinite_carriers_project_null_and_preserve_nan_payload_bits() {
    let nan = f64::from_bits(0x7ff8_0000_0000_0393);
...
pub(in crate::pipeline) fn snapshot(
    ...
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioCaseBreakSnapshot {
        ...
        predecessor_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment_executed: predecessor.dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment_executed,
        predecessor_cp392_resulting_supply_humidity_ratio: predecessor.resulting_supply_humidity_ratio,
        predecessor_cp392_resulting_supply_enthalpy_j_per_kg: predecessor.resulting_supply_enthalpy_j_per_kg,
        predecessor_cp392_resulting_supply_temperature_c: predecessor.resulting_supply_temperature_c,
        dehumidification_control_constant_sensible_heat_ratio_case_exited_via_break: predecessor.dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment_executed,
