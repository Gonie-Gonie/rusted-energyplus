...
fn full_active_snapshot_projects_nonfinite_values_to_null_with_exact_bits() {
    let nan = f64::from_bits(0x7ff8_0000_0000_0390);
...
fn source_local_fields() -> [&'static str; 4] {
    [
        "supply_temperature_before_mixed_air_limit_c",
        "mixed_air_temperature_c",
        "minimum_supply_temperature_c",
...
pub(in crate::pipeline) fn snapshot(
    ...
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyTemperatureMixedAirLimitSnapshot {
        ...
        predecessor_resulting_supply_enthalpy_j_per_kg: value,
        predecessor_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_assignment_executed: active,
        predecessor_cp379_retained_supply_temperature_state_owned: value.is_some(),
        predecessor_preexisting_supply_temperature_c: value,
        predecessor_cp329_retained_mixed_air_temperature_owned_read: active,
        predecessor_mixed_air_temperature_read: active,
        predecessor_mixed_air_temperature_c: local,
        predecessor_cp388_retained_cooling_sensible_output_owned_read: active,
        predecessor_cooling_sensible_output_read: active,
        predecessor_cp389_cooling_sensible_output_w: local,
        predecessor_cp387_retained_cp_air_owned_read: active,
        predecessor_cp_air_read: active,
        predecessor_cp389_cp_air_j_per_kg_k: local,
        ...
        predecessor_supply_mass_flow_rate_kg_per_s: local,
        predecessor_cp_air_times_supply_mass_flow_rate_calculated: active,
        predecessor_cp_air_times_supply_mass_flow_rate_w_per_k: local,
        predecessor_cooling_sensible_output_over_air_capacity_rate_calculated: active,
        predecessor_cooling_sensible_output_over_air_capacity_rate_k: local,
        predecessor_supply_temperature_calculated: active,
        predecessor_calculated_supply_temperature_c: local,
        predecessor_supply_temperature_assigned: active,
        predecessor_assigned_supply_temperature_c: local,
        predecessor_resulting_supply_temperature_c: value,
        resulting_supply_enthalpy_j_per_kg: value,
        dehumidification_control_constant_sensible_heat_ratio_supply_temperature_mixed_air_limit_executed: active,
        cp389_retained_supply_temperature_state_owned: value.is_some(),
        preexisting_supply_temperature_c: value,
        cp389_retained_supply_temperature_owned_read: active,
        supply_temperature_for_minimum_read: active,
        supply_temperature_before_mixed_air_limit_c: local,
        cp329_retained_mixed_air_temperature_owned_read: active,
        cp389_mixed_air_temperature_bit_corroborated: active,
        ...
        minimum_supply_temperature_c: local,
