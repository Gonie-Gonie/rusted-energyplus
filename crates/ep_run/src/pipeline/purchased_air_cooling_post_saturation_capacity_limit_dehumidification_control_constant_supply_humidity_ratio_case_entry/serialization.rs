//! JSON serialization for CP398 lifecycle evidence.

use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSupplyHumidityRatioCaseEntryLifecycleSummary;
...
pub(in crate::pipeline) fn lifecycle_json(
    lifecycle: &PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSupplyHumidityRatioCaseEntryLifecycleSummary,
) -> Value {
    ...
    json!({
        ...
        "dehumidification_control_constant_supply_humidity_ratio_case_entry_count": state.dehumidification_control_constant_supply_humidity_ratio_case_entry_count,
...
mod tests {
    ...
    use ep_runtime::{
        ...
        PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSupplyHumidityRatioCaseEntryRuntimeState,
    };
    ...
    fn lifecycle_serializes_direct_active_none_entry_and_thirty_route_slots() {
        let mut state = PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSupplyHumidityRatioCaseEntryRuntimeState::new(
        ...
        let value = lifecycle_json(&PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSupplyHumidityRatioCaseEntryLifecycleSummary {
        ...
        assert_eq!(
            value["dehumidification_control_constant_supply_humidity_ratio_case_entry_count"],
            1
        );
