//! Lossless JSON serialization for one compact CP406 else-entry snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSupplyHumidityRatioLatentOutputCapacityGuardElseBranchEntrySnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "predecessor_cp405_resulting_supply_humidity_ratio": json_number(snapshot.predecessor_cp405_resulting_supply_humidity_ratio),
        "predecessor_cp405_resulting_supply_humidity_ratio_ieee_bits": ieee_bits(snapshot.predecessor_cp405_resulting_supply_humidity_ratio),
        "predecessor_cp405_resulting_supply_enthalpy_j_per_kg": json_number(snapshot.predecessor_cp405_resulting_supply_enthalpy_j_per_kg),
        "predecessor_cp405_resulting_supply_enthalpy_j_per_kg_ieee_bits": ieee_bits(snapshot.predecessor_cp405_resulting_supply_enthalpy_j_per_kg),
        "predecessor_cp405_resulting_supply_temperature_c": json_number(snapshot.predecessor_cp405_resulting_supply_temperature_c),
        "predecessor_cp405_resulting_supply_temperature_c_ieee_bits": ieee_bits(snapshot.predecessor_cp405_resulting_supply_temperature_c),
        "dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_guard_else_branch_entered": snapshot.dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_guard_else_branch_entered,
