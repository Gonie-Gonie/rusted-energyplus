//! JSON serialization for one compact CP396 case-break snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlHumidistatCaseBreakSnapshot;
use serde_json::{Value, json};

pub(super) fn snapshot_json(
    snapshot: PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlHumidistatCaseBreakSnapshot,
) -> Value {
    json!({
        ...
        "predecessor_cp395_resulting_supply_humidity_ratio": json_number(snapshot.predecessor_cp395_resulting_supply_humidity_ratio),
        "predecessor_cp395_resulting_supply_humidity_ratio_ieee_bits": ieee_bits(snapshot.predecessor_cp395_resulting_supply_humidity_ratio),
        "predecessor_cp395_resulting_supply_enthalpy_j_per_kg": json_number(snapshot.predecessor_cp395_resulting_supply_enthalpy_j_per_kg),
        "predecessor_cp395_resulting_supply_enthalpy_j_per_kg_ieee_bits": ieee_bits(snapshot.predecessor_cp395_resulting_supply_enthalpy_j_per_kg),
        "predecessor_cp395_resulting_supply_temperature_c": json_number(snapshot.predecessor_cp395_resulting_supply_temperature_c),
        "predecessor_cp395_resulting_supply_temperature_c_ieee_bits": ieee_bits(snapshot.predecessor_cp395_resulting_supply_temperature_c),
        "dehumidification_control_humidistat_case_exited_via_break": snapshot.dehumidification_control_humidistat_case_exited_via_break,
