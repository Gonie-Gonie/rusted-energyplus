//! Lossless JSON serialization for one CP401 latent-output snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSupplyHumidityRatioLatentOutputAssignmentSnapshot;
use serde_json::{Value, json};

pub(super) fn snapshot_json(
    snapshot: PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSupplyHumidityRatioLatentOutputAssignmentSnapshot,
) -> Value {
    json!({
        ...
        "dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_assignment_executed": snapshot.dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_assignment_executed,
        "cp400_retained_supply_humidity_ratio_state_owned": snapshot.cp400_retained_supply_humidity_ratio_state_owned,
        "cp400_retained_supply_enthalpy_state_owned": snapshot.cp400_retained_supply_enthalpy_state_owned,
        "cp400_retained_supply_temperature_state_owned": snapshot.cp400_retained_supply_temperature_state_owned,
        ...
        "cp400_retained_cooling_sensible_output_owned_read": snapshot.cp400_retained_cooling_sensible_output_owned_read,
        ...
        "cooling_latent_output_calculated": snapshot.cooling_latent_output_calculated,
        "calculated_cooling_latent_output_w": json_number(snapshot.calculated_cooling_latent_output_w),
        "calculated_cooling_latent_output_w_ieee_bits": ieee_bits(snapshot.calculated_cooling_latent_output_w),
        "cooling_latent_output_assigned": snapshot.cooling_latent_output_assigned,
        "cooling_latent_output_w": json_number(snapshot.cooling_latent_output_w),
        "cooling_latent_output_w_ieee_bits": ieee_bits(snapshot.cooling_latent_output_w),
