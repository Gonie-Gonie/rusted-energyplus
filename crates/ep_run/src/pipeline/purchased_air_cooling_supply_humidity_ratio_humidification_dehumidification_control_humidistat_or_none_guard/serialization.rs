//! JSON serialization for CP371 lifecycle evidence.

use ep_runtime::PurchasedAirCalcCoolingSupplyHumidityRatioHumidificationDehumidificationControlHumidistatOrNoneGuardLifecycleSummary;
