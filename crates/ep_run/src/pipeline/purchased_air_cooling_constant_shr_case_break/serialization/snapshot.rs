//! JSON serialization for one CP357 case-break snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingConstantShrCaseBreakSnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "predecessor_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_mixed_air_limit_executed":
            snapshot.predecessor_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_mixed_air_limit_executed,
...
mod tests {
    ...
    fn direct_none_release_serializes_complete_false_break_skip() {
        ...
        assert_eq!(
            value["dehumidification_control_humidistat_case_selected_skip"],
            false
        );
    }

    #[test]
    fn active_case_break_serializes_true_without_humidistat_fallthrough() {
    ...
    fn snapshot(active: bool) -> PurchasedAirCalcCoolingConstantShrCaseBreakSnapshot {
        PurchasedAirCalcCoolingConstantShrCaseBreakSnapshot {
            ...
            dehumidification_control_constant_sensible_heat_ratio_case_exited_via_break: active,
