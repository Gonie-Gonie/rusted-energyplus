//! JSON serialization for one compact CP394 Humidistat case-entry snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlHumidistatCaseEntrySnapshot;
use serde_json::{Value, json};

pub(super) fn snapshot_json(
    snapshot: PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlHumidistatCaseEntrySnapshot,
) -> Value {
    json!({
        ...
        "dehumidification_control_humidistat_case_entered": snapshot.dehumidification_control_humidistat_case_entered,
