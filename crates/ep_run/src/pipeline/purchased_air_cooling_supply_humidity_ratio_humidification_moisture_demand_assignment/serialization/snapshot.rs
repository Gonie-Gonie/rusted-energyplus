//! JSON serialization for one CP372 humidifying-demand assignment snapshot.

use ep_model::{DehumidificationControlType, HumidificationControlType};
use ep_runtime::PurchasedAirCalcCoolingSupplyHumidityRatioHumidificationMoistureDemandAssignmentSnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "assigned_zone_humidifying_setpoint_moisture_demand_kg_per_s":
            json_number(snapshot.assigned_zone_humidifying_setpoint_moisture_demand_kg_per_s),
        "assigned_zone_humidifying_setpoint_moisture_demand_kg_per_s_ieee_bits":
            ieee_bits(snapshot.assigned_zone_humidifying_setpoint_moisture_demand_kg_per_s),
        "resulting_zone_humidifying_setpoint_moisture_demand_kg_per_s":
            json_number(snapshot.resulting_zone_humidifying_setpoint_moisture_demand_kg_per_s),
        "resulting_zone_humidifying_setpoint_moisture_demand_kg_per_s_ieee_bits":
            ieee_bits(snapshot.resulting_zone_humidifying_setpoint_moisture_demand_kg_per_s),
    })
}
