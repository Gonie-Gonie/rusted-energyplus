//! JSON serialization for one compact CP395 assignment snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlHumidistatSupplyHumidityRatioAssignmentSnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "predecessor_cp393_resulting_supply_humidity_ratio": json_number(snapshot.predecessor_cp393_resulting_supply_humidity_ratio),
        "predecessor_cp393_resulting_supply_humidity_ratio_ieee_bits": ieee_bits(snapshot.predecessor_cp393_resulting_supply_humidity_ratio),
        "predecessor_cp393_resulting_supply_enthalpy_j_per_kg": json_number(snapshot.predecessor_cp393_resulting_supply_enthalpy_j_per_kg),
        "predecessor_cp393_resulting_supply_enthalpy_j_per_kg_ieee_bits": ieee_bits(snapshot.predecessor_cp393_resulting_supply_enthalpy_j_per_kg),
        "predecessor_cp393_resulting_supply_temperature_c": json_number(snapshot.predecessor_cp393_resulting_supply_temperature_c),
        "predecessor_cp393_resulting_supply_temperature_c_ieee_bits": ieee_bits(snapshot.predecessor_cp393_resulting_supply_temperature_c),
        ...
        "predecessor_cp394_resulting_supply_humidity_ratio": json_number(snapshot.predecessor_cp394_resulting_supply_humidity_ratio),
        "predecessor_cp394_resulting_supply_humidity_ratio_ieee_bits": ieee_bits(snapshot.predecessor_cp394_resulting_supply_humidity_ratio),
        "predecessor_cp394_resulting_supply_enthalpy_j_per_kg": json_number(snapshot.predecessor_cp394_resulting_supply_enthalpy_j_per_kg),
        "predecessor_cp394_resulting_supply_enthalpy_j_per_kg_ieee_bits": ieee_bits(snapshot.predecessor_cp394_resulting_supply_enthalpy_j_per_kg),
        "predecessor_cp394_resulting_supply_temperature_c": json_number(snapshot.predecessor_cp394_resulting_supply_temperature_c),
        "predecessor_cp394_resulting_supply_temperature_c_ieee_bits": ieee_bits(snapshot.predecessor_cp394_resulting_supply_temperature_c),
        "dehumidification_control_humidistat_supply_humidity_ratio_assignment_executed": snapshot.dehumidification_control_humidistat_supply_humidity_ratio_assignment_executed,
        "cp394_retained_supply_humidity_ratio_state_owned": snapshot.cp394_retained_supply_humidity_ratio_state_owned,
        "cp394_retained_supply_temperature_state_owned": snapshot.cp394_retained_supply_temperature_state_owned,
        "cp394_retained_supply_enthalpy_state_owned": snapshot.cp394_retained_supply_enthalpy_state_owned,
        "cp394_retained_supply_temperature_owned_read": snapshot.cp394_retained_supply_temperature_owned_read,
        ...
        "cp394_retained_supply_enthalpy_owned_read": snapshot.cp394_retained_supply_enthalpy_owned_read,
