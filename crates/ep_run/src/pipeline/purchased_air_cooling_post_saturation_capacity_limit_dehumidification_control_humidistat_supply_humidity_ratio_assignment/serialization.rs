//! JSON serialization for CP395 lifecycle evidence.

use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlHumidistatSupplyHumidityRatioAssignmentLifecycleSummary;
...
pub(in crate::pipeline) fn lifecycle_json(
    lifecycle: &PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlHumidistatSupplyHumidityRatioAssignmentLifecycleSummary,
) -> Value {
    ...
    json!({
        ...
        "dehumidification_control_humidistat_supply_humidity_ratio_assignment_count": state.dehumidification_control_humidistat_supply_humidity_ratio_assignment_count,
        "predecessor_route_counts": state.predecessor_route_counts,
        "source_site_execution_count": state.source_site_execution_count,
        "cp394_supply_humidity_ratio_state_owner_count": state.cp394_supply_humidity_ratio_state_owner_count,
        "unchanged_supply_humidity_ratio_preservation_count": state.unchanged_supply_humidity_ratio_preservation_count,
        "cp394_supply_temperature_state_owner_count": state.cp394_supply_temperature_state_owner_count,
        "unchanged_supply_temperature_preservation_count": state.unchanged_supply_temperature_preservation_count,
        "cp394_supply_enthalpy_state_owner_count": state.cp394_supply_enthalpy_state_owner_count,
...
mod tests {
    ...
    fn lifecycle_serializes_direct_skip_and_thirty_route_slots() {
        let mut state = PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlHumidistatSupplyHumidityRatioAssignmentRuntimeState::new(IdealLoadsAirSystemId(0));
        state.transition_count = 1;
        state.inactive_transition_count = 1;
        state.predecessor_route_counts[0] = 1;
        let value = lifecycle_json(&PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlHumidistatSupplyHumidityRatioAssignmentLifecycleSummary {
        ...
        assert_eq!(
            value["dehumidification_control_humidistat_supply_humidity_ratio_assignment_count"],
            0
        );
