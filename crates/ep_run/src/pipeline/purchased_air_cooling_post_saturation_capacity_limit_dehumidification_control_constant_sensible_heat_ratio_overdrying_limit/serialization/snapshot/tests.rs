...
#[test]
fn full_active_snapshot_projects_all_nonfinite_values_to_null_with_exact_bits() {
...
fn numeric_fields() -> [&'static str; 33] {
    [
...
pub(in crate::pipeline) fn snapshot(
    ...
    let predecessor = crate::pipeline::purchased_air_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_mixed_air_limit::test_snapshot(value, active);
    ...
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioOverdryingLimitSnapshot {
        ...
        cp390_retained_supply_enthalpy_state_owned: value.is_some(),
        preexisting_supply_enthalpy_j_per_kg: value,
        cp390_retained_supply_enthalpy_owned_read: active,
        supply_enthalpy_for_overdrying_limit_maximum_read: active,
        supply_enthalpy_before_overdrying_limit_j_per_kg: local,
        cp390_retained_supply_temperature_owned_read: active,
        ...
        psychrometric_minimum_supply_enthalpy_j_per_kg: local,
        source_shaped_two_argument_maximum_evaluated: active,
        maximum_supply_enthalpy_j_per_kg: local,
        supply_enthalpy_assignment_performed: active,
        assigned_supply_enthalpy_j_per_kg: local,
