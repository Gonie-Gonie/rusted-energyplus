//! JSON serialization for one CP367 default supply-humidity-ratio mixed-air assignment.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingDefaultSupplyHumidityRatioMixedAirAssignmentSnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "predecessor_dehumidification_control_constant_supply_humidity_ratio_case_exited_via_break":
            snapshot.predecessor_dehumidification_control_constant_supply_humidity_ratio_case_exited_via_break,
...
mod tests {
    ...
    #[test]
    fn direct_none_release_serializes_typed_default_assignment_skip() {
        ...
        assert_eq!(
            value["dehumidification_control_default_supply_humidity_ratio_mixed_air_assignment_executed"],
            false
        );
    }

    #[test]
    fn active_constant_supply_route_also_skips_default_assignment_without_numeric_payload() {
