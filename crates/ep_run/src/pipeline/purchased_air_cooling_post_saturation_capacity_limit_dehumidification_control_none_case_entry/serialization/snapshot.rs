//! JSON serialization for one compact CP397 `None` case-entry snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlNoneCaseEntrySnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "predecessor_cp396_resulting_supply_humidity_ratio": json_number(snapshot.predecessor_cp396_resulting_supply_humidity_ratio),
        "predecessor_cp396_resulting_supply_humidity_ratio_ieee_bits": ieee_bits(snapshot.predecessor_cp396_resulting_supply_humidity_ratio),
        "predecessor_cp396_resulting_supply_enthalpy_j_per_kg": json_number(snapshot.predecessor_cp396_resulting_supply_enthalpy_j_per_kg),
        "predecessor_cp396_resulting_supply_enthalpy_j_per_kg_ieee_bits": ieee_bits(snapshot.predecessor_cp396_resulting_supply_enthalpy_j_per_kg),
        "predecessor_cp396_resulting_supply_temperature_c": json_number(snapshot.predecessor_cp396_resulting_supply_temperature_c),
        "predecessor_cp396_resulting_supply_temperature_c_ieee_bits": ieee_bits(snapshot.predecessor_cp396_resulting_supply_temperature_c),
        "dehumidification_control_none_case_entered": snapshot.dehumidification_control_none_case_entered,
