...
fn six_compact_carriers_serialize_with_adjacent_ieee_sidecars() {
    ...
    let object = value.as_object().expect("CP397 object");
    assert_eq!(
        object
            .keys()
    ...
    assert_eq!(value["dehumidification_control_none_case_entered"], true);
}

#[test]
fn six_nonfinite_carriers_project_null_and_preserve_nan_payload_bits() {
    let nan = f64::from_bits(0x7ff8_0000_0000_0397);
    ...
    assert_eq!(value["dehumidification_control_none_case_entered"], false);
}
...
{
    let mut predecessor = crate::pipeline::purchased_air_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_break::test_snapshot(value, false);
    predecessor.predecessor_dehumidification_control_type_read = active;
    predecessor.predecessor_dehumidification_control_type =
        active.then_some(DehumidificationControlType::None);
    predecessor.predecessor_dehumidification_control_switch_dispatched = active;
    ...
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlNoneCaseEntrySnapshot {
        ...
        predecessor_cp396_resulting_supply_humidity_ratio: predecessor
            .resulting_supply_humidity_ratio,
        predecessor_cp396_resulting_supply_enthalpy_j_per_kg: predecessor
            .resulting_supply_enthalpy_j_per_kg,
        predecessor_cp396_resulting_supply_temperature_c: predecessor
            .resulting_supply_temperature_c,
