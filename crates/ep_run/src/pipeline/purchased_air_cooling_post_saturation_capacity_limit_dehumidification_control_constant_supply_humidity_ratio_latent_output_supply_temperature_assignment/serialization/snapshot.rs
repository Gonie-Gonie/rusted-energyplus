//! Lossless JSON serialization for one CP407 supply-temperature assignment snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSupplyHumidityRatioLatentOutputSupplyTemperatureAssignmentSnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_supply_temperature_assignment_executed": snapshot.dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_supply_temperature_assignment_executed,
        "cp385_retained_supply_enthalpy_owned_read": snapshot.cp385_retained_supply_enthalpy_owned_read,
        "cp406_same_call_supply_enthalpy_bit_corroborated": snapshot.cp406_same_call_supply_enthalpy_bit_corroborated,
        "supply_enthalpy_for_dry_bulb_inversion_read": snapshot.supply_enthalpy_for_dry_bulb_inversion_read,
        ...
        "cp378_retained_supply_humidity_ratio_owned_read": snapshot.cp378_retained_supply_humidity_ratio_owned_read,
        "supply_humidity_ratio_for_dry_bulb_inversion_read": snapshot.supply_humidity_ratio_for_dry_bulb_inversion_read,
        ...
        "cp406_retained_supply_temperature_state_owned": snapshot.cp406_retained_supply_temperature_state_owned,
        ...
        "psychrometric_supply_temperature_evaluated": snapshot.psychrometric_supply_temperature_evaluated,
        "psychrometric_supply_temperature_result_c": json_number(snapshot.psychrometric_supply_temperature_result_c),
        "psychrometric_supply_temperature_result_c_ieee_bits": ieee_bits(snapshot.psychrometric_supply_temperature_result_c),
