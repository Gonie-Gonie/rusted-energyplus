//! JSON serialization for one CP383 total-output capacity-guard snapshot.

use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationTotalOutputGuardSnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "dehumidification_total_output_capacity_guard_evaluated": snapshot.dehumidification_total_output_capacity_guard_evaluated,
        ...
        "cooling_total_output_maximum_total_cooling_capacity_comparison_evaluated": snapshot.cooling_total_output_maximum_total_cooling_capacity_comparison_evaluated,
        "cooling_total_output_strictly_greater_than_maximum_total_cooling_capacity": snapshot.cooling_total_output_strictly_greater_than_maximum_total_cooling_capacity,
        "dehumidification_total_output_capacity_adjustment_body_entered": snapshot.dehumidification_total_output_capacity_adjustment_body_entered,
...
mod tests {
    ...
    fn non_finite_values_are_null_with_exact_ieee_sidecars() {
        for bits in [0x7ff8_0000_0000_0383, f64::INFINITY.to_bits()] {
