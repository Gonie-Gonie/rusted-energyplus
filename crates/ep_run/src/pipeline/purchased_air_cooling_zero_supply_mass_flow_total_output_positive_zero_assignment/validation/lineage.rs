//! Bounded CP428-to-CP429 latest-snapshot lineage validation.
...
use crate::pipeline::purchased_air_cooling_zero_supply_mass_flow_sensible_output_positive_zero_assignment::serialization::snapshot::snapshot_json as predecessor_json;
...
fn local_shape_is_exact(snapshot: Snapshot, predecessor: Predecessor) -> bool {
    ...
    provenance_is_exact(
        ...
        && if assignment {
            positive_zero_is_exact(snapshot.assigned_cooling_total_output_w)
        } else {
