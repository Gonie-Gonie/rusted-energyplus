//! JSON serialization for one CP356 snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingConstantShrSupplyHumidityRatioMixedAirLimitSnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "predecessor_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_minimum_limit_executed":
            snapshot.predecessor_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_minimum_limit_executed,
        ...
        "dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_mixed_air_limit_executed":
            snapshot.dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_mixed_air_limit_executed,
        ...
        "supply_humidity_ratio_before_mixed_air_limit":
            json_number(snapshot.supply_humidity_ratio_before_mixed_air_limit),
        "supply_humidity_ratio_before_mixed_air_limit_ieee_bits":
            ieee_bits(snapshot.supply_humidity_ratio_before_mixed_air_limit),
...
mod tests {
    ...
    fn snapshot(
        ...
        PurchasedAirCalcCoolingConstantShrSupplyHumidityRatioMixedAirLimitSnapshot {
            ...
            supply_humidity_ratio_for_mixed_air_limit_minimum_read: active,
            supply_humidity_ratio_before_mixed_air_limit: numeric,
            mixed_air_humidity_ratio_for_minimum_read: active,
            mixed_air_humidity_ratio: numeric,
