//! JSON serialization for CP399 lifecycle evidence.

use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSupplyHumidityRatioCpAirAssignmentLifecycleSummary;
...
pub(in crate::pipeline) fn lifecycle_json(
    lifecycle: &PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSupplyHumidityRatioCpAirAssignmentLifecycleSummary,
) -> Value {
    ...
    json!({
        ...
        "dehumidification_control_constant_supply_humidity_ratio_cp_air_assignment_count": state.dehumidification_control_constant_supply_humidity_ratio_cp_air_assignment_count,
...
mod tests {
    ...
    #[test]
    fn lifecycle_serializes_active_assignment_counters_and_thirty_route_slots() {
        let mut state = PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSupplyHumidityRatioCpAirAssignmentRuntimeState::new(
        ...
        let value = lifecycle_json(&PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSupplyHumidityRatioCpAirAssignmentLifecycleSummary {
        ...
        assert_eq!(
            value["dehumidification_control_constant_supply_humidity_ratio_cp_air_assignment_count"],
            1
        );
        assert_eq!(value["source_site_execution_count"], 3);
        assert_eq!(value["mixed_air_humidity_ratio_read_count"], 1);
        assert_eq!(value["psychrometric_cp_air_evaluation_count"], 1);
        assert_eq!(value["cp_air_assignment_write_count"], 1);
