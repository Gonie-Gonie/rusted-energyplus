//! JSON serialization for one CP392 supply-humidity-ratio assignment snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyHumidityRatioAssignmentSnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "predecessor_cp391_supply_temperature_c": json_number(snapshot.predecessor_cp391_supply_temperature_c),
        "predecessor_cp391_supply_temperature_c_ieee_bits": ieee_bits(snapshot.predecessor_cp391_supply_temperature_c),
        ...
        "predecessor_cp391_resulting_supply_enthalpy_j_per_kg": json_number(snapshot.predecessor_cp391_resulting_supply_enthalpy_j_per_kg),
        "predecessor_cp391_resulting_supply_enthalpy_j_per_kg_ieee_bits": ieee_bits(snapshot.predecessor_cp391_resulting_supply_enthalpy_j_per_kg),
        "predecessor_cp391_resulting_supply_temperature_c": json_number(snapshot.predecessor_cp391_resulting_supply_temperature_c),
        "predecessor_cp391_resulting_supply_temperature_c_ieee_bits": ieee_bits(snapshot.predecessor_cp391_resulting_supply_temperature_c),
        "dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment_executed": snapshot.dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment_executed,
        "cp391_retained_supply_temperature_state_owned": snapshot.cp391_retained_supply_temperature_state_owned,
        "cp391_retained_supply_enthalpy_state_owned": snapshot.cp391_retained_supply_enthalpy_state_owned,
        "cp391_retained_supply_temperature_owned_read": snapshot.cp391_retained_supply_temperature_owned_read,
        ...
        "cp391_retained_supply_enthalpy_owned_read": snapshot.cp391_retained_supply_enthalpy_owned_read,
