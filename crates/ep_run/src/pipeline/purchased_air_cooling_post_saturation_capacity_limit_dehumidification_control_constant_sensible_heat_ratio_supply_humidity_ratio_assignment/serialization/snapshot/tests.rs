...
#[test]
fn all_forty_nonfinite_fields_serialize_as_null_with_exact_ieee_sidecars() {
    let nan = f64::from_bits(0x7ff8_0000_0000_0391);
...
#[test]
fn direct_skip_retains_signed_zero_enthalpy_and_temperature() {
    let value = snapshot_json(snapshot(Some(-0.0), false));
    for field in [
        "predecessor_cp391_resulting_supply_enthalpy_j_per_kg_ieee_bits",
        "predecessor_cp391_resulting_supply_temperature_c_ieee_bits",
...
fn numeric_fields() -> [&'static str; 40] {
    [
        ...
        "predecessor_cp391_supply_temperature_c",
...
fn source_local_fields() -> [&'static str; 5] {
    [
        "supply_temperature_c",
        "supply_enthalpy_j_per_kg",
        "psychrometric_supply_humidity_ratio",
...
pub(in crate::pipeline) fn snapshot(
    ...
    let predecessor = crate::pipeline::purchased_air_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit::test_snapshot(value, active);
    ...
    PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSensibleHeatRatioSupplyHumidityRatioAssignmentSnapshot {
        ...
        source_order: PURCHASED_AIR_CALC_COOLING_POST_SATURATION_CAPACITY_LIMIT_DEHUMIDIFICATION_CONTROL_CONSTANT_SENSIBLE_HEAT_RATIO_SUPPLY_HUMIDITY_RATIO_ASSIGNMENT_SOURCE_ORDER,
        ...
        predecessor_cp390_resulting_supply_enthalpy_j_per_kg: predecessor.predecessor_cp390_resulting_supply_enthalpy_j_per_kg,
        ...
        predecessor_cp390_resulting_supply_temperature_c: predecessor.predecessor_cp390_resulting_supply_temperature_c,
        dehumidification_control_constant_sensible_heat_ratio_overdrying_limit_executed: predecessor.dehumidification_control_constant_sensible_heat_ratio_overdrying_limit_executed,
        cp390_retained_supply_enthalpy_state_owned: predecessor.cp390_retained_supply_enthalpy_state_owned,
        preexisting_supply_enthalpy_j_per_kg: predecessor.preexisting_supply_enthalpy_j_per_kg,
        cp390_retained_supply_enthalpy_owned_read: predecessor.cp390_retained_supply_enthalpy_owned_read,
        supply_enthalpy_for_overdrying_limit_maximum_read: predecessor.supply_enthalpy_for_overdrying_limit_maximum_read,
        supply_enthalpy_before_overdrying_limit_j_per_kg: predecessor.supply_enthalpy_before_overdrying_limit_j_per_kg,
        cp390_retained_supply_temperature_owned_read: predecessor.cp390_retained_supply_temperature_owned_read,
        supply_temperature_for_minimum_humidity_ratio_enthalpy_read: predecessor.supply_temperature_for_minimum_humidity_ratio_enthalpy_read,
        predecessor_cp391_supply_temperature_c: predecessor.supply_temperature_c,
        psychrometric_minimum_supply_enthalpy_evaluated: predecessor.psychrometric_minimum_supply_enthalpy_evaluated,
        psychrometric_minimum_supply_enthalpy_j_per_kg: predecessor.psychrometric_minimum_supply_enthalpy_j_per_kg,
        source_shaped_two_argument_maximum_evaluated: predecessor.source_shaped_two_argument_maximum_evaluated,
        maximum_supply_enthalpy_j_per_kg: predecessor.maximum_supply_enthalpy_j_per_kg,
        ...
        predecessor_cp391_resulting_supply_enthalpy_j_per_kg: predecessor.resulting_supply_enthalpy_j_per_kg,
        predecessor_cp391_resulting_supply_temperature_c: predecessor.resulting_supply_temperature_c,
        dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment_executed: active,
        cp391_retained_supply_temperature_state_owned: value.is_some(),
        cp391_retained_supply_enthalpy_state_owned: value.is_some(),
        cp391_retained_supply_temperature_owned_read: active,
        supply_temperature_for_humidity_ratio_inversion_read: active,
        supply_temperature_c: local,
        cp391_retained_supply_enthalpy_owned_read: active,
        supply_enthalpy_for_humidity_ratio_inversion_read: active,
        supply_enthalpy_j_per_kg: local,
        psychrometric_supply_humidity_ratio_evaluated: active,
        psychrometric_supply_humidity_ratio: local,
        supply_humidity_ratio_assignment_performed: active,
        assigned_supply_humidity_ratio: local,
        resulting_supply_humidity_ratio: local,
