//! JSON serialization for one compact CP410 default-case break snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlDefaultCaseBreakSnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "dehumidification_control_default_case_exited_via_break": snapshot.dehumidification_control_default_case_exited_via_break,
