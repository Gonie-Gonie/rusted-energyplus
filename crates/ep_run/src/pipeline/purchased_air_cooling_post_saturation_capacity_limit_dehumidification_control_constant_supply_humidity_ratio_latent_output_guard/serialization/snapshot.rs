//! Lossless JSON serialization for one CP402 latent-output guard snapshot.

use ep_model::DehumidificationControlType;
use ep_runtime::PurchasedAirCalcCoolingPostSaturationCapacityLimitDehumidificationControlConstantSupplyHumidityRatioLatentOutputGuardSnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_guard_evaluated": snapshot.dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_guard_evaluated,
        "cp401_retained_cooling_latent_output_owned_read": snapshot.cp401_retained_cooling_latent_output_owned_read,
        "cooling_latent_output_read": snapshot.cooling_latent_output_read,
        ...
        "cooling_latent_output_maximum_total_cooling_capacity_comparison_evaluated": snapshot.cooling_latent_output_maximum_total_cooling_capacity_comparison_evaluated,
        "cooling_latent_output_greater_than_or_equal_to_maximum_total_cooling_capacity": snapshot.cooling_latent_output_greater_than_or_equal_to_maximum_total_cooling_capacity,
        "dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_adjustment_body_entered": snapshot.dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_adjustment_body_entered,
        "dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_guard_false_fallthrough": snapshot.dehumidification_control_none_or_constant_supply_humidity_ratio_latent_output_capacity_guard_false_fallthrough,
        "cp401_retained_supply_humidity_ratio_state_owned": snapshot.cp401_retained_supply_humidity_ratio_state_owned,
        "cp401_retained_supply_enthalpy_state_owned": snapshot.cp401_retained_supply_enthalpy_state_owned,
        "cp401_retained_supply_temperature_state_owned": snapshot.cp401_retained_supply_temperature_state_owned,
