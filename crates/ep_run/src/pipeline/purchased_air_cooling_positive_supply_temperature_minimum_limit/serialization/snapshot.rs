//! JSON serialization for one CP333 snapshot.

use ep_runtime::PurchasedAirCalcCoolingPositiveSupplyTemperatureMinimumLimitSnapshot;
...
pub(super) fn snapshot_json(
    ...
    json!({
        ...
        "supply_temperature_before_minimum_limit_c_ieee_bits":
            ieee_bits(snapshot.supply_temperature_before_minimum_limit_c),
        ...
        "minimum_cooling_supply_air_temperature_c_ieee_bits":
            ieee_bits(snapshot.minimum_cooling_supply_air_temperature_c),
        "source_shaped_two_argument_maximum_evaluated":
            snapshot.source_shaped_two_argument_maximum_evaluated,
        "maximum_supply_temperature_c": snapshot.maximum_supply_temperature_c,
        "maximum_supply_temperature_c_ieee_bits":
            ieee_bits(snapshot.maximum_supply_temperature_c),
