...
mod tests {
    ...
    #[test]
    fn non_direct_runtime_rejects_cp316_through_cp434_lifecycle_evidence() {
    ...
    #[test]
    fn non_direct_runtime_rejects_cp434_lifecycle_evidence() {
        ...
        let coverage = source
            ...
            .expect("CP434 non-direct rejection coverage");
