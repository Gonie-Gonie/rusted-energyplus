...
EXPECTED_STATUS_COUNTS = {"source_mapped": 20, "state_mapped": 33}
...
def self_test_inventory() -> int:
    ...
    for name, source_routine in (
        ...
        ("w_tdb_rh_pb_state_mapped_downgrade", "PsyWFnTdbRhPb"),
        ("w_tdb_twb_pb_state_mapped_downgrade", "PsyWFnTdbTwbPb"),
        ("h_tdb_rh_pb_state_mapped_downgrade", "PsyHFnTdbRhPb"),
        ...
        ("c_splineint_state_mapped_downgrade", "CSplineint"),
    ):
        candidate = copy.deepcopy(baseline)
...
def main() -> int:
    ...
    print("  completion_status: source_mapped=20, state_mapped=33")
