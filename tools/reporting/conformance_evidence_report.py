...
CLAIM_BOUNDARY = (
    ...
    "setup remain outside the claim. The paired fixed-date EPW DST cases prove only the explicit "
    "RunPeriod weather-file-use flag difference against the same declared February 29 through "
    "March 1 period. Enabled produces 72 ordered, unique Site Daylight Saving Time Status samples "
    "in daily status 0/1/1 with 48 active hours; disabled produces 0/0/0 with zero active hours. "
    "The pair gate locks exact EnergyPlus 26.1 Environment and Environment:Daylight Saving EIO "
    ...
    "year-wrap behavior, and other date-rule pairs are not proved. The separate southern-wrap "
    "start-side case uses the same literal EPW pair and EnergyPlus EIO dates but executes only "
    "the same-year October 30 through November 1 window. Its 72 EnergyPlus ESO values and timestamp "
    "fields match daily status 0/1/1 with 48 active and 24 inactive hours at zero tolerance. The "
    "Rust summary again locks day-of-year 305 and 88 plus wraps_year=true only against source-mapped "
    ...
    "months, years, or date strings remain outside that numerical claim. "
    "`calendar_special_day_nonexistent_fifth_weekday_failure_001` is blocking smoke/nonclaim "
    "failure evidence covering only the exact 2016 `5th Sunday in February` duration-one input-file "
    "Holiday. Apply Weekend Holiday Rule is explicitly Yes and does not rescue it. EnergyPlus exits "
    "1 through the SetSpecialDayDates not-enough-Nths Severe-to-Fatal path with 0 counted warnings, "
    "1 severe error, and zero data rows. Rust arbitrary-run exits 6 with phase `runtime`, code "
    "`RuntimeConvergenceFailure`, the exact rejection of occurrence 5 of Sunday in month 2 for "
    "Missing Fifth Sunday Holiday, and zero hourly samples. Numeric "
    "exit-code equality and numerical Site Day Type Index conformance are not claimed. Other "
    "ordinal/weekday/month/year combinations; EPW rules; multiple errors or definitions; partial-"
...
CASE_LABELS = {
    ...
    "calendar_schedule_file_8760_leap_exact_001": "Schedule file leap",
    "calendar_schedule_file_shading_exact_001": "Shading file schedules",
    "calendar_schedule_external_interface_initial_value_exact_001": "External schedule initial",
    "calendar_schedule_fmu_import_initial_value_exact_001": "FMU import initial",
    "calendar_schedule_fmu_export_initial_value_exact_001": "FMU export initial",
    "calendar_schedule_fmu_export_bounded_initial_value_exact_001": "FMU export bounded",
    "calendar_schedule_day_hourly_week_daily_year_leap_exact_001": "Day/week/year leap",
    "calendar_schedule_day_interval_modes_exact_001": "Day interval modes",
    "calendar_schedule_day_list_modes_exact_001": "Day list modes",
    "calendar_schedule_week_compact_day_types_exact_001": "Week compact day types",
...
KEY_LABELS = {
    ...
    "SELECTED COLUMN 8760 SCHEDULE": "File 8760 selected",
    "ALPHA SURFACE_SHADING": "Shading alpha",
    "BETA SURFACE_SHADING": "Shading beta",
    "EXTERNAL INITIAL VALUE": "External initial",
    "FMU IMPORT INITIAL VALUE": "FMU import initial",
    "FMU EXPORT INITIAL VALUE": "FMU export initial",
    "FMU EXPORT BOUNDED INITIAL VALUE": "FMU export bounded",
    "YEAR LEAP SCHEDULE": "Year leap",
    "DAY INTERVAL MODES SCHEDULE": "Day interval",
    "DAY LIST MODES SCHEDULE": "Day list",
    "WEEK COMPACT DAY TYPES SCHEDULE": "Week compact",
...
CASE_SPECS = (
    ...
    CaseSpec(
        milestone="Schedule file leap",
        command="compare-calendar-schedule-file-8760-leap-exact",
        summary_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_file_8760_leap_exact_001\compare\compare-summary.json",
        oracle_end_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_file_8760_leap_exact_001\oracle\eplusout.end",
        oracle_err_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_file_8760_leap_exact_001\oracle\eplusout.err",
    ),
    CaseSpec(
        milestone="Shading file schedules",
        command="compare-calendar-schedule-file-shading-exact",
        summary_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_file_shading_exact_001\compare\compare-summary.json",
        oracle_end_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_file_shading_exact_001\oracle\eplusout.end",
        oracle_err_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_file_shading_exact_001\oracle\eplusout.err",
    ),
    CaseSpec(
        milestone="External schedule initial",
        command="compare-calendar-schedule-external-interface-initial-value-exact",
        summary_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_external_interface_initial_value_exact_001\compare\compare-summary.json",
        oracle_end_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_external_interface_initial_value_exact_001\oracle\eplusout.end",
        oracle_err_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_external_interface_initial_value_exact_001\oracle\eplusout.err",
    ),
    CaseSpec(
        milestone="FMU import initial",
        command="compare-calendar-schedule-fmu-import-initial-value-exact",
        summary_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_fmu_import_initial_value_exact_001\compare\compare-summary.json",
        oracle_end_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_fmu_import_initial_value_exact_001\oracle\eplusout.end",
        oracle_err_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_fmu_import_initial_value_exact_001\oracle\eplusout.err",
    ),
    CaseSpec(
        milestone="FMU export initial",
        command="compare-calendar-schedule-fmu-export-initial-value-exact",
        summary_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_fmu_export_initial_value_exact_001\compare\compare-summary.json",
        oracle_end_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_fmu_export_initial_value_exact_001\oracle\eplusout.end",
        oracle_err_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_fmu_export_initial_value_exact_001\oracle\eplusout.err",
    ),
    CaseSpec(
        milestone="FMU export bounded",
        command="compare-calendar-schedule-fmu-export-bounded-initial-value-exact",
        summary_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_fmu_export_bounded_initial_value_exact_001\compare\compare-summary.json",
        oracle_end_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_fmu_export_bounded_initial_value_exact_001\oracle\eplusout.end",
        oracle_err_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_fmu_export_bounded_initial_value_exact_001\oracle\eplusout.err",
    ),
    CaseSpec(
        milestone="Day/week/year leap",
        command="compare-calendar-schedule-day-hourly-week-daily-year-leap-exact",
        summary_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_day_hourly_week_daily_year_leap_exact_001\compare\compare-summary.json",
        oracle_end_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_day_hourly_week_daily_year_leap_exact_001\oracle\eplusout.end",
        oracle_err_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_day_hourly_week_daily_year_leap_exact_001\oracle\eplusout.err",
    ),
    CaseSpec(
        milestone="Day interval modes",
        command="compare-calendar-schedule-day-interval-modes-exact",
        summary_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_day_interval_modes_exact_001\compare\compare-summary.json",
        oracle_end_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_day_interval_modes_exact_001\oracle\eplusout.end",
        oracle_err_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_day_interval_modes_exact_001\oracle\eplusout.err",
    ),
    CaseSpec(
        milestone="Day list modes",
        command="compare-calendar-schedule-day-list-modes-exact",
        summary_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_day_list_modes_exact_001\compare\compare-summary.json",
        oracle_end_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_day_list_modes_exact_001\oracle\eplusout.end",
        oracle_err_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_day_list_modes_exact_001\oracle\eplusout.err",
    ),
    CaseSpec(
        milestone="Week compact day types",
        command="compare-calendar-schedule-week-compact-day-types-exact",
        summary_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_week_compact_day_types_exact_001\compare\compare-summary.json",
        oracle_end_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_week_compact_day_types_exact_001\oracle\eplusout.end",
        oracle_err_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_schedule_week_compact_day_types_exact_001\oracle\eplusout.err",
    ),
    CaseSpec(
    ...
    CaseSpec(
        milestone="Calendar DST fixed enabled",
        command="compare-calendar-dst-fixed-date-policy-exact",
    ...
    CaseSpec(
        milestone="Calendar DST fixed disabled",
        command="compare-calendar-dst-fixed-date-policy-exact",
    ...
    CaseSpec(
        milestone="EPW DST southern start",
        command="compare-calendar-epw-dst-southern-wrap-start-exact",
    ...
    CaseSpec(
        ...
        summary_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_special_day_weekend_rule_enabled_hourly_exact_001\compare\compare-summary.json",
        oracle_end_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_special_day_weekend_rule_enabled_hourly_exact_001\oracle\eplusout.end",
        oracle_err_path=r".runtime\time-weather-schedule-conformance\26.1.0\calendar_special_day_weekend_rule_enabled_hourly_exact_001\oracle\eplusout.err",
    ),
    CaseSpec(
        milestone="Weekend holiday disabled",
        command="compare-calendar-weekend-holiday-policy-exact",
