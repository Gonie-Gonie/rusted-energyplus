...
| 0.33 | Official Dynamic Heat-Balance Conformance | complete | limited-official-dynamic-conformance | official_1zone_uncontrolled_dynamic_diagnostic_001, official_1zone_uncontrolled_dynamic_conformance_candidate_001 | broad ExampleFiles dynamic numerical conformance, general warmup convergence parity outside the official 1ZoneUncontrolled dynamic candidate, broad weather processor and wet-surface branch compatibility, storage rows outside the declared floor storage rows, radiation, nonzero solar, and convection coefficient variables, broad solar and exterior convection parity, full EnergyPlus compatibility |
