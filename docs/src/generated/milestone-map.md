...
| 0.33 | Official Dynamic Heat-Balance Diagnostic | in_progress | diagnostic-only | official_1zone_uncontrolled_dynamic_diagnostic_001 | official ExampleFiles dynamic numerical conformance, warmup parity, surface CTF/conduction parity, solar and exterior convection parity, full EnergyPlus compatibility |
