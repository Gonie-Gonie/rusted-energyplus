...
| People | internal_gains | typed | ideal_loads_outdoor_air_flow_person_diagnostic_001 | Typed for zone design occupant count used by diagnostic-only IdealLoads Flow/Person outdoor-air design-flow evidence; no people heat-gain numerical conformance claim. |
...
| ZoneHVAC:IdealLoadsAirSystem | hvac | typed | ideal_loads_no_oa_sensible_conformance_001 | Typed input support plus limited no-OA/no-limit IdealLoads sensible conformance evidence, no-OA numeric capacity-limit, flow-limit, and flow-and-capacity-limit conformance evidence for declared thermostat, IdealLoads rate, and supply-node temperature/mass-flow outputs, no-OA ConstantSensibleHeatRatio cooling conformance evidence for declared cooling total/sensible/latent rate and supply-node humidity outputs, no-OA ConstantSupplyHumidityRatio cooling/heating conformance evidence for declared total/sensible/latent rate and supply-node temperature/mass-flow/humidity outputs, no-OA Humidistat dehumidification/humidification conformance evidence for declared cooling/heating total/sensible/latent rate and supply-node temperature/mass-flow/humidity outputs using traced EnergyPlus moisture-demand proof inputs, limited outdoor-air Flow/Zone conformance evidence for declared outdoor-air mass/standard-density volume flow, no-humidity report rates, supply-air state, and mixed-air state outputs, diagnostic ReportPurchasedAir energy and blank/constant Schedule:Constant fuel-efficiency evidence, diagnostic hourly facility meter oracle-MTR vs Rust aggregated fuel-energy evidence with RuntimeMeterRegistry request resolution, and remaining diagnostic Flow/Person, Flow/Area, AirChanges/Hour, Sum, Maximum, DifferentialDryBulb, DifferentialEnthalpy, Sensible heat-recovery, and Enthalpy heat-recovery outdoor-air evidence for declared output variables only; outdoor-air methods beyond Flow/Zone, active economizer/heat recovery, broad humidity-control conformance, humidistat moisture-demand conformance, heat-recovery saturation-limit branches, sizing, non-constant efficiency schedules, broad meter conformance, and broad HVAC compatibility remain outside the claim. |
| DesignSpecification:OutdoorAir | hvac | diagnostic | ideal_loads_outdoor_air_design_flow_diagnostic_001 | Typed for IdealLoads outdoor-air reference/schedule preservation plus limited Flow/Zone conformance evidence for declared design-flow/final-flow mass, standard-density volume flow, no-humidity outdoor-air report-rate, supply-air state, and mixed-air state rows in ideal_loads_outdoor_air_flow_zone_conformance_candidate_001. Flow/Person, Flow/Area, AirChanges/Hour, Sum, Maximum, DifferentialDryBulb, DifferentialEnthalpy, Sensible heat-recovery, and Enthalpy heat-recovery outdoor-air rows remain diagnostic-only; no active DCV, saturation-limit heat-recovery branch parity, or broad numerical OA conformance claim. |
