...
| DesignSpecification:OutdoorAir | hvac | typed_graph_only | ideal-loads-outdoor-air-typed-intake-test | Typed for IdealLoads outdoor-air reference and schedule preservation only; no outdoor-air flow, DCV, economizer, heat recovery, or numerical OA conformance claim. |
