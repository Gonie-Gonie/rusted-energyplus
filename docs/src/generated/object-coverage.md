...
| ZoneHVAC:IdealLoadsAirSystem | hvac | typed | ideal_loads_no_oa_sensible_conformance_001 | Typed input support plus limited no-OA/no-limit IdealLoads sensible conformance evidence, no-OA numeric capacity-limit, flow-limit, and flow-and-capacity-limit conformance evidence for declared thermostat, IdealLoads rate, and supply-node temperature/mass-flow outputs, no-OA ConstantSensibleHeatRatio cooling conformance evidence for declared cooling total/sensible/latent rate and supply-node humidity outputs, no-OA ConstantSupplyHumidityRatio cooling conformance evidence for declared cooling total/sensible/latent rate and supply-node temperature/mass-flow/humidity outputs, diagnostic ReportPurchasedAir energy and blank/constant Schedule:Constant fuel-efficiency evidence, diagnostic hourly facility meter oracle-MTR vs Rust aggregated fuel-energy evidence with RuntimeMeterRegistry request resolution, diagnostic no-OA ConstantSupplyHumidityRatio heating and Humidistat dehumidification/humidification humidity-control latent/sensible/moisture-demand evidence, and diagnostic Flow/Person, Flow/Zone, Flow/Area, AirChanges/Hour, Sum, Maximum, DifferentialDryBulb, DifferentialEnthalpy, Sensible heat-recovery, and Enthalpy heat-recovery outdoor-air design-flow/supply-air/mixed-air/economizer-active-time/inactive-heat-recovery/heat-recovery evidence for declared output variables only; outdoor-air conformance, broad humidity-control conformance, heat-recovery saturation-limit branches, sizing, non-constant efficiency schedules, broad meter conformance, and broad HVAC compatibility remain outside the claim. |
