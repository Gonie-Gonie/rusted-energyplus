...
| DesignSpecification:OutdoorAir | hvac | diagnostic | ideal_loads_outdoor_air_design_flow_diagnostic_001 | Typed for IdealLoads outdoor-air reference/schedule preservation plus diagnostic-only Flow/Zone design-flow mass, standard-density volume flow, no-humidity outdoor-air report-rate, and no-heat-recovery mixed-air state parity; no DCV, economizer, heat recovery, or numerical OA conformance claim. |
