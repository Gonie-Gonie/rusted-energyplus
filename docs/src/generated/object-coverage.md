...
| DesignSpecification:OutdoorAir | hvac | diagnostic | ideal_loads_outdoor_air_design_flow_diagnostic_001 | Typed for IdealLoads outdoor-air reference/schedule preservation plus diagnostic-only Flow/Zone design-flow mass and standard-density volume flow parity; no outdoor-air load, DCV, economizer, heat recovery, or numerical OA conformance claim. |
