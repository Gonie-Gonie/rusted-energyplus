...
| ZoneHVAC:IdealLoadsAirSystem | hvac | typed | ideal_loads_no_oa_sensible_conformance_001 | Typed input support plus limited no-OA/no-limit IdealLoads sensible conformance evidence, zero-failure diagnostic finite flow/capacity evidence with return-node proof rows, diagnostic ReportPurchasedAir energy and blank/constant Schedule:Constant fuel-efficiency evidence, diagnostic hourly facility meter oracle-MTR vs Rust aggregated fuel-energy evidence with RuntimeMeterRegistry request resolution, diagnostic no-OA ConstantSensibleHeatRatio and ConstantSupplyHumidityRatio humidity-control latent/sensible evidence, and diagnostic outdoor-air design-flow/supply-air/mixed-air/inactive-economizer-heat-recovery evidence for declared output variables only; finite-limit conformance, outdoor-air conformance, broad humidity-control conformance, humidistat, active economizer, active heat recovery, adaptive system timestep, sizing, non-constant efficiency schedules, broad meter conformance, and broad HVAC compatibility remain outside the claim. |
