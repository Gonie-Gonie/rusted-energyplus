...
| Zone Air Heat Balance Surface Convection Rate | heat_balance | diagnostic | official_1zone_uncontrolled_dynamic_conformance_candidate_001 | Official 1Zone dynamic compatibility-candidate evidence only; not tolerance-gated conformance until all candidate variables pass. |
| Zone Air Heat Balance Air Energy Storage Rate | heat_balance | diagnostic | official_1zone_uncontrolled_dynamic_conformance_candidate_001 | Official 1Zone dynamic compatibility-candidate evidence only; not tolerance-gated conformance until all candidate variables pass. |
