...
| System Node Humidity Ratio | node | diagnostic | ideal_loads_no_oa_sensible_conformance_001 | Diagnostic proof row in the no-OA/no-limit IdealLoads case; humidity control and broad node humidity conformance remain outside the claim. |
...
| System Node Mass Flow Rate | hvac | conformance | ideal_loads_no_oa_sensible_conformance_001 | Tolerance-gated IdealLoads supply-node mass-flow conformance within the no-OA/no-limit case; broad HVAC flow balancing and node conformance remain outside the claim. |
| System Node Temperature | hvac | conformance | ideal_loads_no_oa_sensible_conformance_001 | Tolerance-gated IdealLoads supply-node temperature conformance within the no-OA/no-limit case; broad HVAC and node conformance remain outside the claim. |
