...
|---|---|---|---|---|
| Zone Ideal Loads Zone Total Cooling Rate | hvac | diagnostic | ideal_loads_no_oa_sensible_conformance_001 | Zero-failure diagnostic Detailed compare evidence exists for the no-OA/no-limit IdealLoads sensible candidate; not a conformance claim until the case is promoted. |
| Zone Ideal Loads Zone Total Heating Rate | hvac | diagnostic | ideal_loads_no_oa_sensible_conformance_001 | Zero-failure diagnostic Detailed compare evidence exists for the no-OA/no-limit IdealLoads sensible candidate; not a conformance claim until the case is promoted. |
| Zone Ideal Loads Zone Sensible Heating Rate | hvac | diagnostic | ideal_loads_no_oa_sensible_conformance_001 | Zero-failure diagnostic Detailed compare evidence exists for the no-OA/no-limit IdealLoads sensible candidate; not a conformance claim until the case is promoted. |
| Zone Ideal Loads Zone Sensible Cooling Rate | hvac | diagnostic | ideal_loads_no_oa_sensible_conformance_001 | Zero-failure diagnostic Detailed compare evidence exists for the no-OA/no-limit IdealLoads sensible candidate; not a conformance claim until the case is promoted. |
| Zone Ideal Loads Supply Air Total Heating Rate | hvac | diagnostic | ideal_loads_no_oa_sensible_conformance_001 | Zero-failure diagnostic Detailed compare evidence exists for the no-OA/no-limit IdealLoads sensible candidate; not a conformance claim until the case is promoted. |
| Zone Ideal Loads Supply Air Total Cooling Rate | hvac | diagnostic | ideal_loads_no_oa_sensible_conformance_001 | Zero-failure diagnostic Detailed compare evidence exists for the no-OA/no-limit IdealLoads sensible candidate; not a conformance claim until the case is promoted. |
...
| System Node Mass Flow Rate | hvac | diagnostic | air_side_node_diagnostic_001 | Diagnostic node-state evidence plus zero-failure no-OA/no-limit IdealLoads supply-node compare evidence; no broad HVAC flow balancing or node conformance claim. |
| System Node Temperature | hvac | diagnostic | air_side_node_diagnostic_001 | Diagnostic node-state evidence plus zero-failure no-OA/no-limit IdealLoads supply-node compare evidence; no broad HVAC or node conformance claim. |
