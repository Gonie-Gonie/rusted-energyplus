...
| Current nav missing | 0 |
| Current nav unexpected | 0 |
...
| Order | Expected | Actual | Result |
|---|---|---|---|
| 1 | docs/src/current/project-contract.md | docs/src/current/project-contract.md | pass |
| 2 | docs/src/current/current-status.md | docs/src/current/current-status.md | pass |
| 3 | docs/src/current/roadmap.md | docs/src/current/roadmap.md | pass |
| 4 | docs/src/current/verification.md | docs/src/current/verification.md | pass |
| 5 | docs/src/current/architecture-overview.md | docs/src/current/architecture-overview.md | pass |
| 6 | docs/src/current/launcher-and-run-framework.md | docs/src/current/launcher-and-run-framework.md | pass |
...
| docs/src/architecture/result-store.md | spec-explanation | not in SUMMARY | n/a | present | active | runtime | 2026-06-07 |
| docs/src/architecture/rust-only-policy.md | spec-explanation | not in SUMMARY | n/a | none |  |  |  |
| docs/src/architecture/simulation-state.md | spec-explanation | not in SUMMARY | n/a | present | active | runtime | 2026-06-07 |
| docs/src/conformance/baseline-generation.md | spec-explanation | not in SUMMARY | n/a | present | active | conformance | 2026-06-07 |
| docs/src/conformance/case-manifest.md | spec-explanation | not in SUMMARY | n/a | present | active | conformance | 2026-06-07 |
| docs/src/conformance/case-tier-policy.md | spec-explanation | not in SUMMARY | n/a | present | active | conformance | 2026-06-07 |
| docs/src/conformance/comparison-reports.md | spec-explanation | not in SUMMARY | n/a | present | active | conformance | 2026-06-05 |
| docs/src/conformance/examplefile-suite.md | spec-explanation | not in SUMMARY | n/a | present | active | conformance | 2026-06-07 |
| docs/src/conformance/examplefiles-coverage-plan.md | spec-explanation | not in SUMMARY | n/a | present | active | conformance | 2026-06-08 |
| docs/src/conformance/numeric-release-evidence.md | spec-explanation | not in SUMMARY | n/a | present | active | conformance | 2026-06-08 |
| docs/src/conformance/oracle-policy.md | spec-explanation | not in SUMMARY | n/a | present | active | conformance | 2026-06-05 |
