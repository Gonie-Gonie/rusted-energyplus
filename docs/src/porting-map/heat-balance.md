...
| Warmup and reporting semantics | warmup convergence and ESO reporting filters | future warmup-aware runtime/report context | heat-balance diagnostic reports filter ESO run-period samples | see `warmup-semantics-map.md`; official dynamic cases are diagnostic candidates |
