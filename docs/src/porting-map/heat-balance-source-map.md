...
43. CP172 next maps required general `CalcHeatBalanceInsideSurf2`, declared at `HeatBalanceSurfaceManager.hh` lines 179-184 and implemented at `HeatBalanceSurfaceManager.cc` lines 7815-8656
...
parent/optimized-child/MRT/tail grouping. It adds no EnergyPlus source inventory,
...
CP172 next maps required general `CalcHeatBalanceInsideSurf2`, declared at
`HeatBalanceSurfaceManager.hh` lines 179-184, implemented at
`HeatBalanceSurfaceManager.cc` lines 7815-8656, and called in production only
by `CalcHeatBalanceInsideSurf` lines 7797 and 7809.
