...
36. CP165 next in source-definition order maps `InitEMSControlledConstructions`, declared at `HeatBalanceSurfaceManager.hh` line 121 and implemented at `HeatBalanceSurfaceManager.cc` lines 4722-4940; its sole production call at `HeatBalanceManager.cc` line 2662 is CP164's immediate runtime predecessor, not its successor
...
CP165 next maps `InitEMSControlledConstructions`, declared at
