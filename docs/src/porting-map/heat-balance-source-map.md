...
37. CP166 next in source-definition order maps `UpdateIntermediateSurfaceHeatBalanceResults`, declared at `HeatBalanceSurfaceManager.hh` line 132 and implemented at `HeatBalanceSurfaceManager.cc` lines 4951-5020; its sole production call is `CalcHeatBalanceInsideSurf` line 7812, and one unit fixture calls it directly at lines 8694, 8702, 8710, and 8718
...
before `calc_heat_balance_outside_surf` in the mapped routine ledger. It adds
no project-contract requirement, EnergyPlus source inventory, Rust
target/code/state, test, support, capability, output, numerical, performance,
...
CP166 next maps `UpdateIntermediateSurfaceHeatBalanceResults`, declared at
