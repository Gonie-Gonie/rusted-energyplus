...
1. when `ManageSurfaceHeatBalancefirstTime` is true, display `Initializing Surfaces`;
2. call `InitSurfaceHeatBalance(state)`;
3. under the same first-time flag, display `Calculate Outside Surface Heat Balance`;
