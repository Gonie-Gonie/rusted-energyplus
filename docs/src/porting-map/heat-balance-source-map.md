...
both the Surface-manager routine ledger and the heat-balance project-contract
list. It adds no EnergyPlus source inventory, Rust target/code/state, test,
...
CP175 next maps `CalcOutsideSurfTemp`, declared at
`HeatBalanceSurfaceManager.hh` lines 195-202 and defined immediately after
CP174 beginning at `HeatBalanceSurfaceManager.cc` line 9470.
