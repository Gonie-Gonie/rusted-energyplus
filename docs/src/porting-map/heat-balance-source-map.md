...
retain the parent’s zero `HMovInsul`; the modeled-other-side call follows any
...
CP176 next maps `CalcExteriorVentedCavity`, declared at
`HeatBalanceSurfaceManager.hh` line 204 and defined immediately after CP175 at
`HeatBalanceSurfaceManager.cc` line 9765.
