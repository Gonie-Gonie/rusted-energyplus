...
40. CP169 next, after already mapped resilience and `ReportSurfaceHeatBalance` definitions, maps `ReportNonRepresentativeSurfaceResults`, declared at `HeatBalanceSurfaceManager.hh` line 151 and implemented at `HeatBalanceSurfaceManager.cc` lines 6893-6930
...
CP169 next, after already mapped resilience and `ReportSurfaceHeatBalance`
definitions, maps `ReportNonRepresentativeSurfaceResults`, declared at
