...
declared date and directly ordered typed-vector overwrite remain unit/source
evidence; compiled IDF overlap precedence and cross-year reprojection remain
unclaimed.
