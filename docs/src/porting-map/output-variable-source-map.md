...
| `Zone Ideal Loads Supply Air Latent Heating Rate` | detailed | `PurchasedAirManager.cc::ReportPurchasedAir` | no-OA `ConstantSensibleHeatRatio`, `ConstantSupplyHumidityRatio`, and Humidistat humidification supply-air latent heating report row in the diagnostic compare lane | diagnostic-only for `ideal_loads_constant_shr_diagnostic_001`, `ideal_loads_constant_supply_humidity_diagnostic_001`, and `ideal_loads_humidistat_humidification_diagnostic_001`; no broad humidity-control conformance |
