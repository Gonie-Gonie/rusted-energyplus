...
deltas and records Rust/oracle warmup day metadata. These are conformance
candidates, but they remain non-claiming until Rust produces matching hourly
series under a blocking gate.
