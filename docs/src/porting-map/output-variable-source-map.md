...
| `Zone Ideal Loads Supply Air Total Heating Fuel Energy` | detailed sum | `PurchasedAirManager.cc::ReportPurchasedAir` fuel efficiency and energy branches plus `OutputProcessor` Sum reporting | no-OA supply-air total heating rate divided by blank fuel-efficiency schedule value 1.0, multiplied by `TimeStepSysSec` per raw system step, and summed over the 900 s report interval | diagnostic-only for `ideal_loads_no_oa_sensible_conformance_001`; facility meters are oracle-MTR tracked separately; no Rust meter time-series conformance |
| `Zone Ideal Loads Supply Air Total Cooling Fuel Energy` | detailed sum | `PurchasedAirManager.cc::ReportPurchasedAir` fuel efficiency and energy branches plus `OutputProcessor` Sum reporting | no-OA supply-air total cooling rate divided by blank fuel-efficiency schedule value 1.0, multiplied by `TimeStepSysSec` per raw system step, and summed over the 900 s report interval | diagnostic-only for `ideal_loads_no_oa_sensible_conformance_001`; facility meters are oracle-MTR tracked separately; no Rust meter time-series conformance |
...
| `Zone Ideal Loads Zone Cooling Fuel Energy` | detailed sum | `PurchasedAirManager.cc::ReportPurchasedAir` fuel efficiency and energy branches plus `OutputProcessor` Sum reporting | no-OA zone total cooling rate divided by blank fuel-efficiency schedule value 1.0, multiplied by `TimeStepSysSec` per raw system step, and summed over the 900 s report interval | diagnostic-only for `ideal_loads_no_oa_sensible_conformance_001`; facility meters are oracle-MTR tracked separately; no Rust meter time-series conformance |
| `Zone Ideal Loads Supply Air Total Heating Fuel Energy Rate` | detailed | `PurchasedAirManager.cc::ReportPurchasedAir` fuel efficiency branch | no-OA supply-air total heating rate divided by blank fuel-efficiency schedule value 1.0 | diagnostic-only for `ideal_loads_no_oa_sensible_conformance_001`; facility meters are oracle-MTR tracked separately; no Rust meter time-series conformance |
| `Zone Ideal Loads Supply Air Total Cooling Fuel Energy Rate` | detailed | `PurchasedAirManager.cc::ReportPurchasedAir` fuel efficiency branch | no-OA supply-air total cooling rate divided by blank fuel-efficiency schedule value 1.0 | diagnostic-only for `ideal_loads_no_oa_sensible_conformance_001`; facility meters are oracle-MTR tracked separately; no Rust meter time-series conformance |
...
| `Zone Ideal Loads Zone Cooling Fuel Energy Rate` | detailed | `PurchasedAirManager.cc::ReportPurchasedAir` fuel efficiency branch | no-OA zone total cooling rate divided by blank fuel-efficiency schedule value 1.0 | diagnostic-only for `ideal_loads_no_oa_sensible_conformance_001`; facility meters are oracle-MTR tracked separately; no Rust meter time-series conformance |
...
sizing, Rust meter time-series comparison, non-unity efficiency schedules, or
broad HVAC compatibility. The energy and blank-efficiency fuel energy rows are
diagnostic-only proof of the EnergyPlus `ReportPurchasedAir` rate-to-
`TimeStepSysSec`, `OutputProcessor` Sum reporting, and unity-efficiency
branches. `DistrictHeatingWater:Facility` and `DistrictCooling:Facility`
meters are tracked only as oracle-MTR diagnostic requests.
