...
| `Zone Ideal Loads Outdoor Air Total Heating Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads` and `ReportPurchasedAir` | no-humidity total heating equals sensible heating in the diagnostic compare lane | diagnostic-only for `ideal_loads_outdoor_air_design_flow_diagnostic_001` and `ideal_loads_outdoor_air_flow_area_diagnostic_001`; 1 W source-order tolerance |
| `Zone Ideal Loads Outdoor Air Total Cooling Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads` and `ReportPurchasedAir` | no-humidity total cooling equals sensible cooling in the diagnostic compare lane | diagnostic-only for `ideal_loads_outdoor_air_design_flow_diagnostic_001` and `ideal_loads_outdoor_air_flow_area_diagnostic_001`; 1 W source-order tolerance |
| `Zone Ideal Loads Supply Air Mass Flow Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads` and `ReportPurchasedAir` | no-limit supply mass selected from OA and sensible flow requirements | diagnostic-only for `ideal_loads_outdoor_air_design_flow_diagnostic_001` and `ideal_loads_outdoor_air_flow_area_diagnostic_001` |
| `Zone Ideal Loads Supply Air Standard Density Volume Flow Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads`, `ReportPurchasedAir`, and `DataEnvironment.hh::StdRhoAir` | supply mass flow divided by EnergyPlus `StdRhoAir` in the diagnostic compare lane | diagnostic-only for `ideal_loads_outdoor_air_design_flow_diagnostic_001` and `ideal_loads_outdoor_air_flow_area_diagnostic_001` |
| `Zone Ideal Loads Supply Air Temperature` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads` and `ReportPurchasedAir` | no-limit supply temperature from source-order demand, mass flow, and mixed-air clamp | diagnostic-only for `ideal_loads_outdoor_air_design_flow_diagnostic_001` and `ideal_loads_outdoor_air_flow_area_diagnostic_001`; 0.02 C tolerance |
...
| `Zone Ideal Loads Heat Recovery Sensible Heating Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirMixedAir` and `ReportPurchasedAir` | inactive heat recovery reports zero sensible heating | diagnostic-only for `ideal_loads_outdoor_air_design_flow_diagnostic_001` and `ideal_loads_outdoor_air_flow_area_diagnostic_001` |
| `Zone Ideal Loads Heat Recovery Latent Heating Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirMixedAir` and `ReportPurchasedAir` | inactive heat recovery reports zero latent heating | diagnostic-only for `ideal_loads_outdoor_air_design_flow_diagnostic_001` and `ideal_loads_outdoor_air_flow_area_diagnostic_001` |
| `Zone Ideal Loads Heat Recovery Total Heating Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirMixedAir` and `ReportPurchasedAir` | inactive heat recovery reports zero total heating | diagnostic-only for `ideal_loads_outdoor_air_design_flow_diagnostic_001` and `ideal_loads_outdoor_air_flow_area_diagnostic_001` |
...
| `Zone Ideal Loads Heat Recovery Total Cooling Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirMixedAir` and `ReportPurchasedAir` | inactive heat recovery reports zero total cooling | diagnostic-only for `ideal_loads_outdoor_air_design_flow_diagnostic_001` and `ideal_loads_outdoor_air_flow_area_diagnostic_001` |
| `Zone Ideal Loads Economizer Active Time` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads` and `ReportPurchasedAir` | inactive economizer reports zero active time | diagnostic-only for `ideal_loads_outdoor_air_design_flow_diagnostic_001` and `ideal_loads_outdoor_air_flow_area_diagnostic_001` |
| `Zone Ideal Loads Heat Recovery Active Time` | detailed | `PurchasedAirManager.cc::CalcPurchAirMixedAir` and `ReportPurchasedAir` | inactive heat recovery reports zero active time | diagnostic-only for `ideal_loads_outdoor_air_design_flow_diagnostic_001` and `ideal_loads_outdoor_air_flow_area_diagnostic_001` |
...
The `ideal_loads_outdoor_air_design_flow_diagnostic_001` and
`ideal_loads_outdoor_air_flow_area_diagnostic_001` reports are
diagnostic-only Flow/Zone and Flow/Area outdoor-air design-flow results for
IdealLoads
