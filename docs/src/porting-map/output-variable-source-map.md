...
| `Zone Ideal Loads Zone Total Heating Rate` | detailed | IdealLoads HVAC component implementation and zone equipment managers | `calc_no_oa_no_limit_sensible_compat` sampled by the IdealLoads compare lane | conformance for `ideal_loads_no_oa_sensible_conformance_001` only |
| `Zone Ideal Loads Zone Total Cooling Rate` | detailed | IdealLoads HVAC component implementation and zone equipment managers | `calc_no_oa_no_limit_sensible_compat` sampled by the IdealLoads compare lane | conformance for `ideal_loads_no_oa_sensible_conformance_001` only |
| `Zone Ideal Loads Zone Sensible Heating Rate` | detailed | IdealLoads HVAC component implementation and zone equipment managers | `calc_no_oa_no_limit_sensible_compat` sampled by the IdealLoads compare lane | conformance for `ideal_loads_no_oa_sensible_conformance_001` only |
...
| `Zone Ideal Loads Outdoor Air Mass Flow Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirMinOAMassFlow`, `CalcPurchAirLoads`, and `ReportPurchasedAir` | `calc_scheduled_outdoor_air_mass_flow_rate_kg_per_s` plus DifferentialDryBulb/DifferentialEnthalpy economizer OA flow reset in the IdealLoads outdoor-air diagnostic lane | diagnostic-only for nine IdealLoads outdoor-air fixtures, including `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001`; no OA load conformance |
| `Zone Ideal Loads Outdoor Air Standard Density Volume Flow Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirMinOAMassFlow`, `CalcPurchAirLoads`, and `ReportPurchasedAir` | final outdoor-air mass flow divided by EnergyPlus `StdRhoAir` in the diagnostic compare lane | diagnostic-only for nine IdealLoads outdoor-air fixtures, including `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001`; no OA load conformance |
| `Zone Ideal Loads Outdoor Air Sensible Heating Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads` and `ReportPurchasedAir` | `calc_outdoor_air_sensible_report_rates_compat` using source-order zone/OA state proof rows | diagnostic-only for nine IdealLoads outdoor-air fixtures, including `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001`; 1 W source-order tolerance |
...
| `Zone Ideal Loads Outdoor Air Total Heating Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads` and `ReportPurchasedAir` | no-humidity total heating equals sensible heating in the diagnostic compare lane | diagnostic-only for nine IdealLoads outdoor-air fixtures, including `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001`; 1 W source-order tolerance |
| `Zone Ideal Loads Outdoor Air Total Cooling Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads` and `ReportPurchasedAir` | no-humidity total cooling equals sensible cooling in the diagnostic compare lane | diagnostic-only for nine IdealLoads outdoor-air fixtures, including `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001`; 1 W source-order tolerance |
| `Zone Ideal Loads Supply Air Mass Flow Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads` and `ReportPurchasedAir` | no-limit supply mass selected from OA and sensible flow requirements | diagnostic-only for nine IdealLoads outdoor-air fixtures, including `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001` |
| `Zone Ideal Loads Supply Air Standard Density Volume Flow Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads`, `ReportPurchasedAir`, and `DataEnvironment.hh::StdRhoAir` | supply mass flow divided by EnergyPlus `StdRhoAir` in the diagnostic compare lane | diagnostic-only for nine IdealLoads outdoor-air fixtures, including `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001` |
| `Zone Ideal Loads Supply Air Temperature` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads` and `ReportPurchasedAir` | no-limit supply temperature from source-order demand, mass flow, and mixed-air clamp | diagnostic-only for nine IdealLoads outdoor-air fixtures, including `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001`; 0.02 C tolerance |
| `Zone Ideal Loads Supply Air Humidity Ratio` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads` and `ReportPurchasedAir` | no-humidity-control supply humidity follows mixed-air humidity | diagnostic-only for nine IdealLoads outdoor-air fixtures, including `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001` |
| `Zone Ideal Loads Mixed Air Temperature` | detailed | `PurchasedAirManager.cc::CalcPurchAirMixedAir` and `SetupOutputVariable` | mixed-air state from source-order recirculation/OA proof rows, including no-heat-recovery rows, DifferentialDryBulb/DifferentialEnthalpy economizer OA flow reset, and Sensible heat-recovery OA tempering | diagnostic-only for nine IdealLoads outdoor-air fixtures, including `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001` |
...
| `Zone Ideal Loads Heat Recovery Sensible Heating Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirMixedAir` and `ReportPurchasedAir` | inactive heat recovery reports zero sensible heating; Sensible heat recovery reports source-order outdoor-air tempering output | diagnostic-only for eight inactive fixtures plus active Sensible heat recovery in `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001` |
| `Zone Ideal Loads Heat Recovery Latent Heating Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirMixedAir` and `ReportPurchasedAir` | inactive heat recovery reports zero latent heating; Sensible heat recovery leaves humidity unchanged and latent output at zero | diagnostic-only for eight inactive fixtures plus active Sensible heat recovery in `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001` |
| `Zone Ideal Loads Heat Recovery Total Heating Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirMixedAir` and `ReportPurchasedAir` | inactive heat recovery reports zero total heating; Sensible heat recovery total heating follows sensible output | diagnostic-only for eight inactive fixtures plus active Sensible heat recovery in `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001` |
| `Zone Ideal Loads Heat Recovery Sensible Cooling Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirMixedAir` and `ReportPurchasedAir` | inactive heat recovery reports zero sensible cooling; Sensible heat recovery reports source-order outdoor-air tempering output | diagnostic-only for eight inactive fixtures plus active Sensible heat recovery in `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001` |
| `Zone Ideal Loads Heat Recovery Latent Cooling Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirMixedAir` and `ReportPurchasedAir` | inactive heat recovery reports zero latent cooling; Sensible heat recovery leaves humidity unchanged and latent output at zero | diagnostic-only for eight inactive fixtures plus active Sensible heat recovery in `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001` |
| `Zone Ideal Loads Heat Recovery Total Cooling Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirMixedAir` and `ReportPurchasedAir` | inactive heat recovery reports zero total cooling; Sensible heat recovery total cooling follows sensible output | diagnostic-only for eight inactive fixtures plus active Sensible heat recovery in `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001` |
| `Zone Ideal Loads Economizer Active Time` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads` and `ReportPurchasedAir` | inactive economizer reports zero active time; DifferentialDryBulb reports the current system timestep when OA dry-bulb is below recirculation dry-bulb and OA flow is reset above the minimum; DifferentialEnthalpy uses the same reset after OA enthalpy is below recirculation enthalpy | diagnostic-only for nine IdealLoads outdoor-air fixtures, including `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001` |
| `Zone Ideal Loads Heat Recovery Active Time` | detailed | `PurchasedAirManager.cc::CalcPurchAirMixedAir` and `ReportPurchasedAir` | inactive heat recovery reports zero active time; Sensible heat recovery reports the current system timestep when OA tempering is active | diagnostic-only for eight inactive fixtures plus active Sensible heat recovery in `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001` |
...
| `System Node Temperature` | detailed | `node-state-source-map.md`; `NodeInputManager.cc`; `ZoneTempPredictorCorrector.cc`; `PurchasedAirManager.cc`; `ZoneEquipmentManager.cc` | `supply_node_update_from_result` in the IdealLoads compare lane; finite-limit return-node same-call proof rows from oracle ESO | conformance for the IdealLoads supply node in `ideal_loads_no_oa_sensible_conformance_001` only; finite-limit rows zero-failure diagnostic-only |
...
and `ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001`
...
Sensible heat-recovery outdoor-air results for IdealLoads outdoor-air mass
flow, standard-density volume flow, no-humidity sensible/latent/total report
rates, supply-air state, mixed-air temperature and humidity ratio, inactive
heat-recovery rows, Sensible heat-recovery rows, and economizer active-time
rows. It does not promote active DCV, Enthalpy heat recovery, active humidity
