...
| `Zone Ideal Loads Zone Latent Cooling Rate` | detailed | `PurchasedAirManager.cc::CalcPurchAirLoads`, `ReportPurchasedAir`, and EnergyPlus psychrometric helpers | no-OA `ConstantSensibleHeatRatio` and `ConstantSupplyHumidityRatio` cooling latent split with EPW barometric-pressure saturation clamp | diagnostic-only for `ideal_loads_constant_shr_diagnostic_001` and `ideal_loads_constant_supply_humidity_diagnostic_001`; no broad humidity-control conformance |
...
| `Zone Ideal Loads Supply Air Sensible Cooling Rate` | detailed | `PurchasedAirManager.cc::ReportPurchasedAir` | no-OA `ConstantSensibleHeatRatio` and `ConstantSupplyHumidityRatio` supply-air sensible cooling report row in the diagnostic compare lane | diagnostic-only for `ideal_loads_constant_shr_diagnostic_001` and `ideal_loads_constant_supply_humidity_diagnostic_001`; no broad humidity-control conformance |
...
| `Zone Ideal Loads Supply Air Latent Cooling Rate` | detailed | `PurchasedAirManager.cc::ReportPurchasedAir` and EnergyPlus psychrometric helpers | no-OA `ConstantSensibleHeatRatio` and `ConstantSupplyHumidityRatio` supply-air latent cooling report row with EnergyPlus enthalpy constants | diagnostic-only for `ideal_loads_constant_shr_diagnostic_001` and `ideal_loads_constant_supply_humidity_diagnostic_001`; no broad humidity-control conformance |
