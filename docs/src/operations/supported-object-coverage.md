...
| Construction | yes | partial | yes | yes | partial | partial | partial | partial | outside layer used for first-zone UA and compared against EIO `Construction CTF`; official `1ZoneUncontrolled` static EIO fields are v0.23 conformance |
...
| OtherEquipment | yes | partial | yes | yes | partial | partial | partial | partial | internal gains used for first-zone subset, EIO nominal-gains comparison, v0.23 official static EIO nominal-gains evidence, and ESO convective-gain trace |
