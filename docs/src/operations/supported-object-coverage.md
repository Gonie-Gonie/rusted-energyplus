...
| Zone | yes | partial | yes | yes | partial | partial | partial | partial | complete public declaration fields plus bounded nominal-control and ZoneGroup side effects; local convection overrides and zone grouping fail closed before runtime; existing first-zone numerical boundaries are unchanged |
