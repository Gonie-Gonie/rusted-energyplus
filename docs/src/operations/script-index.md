...
| `official-dynamic-heat-balance-all-ctf-analytical-coupled-previous-inside-quick-outside-interleaved-lw-iter20-probe` | diagnostic | run the official dynamic diagnostic with all EIO CTF rows plus quick outside solves, grey interior longwave exchange, and twenty interleaved surface/zone-air passes | no | `.runtime/official-dynamic-diagnostic-all-ctf-analytical-coupled-previous-inside-quick-outside-interleaved-lw-surface-iter20` |
