...
| `compare-ideal-loads-no-oa-facility-meter-monthly-run-period-conformance-candidate` | conformance | run the no-OA monthly/run-period facility meter IdealLoads conformance candidate | yes | `.runtime/ideal-loads-no-oa-facility-meter-monthly-run-period-conformance` |
