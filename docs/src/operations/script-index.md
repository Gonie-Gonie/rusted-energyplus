...
| `official-dynamic-heat-balance-compat-candidate` | conformance | run the official dynamic compatibility-candidate gate with all EIO CTF rows, EnergyPlus initial CTF histories, 20-day warmup, 20 surface iterations, and the promoted conformance output set | yes | `.runtime/official-dynamic-compat-candidate` |
