...
| `official-dynamic-heat-balance-compat-candidate` | diagnostic | run the official dynamic compatibility-candidate lane with all EIO CTF rows, EnergyPlus initial CTF histories, 20-day warmup, and no conformance claim | no | `.runtime/official-dynamic-compat-candidate` |
