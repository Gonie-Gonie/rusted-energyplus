...
```text
.runtime/release-evidence/v0.12.0/numeric-conformance-evidence.html
.runtime/release-evidence/v0.12.0/numeric-conformance-evidence.pdf
.runtime/release-evidence/v0.12.0/numeric-conformance-evidence.json
```

Current packaged release paths:

```text
evidence/v0.12.0/numeric-conformance-evidence.html
evidence/v0.12.0/numeric-conformance-evidence.pdf
evidence/v0.12.0/numeric-conformance-evidence.json
```

## Included Cases

Only promoted, tolerance-gated numerical conformance cases enter the release
PDF. For v0.12.0, that means the earlier v0.8/v0.9 cases only:
