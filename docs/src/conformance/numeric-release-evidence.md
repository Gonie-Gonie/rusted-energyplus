...
```text
.runtime/release-evidence/v0.29.0/numeric-conformance-evidence.html
.runtime/release-evidence/v0.29.0/numeric-conformance-evidence.pdf
.runtime/release-evidence/v0.29.0/numeric-conformance-evidence.json
```
...
metadata; those infrastructure/static/reporting changes do not add series to
this numerical PDF and are represented instead by their gates plus the
conformance index and support coverage report:
