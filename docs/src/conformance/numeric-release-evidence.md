...
```text
.runtime/release-evidence/v0.19.0/numeric-conformance-evidence.html
.runtime/release-evidence/v0.19.0/numeric-conformance-evidence.pdf
.runtime/release-evidence/v0.19.0/numeric-conformance-evidence.json
```
...
PDF. v0.19.0 is a comparison-infrastructure release. That still means the
