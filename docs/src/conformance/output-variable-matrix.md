...
|---|---|---|---|
| weather | Site Outdoor Air Drybulb Temperature; Site Rain Status; Site Outdoor Air Dewpoint Temperature; Site Outdoor Air Relative Humidity; Site Outdoor Air Barometric Pressure; Site Wind Speed; Site Wind Direction | ESO | dry-bulb conformance for `weather_fields_001`; rain-status conformance only for the declared official dynamic Environment row; other weather rows diagnostic |
