...
| surface heat balance | Surface Inside Face Temperature; Surface Outside Face Temperature; Surface Inside Face Conduction Heat Transfer Rate; Surface Inside/Outside Face Conduction Heat Transfer Rate per Area; Surface Outside Face Incident Total/Beam/Sky/Ground Solar Radiation Rate per Area; declared absorbed Surface Outside Face Solar Radiation Heat Gain Rate and roof per-area row; Surface Outside Face Convection and Net Thermal Radiation Heat Gain Rate; Surface Heat Storage Rate; Surface Heat Storage Rate per Area; Zone Opaque Surface Inside/Outside Faces Conduction Rate | ESO | conformance for no-mass adiabatic `surface_temperature_nomass_001` and the official dynamic compatibility candidate's declared face-temperature, whole-surface conduction, conduction per-area, named wall/roof incident total/beam solar, exact-zero named wall/roof sky/ground diffuse incident solar, named wall/roof absorbed solar heat gain rate, roof absorbed solar heat gain per-area, zone opaque aggregate conduction, and floor storage rows; other exterior source rows remain diagnostic |
