...
| surface heat balance | Surface Inside Face Temperature; Surface Outside Face Temperature; Surface Inside Face Conduction Heat Transfer Rate; Surface Inside/Outside Face Conduction Heat Transfer Rate per Area; Surface Outside Face Convection, Net Thermal Radiation, and Solar Radiation Heat Gain Rate; Zone Opaque Surface Inside/Outside Faces Conduction Rate | ESO | conformance for no-mass adiabatic `surface_temperature_nomass_001` and the official dynamic compatibility candidate's declared face-temperature and whole-surface conduction rows; exterior source, storage, per-area dynamic, and aggregate dynamic rows remain diagnostic |
