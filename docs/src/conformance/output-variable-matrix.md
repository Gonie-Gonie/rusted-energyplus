...
| surface heat balance | Surface Inside Face Temperature; Surface Outside Face Temperature; Surface Inside Face Conduction Heat Transfer Rate; Surface Inside/Outside Face Conduction Heat Transfer Rate per Area; Surface Outside Face Convection, Net Thermal Radiation, and Solar Radiation Heat Gain Rate; Surface Heat Storage Rate; Surface Heat Storage Rate per Area; Zone Opaque Surface Inside/Outside Faces Conduction Rate | ESO | conformance for no-mass adiabatic `surface_temperature_nomass_001` and the official dynamic compatibility candidate's declared face-temperature, whole-surface conduction, conduction per-area, zone opaque aggregate conduction, and floor storage rows; exterior source rows remain diagnostic |
