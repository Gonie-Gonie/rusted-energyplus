...
|---|---|---|---|
| weather | Site Outdoor Air Drybulb Temperature; Site Outdoor Air Wetbulb Temperature; Site Rain Status; Site Outdoor Air Dewpoint Temperature; Site Outdoor Air Relative Humidity; Site Outdoor Air Barometric Pressure; Site Wind Speed; Site Wind Direction | ESO | dry-bulb conformance for `weather_fields_001`; wetbulb/rain-status conformance only for the declared official dynamic Environment rows; other weather rows diagnostic |
...
| zone heat balance | Zone Mean Air Temperature; Zone Air Heat Balance Internal Convective Heat Gain Rate; Zone Air Heat Balance Surface Convection Rate; Zone Air Heat Balance Air Energy Storage Rate | ESO | conformance for `heat_balance_nomass_001` `Zone Mean Air Temperature` and the official dynamic compatibility candidate's declared zone-air rows |
| surface heat balance | Surface Inside Face Temperature; Surface Outside Face Temperature; Surface Inside Face Conduction Heat Transfer Rate; Surface Inside/Outside Face Conduction Heat Transfer Rate per Area; Surface Inside Face Convection Heat Transfer Coefficient; Surface Outside Face Convection Heat Transfer Coefficient; Surface Inside Face Convection and Net Thermal Radiation Heat Gain Rate; Surface Outside Face Incident Total/Beam/Sky/Ground Solar Radiation Rate per Area; declared absorbed Surface Outside Face Solar Radiation Heat Gain Rate and roof per-area row; Surface Outside Face Convection and Net Thermal Radiation Heat Gain Rate; Surface Heat Storage Rate; Surface Heat Storage Rate per Area; Zone Opaque Surface Inside/Outside Faces Conduction Rate plus outside gain/loss aggregates | ESO | conformance for no-mass adiabatic `surface_temperature_nomass_001` and the official dynamic compatibility candidate's declared face-temperature, whole-surface conduction, conduction per-area, inside convection/radiation source rows, inside/outside convection coefficients, declared wall/roof exterior convection/net-radiation source rows, roof exterior convection/net-radiation per-area rows, named wall/roof incident total/beam solar, exact-zero named wall/roof sky/ground diffuse incident solar, named wall/roof absorbed solar heat gain rate, roof absorbed solar heat gain per-area, zone opaque aggregate conduction including outside gain/loss rows, and floor storage rows; exterior source rows outside those declared rows remain diagnostic |
| fenestration/solar | Surface Window Transmitted Solar Radiation Rate; Surface Inside Face Solar Radiation Heat Gain Rate; absorbed Surface Outside Face Solar Radiation Heat Gain Rate outside the declared wall/roof candidate rows | ESO | diagnostic until a separate declared case exists |
...
| facility meter | DistrictHeatingWater:Facility; DistrictCooling:Facility; Electricity:Facility; Gas:Facility; Heating:EnergyTransfer; Cooling:EnergyTransfer | MTR, SQL, CSV | narrow conformance for declared no-OA IdealLoads DistrictHeatingWater/DistrictCooling hourly rows in the dedicated meter candidate, hourly/monthly/run-period rows in the humidity-control candidates, plus declared monthly/annual/run-period rows in the meter-only candidate; annual rows in the short-run humidity-control candidates and other meters remain diagnostic until separate contracts |
