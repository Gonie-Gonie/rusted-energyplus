...
- `official_1zone_uncontrolled_dynamic_conformance_candidate_001` declared
  weather drybulb/wetbulb/sky/horizontal-infrared/rain-status, roof surface-local outdoor-air drybulb/wetbulb/wind speed/wind direction, zone-air, surface temperature, surface
  conduction, inside convection/radiation source rows, inside/outside
  convection coefficients, zone opaque aggregate conduction including outside
...
| Heat balance | no-mass zone MAT, no-mass surface inside/outside temperature, no-mass adiabatic conduction series, selected official `1ZoneUncontrolled` dynamic weather drybulb/wetbulb/sky/horizontal-infrared/rain-status, roof surface-local outdoor-air drybulb/wetbulb/wind, zone-air, surface-temperature/surface-conduction, conduction-per-area, inside convection/radiation source rows, inside/outside convection coefficient rows, named wall/roof incident total/beam solar per-area rows, exact-zero named wall/roof sky/ground diffuse incident solar per-area rows, named wall/roof absorbed solar heat gain rate rows, the roof absorbed solar heat gain per-area row, zone opaque aggregate conduction variables including outside-face gain/loss aggregates, and the declared floor `Surface Heat Storage Rate` / `Surface Heat Storage Rate per Area` rows under dedicated aggregate/flux/storage/solar-rate/solar-flux/coefficient tolerances | official `1ZoneUncontrolled` broad diagnostic decomposition, broad weather processor, absorbed/non-incident solar outside the declared absorbed rows, exterior radiation/convection heat-gain diagnostics, and non-promoted probe lanes | broad CTF storage parity, EnergyPlus warmup convergence parity outside the official candidate, broad weather processor compatibility, absorbed/non-incident solar outside the declared rows, exterior radiation/convection heat-gain rate rows, fenestration, infiltration, zone air predictor/corrector parity, or general heat-balance compatibility |
