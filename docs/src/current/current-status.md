...
- limited IdealLoads no-OA/no-limit sensible conformance for declared
  ...
  meters in that case compared as oracle-MTR vs Rust aggregated fuel-energy
  diagnostics with RuntimeMeterRegistry request resolution, while broad meter
  conformance beyond the declared meter candidate, humidity,
