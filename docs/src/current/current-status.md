...
separate counts. Current public documentation tracks 119 conformance output
variables, 10 diagnostic output variables, and 6 baseline output variables, for
135 tracked output variables. Release-evidence pass counts remain generated by
the release evidence reports and do not change the variable coverage total.
