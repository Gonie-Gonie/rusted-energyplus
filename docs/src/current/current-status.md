...
- limited IdealLoads no-OA/no-limit sensible conformance for declared
  ...
  blank/constant Schedule:Constant fuel energy rows kept diagnostic-only, and
...
- limited IdealLoads no-OA ReportPurchasedAir energy conformance for declared
  ...
  energy Detailed rows, with fuel-energy, rate, thermostat, demand, humidity,
  node, and facility meter rows kept diagnostic proof only
