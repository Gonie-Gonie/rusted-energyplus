...
- `official_1zone_uncontrolled_dynamic_conformance_candidate_001` declared
  weather/wetbulb/rain-status, zone-air, surface temperature, surface
...
- official dynamic heat-balance conformance reports that run a Rust warmup
  ...
  ESO values to run-period samples, gate declared weather/wetbulb/rain-status, zone-air,
