...
- diagnostic-only IdealLoads remaining AirChanges/Hour, Sum,
  ...
  rates, supply-air state, mixed-air state, economizer active time, inactive
  heat-recovery reports, and heat-recovery active-time/rate rows, with active
