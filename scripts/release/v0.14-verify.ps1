...
Assert-FileExists -Path "docs\src\operations\v0.14.0-plan.md" -Description "v0.14 plan"
Assert-FileExists -Path "docs\src\operations\v0.14.0-readiness.md" -Description "v0.14 readiness"
...
Assert-Contains -Path "docs\src\operations\v0.14.0-readiness.md" -Pattern "planning-ready" -Description "v0.14 readiness status"
...
Assert-Contains -Path "docs\src\operations\v0.14.0-plan.md" -Pattern "This is not a plant, HVAC, node, meter, sizing, or ExampleFiles numerical" -Description "v0.14 plan boundary"
...
Assert-ZipEntry -ZipPath $package -Entry "docs/src/operations/v0.14.0-plan.md" -Description "v0.14 packaged plan"
Assert-ZipEntry -ZipPath $package -Entry "docs/src/operations/v0.14.0-readiness.md" -Description "v0.14 packaged readiness"
