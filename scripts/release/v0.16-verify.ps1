...
Assert-FileExists -Path "docs\src\operations\v0.17.0-plan.md" -Description "v0.17 plan seed"
Assert-FileExists -Path "docs\src\operations\v0.18.0-plan.md" -Description "v0.18 plan seed"
Assert-FileExists -Path "docs\src\releases\v0.16.0.md" -Description "v0.16 release notes"
Assert-FileExists -Path "docs\src\project-scope\versioning-reset-v2.md" -Description "versioning reset v2"
Assert-FileExists -Path "docs\src\project-scope\legacy-milestones.md" -Description "legacy milestones"
Assert-FileExists -Path "docs\src\project-scope\v1-scope.md" -Description "v1 scope"
Assert-FileExists -Path "docs\src\project-scope\v2-full-compatibility.md" -Description "v2 full compatibility target"
Assert-FileExists -Path "docs\src\project-scope\v3-fast-successor.md" -Description "v3 fast successor target"
...
Assert-Contains -Path "docs\src\project-scope\versioning-reset-v2.md" -Pattern "v0.16 starts the Road to v1.0" -Description "v0.16 reset meaning"
Assert-Contains -Path "docs\src\project-scope\legacy-milestones.md" -Pattern "Historical Pre-Alpha Evidence Series" -Description "legacy evidence classification"
...
Assert-Contains -Path "docs\src\operations\v0.16.0-readiness.md" -Pattern "versioning-cleanup-ready" -Description "v0.16 readiness status"
...
Assert-ZipEntry -ZipPath $package -Entry "docs/src/operations/v0.17.0-plan.md" -Description "v0.17 packaged plan seed"
Assert-ZipEntry -ZipPath $package -Entry "docs/src/operations/v0.18.0-plan.md" -Description "v0.18 packaged plan seed"
Assert-ZipEntry -ZipPath $package -Entry "docs/src/project-scope/versioning-reset-v2.md" -Description "packaged versioning reset"
Assert-ZipEntry -ZipPath $package -Entry "docs/src/project-scope/legacy-milestones.md" -Description "packaged legacy milestones"
Assert-ZipEntry -ZipPath $package -Entry "docs/src/project-scope/v1-scope.md" -Description "packaged v1 scope"
Assert-ZipEntry -ZipPath $package -Entry "docs/src/project-scope/v2-full-compatibility.md" -Description "packaged v2 target"
Assert-ZipEntry -ZipPath $package -Entry "docs/src/project-scope/v3-fast-successor.md" -Description "packaged v3 target"
...
Write-Host "v0.16.0 versioning and evidence cleanup verification passed."
