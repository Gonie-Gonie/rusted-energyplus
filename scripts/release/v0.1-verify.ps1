...
Assert-Contains -Path "scripts\launcher\build-launcher-exe.ps1" -Pattern "WindowsApplication" -Description "no-console launcher builder"
...
Assert-ZipEntry -ZipPath $package -Entry "scripts/launcher/eplus-rs-launch.ps1" -Description "packaged launcher UI script"
Assert-ZipEntry -ZipPath $package -Entry "scripts/launcher/build-launcher-exe.ps1" -Description "packaged launcher builder"
