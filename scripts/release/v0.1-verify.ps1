...
Assert-FileExists -Path "docs\src\archive\development-plan-v2.md" -Description "archived development plan"
...
Assert-FileExists -Path "docs\src\archive\pre-alpha\v0.1.0-readiness.md" -Description "v0.1 readiness document"
