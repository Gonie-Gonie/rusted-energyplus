...
Assert-FileExists -Path "docs\src\operations\v0.15.0-plan.md" -Description "v0.15 plan"
Assert-FileExists -Path "docs\src\operations\v0.15.0-readiness.md" -Description "v0.15 readiness"
...
Assert-Contains -Path "docs\src\operations\v0.15.0-readiness.md" -Pattern "diagnostic-ready" -Description "v0.15 readiness status"
...
Assert-ZipEntry -ZipPath $package -Entry "docs/src/operations/v0.15.0-plan.md" -Description "v0.15 packaged plan"
Assert-ZipEntry -ZipPath $package -Entry "docs/src/operations/v0.15.0-readiness.md" -Description "v0.15 packaged readiness"
