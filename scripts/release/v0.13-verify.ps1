...
Assert-FileExists -Path "docs\src\operations\v0.13.0-plan.md" -Description "v0.13 plan"
Assert-FileExists -Path "docs\src\operations\v0.13.0-readiness.md" -Description "v0.13 readiness"
...
Assert-Contains -Path "docs\src\operations\v0.13.0-readiness.md" -Pattern "plant-graph-ready" -Description "v0.13 readiness status"
...
Assert-ZipEntry -ZipPath $package -Entry "docs/src/operations/v0.13.0-plan.md" -Description "v0.13 packaged plan"
Assert-ZipEntry -ZipPath $package -Entry "docs/src/operations/v0.13.0-readiness.md" -Description "v0.13 packaged readiness"
