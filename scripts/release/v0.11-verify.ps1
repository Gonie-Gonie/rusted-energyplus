...
Assert-Contains -Path "crates\ep_conformance\src\lib.rs" -Pattern "NodeState" -Description "v0.11 node-state manifest class"
Assert-Contains -Path "crates\ep_model\src\lib.rs" -Pattern "pub struct Node" -Description "v0.11 node typed model"
