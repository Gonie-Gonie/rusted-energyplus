...
$OutputRoot = Join-Path $RepoRoot ".runtime\ideal-loads-outdoor-air-air-changes\26.1.0"
$CaseId = "ideal_loads_outdoor_air_air_changes_diagnostic_001"
...
Write-Host "Generating IdealLoads outdoor-air AirChanges/Hour diagnostic comparison artifacts."
...
if ($LASTEXITCODE -ne 0) {
    ...
    throw "IdealLoads outdoor-air AirChanges/Hour diagnostic comparison failed."
}
...
Assert-Contains -Text $reportText -Pattern "claim_boundary: diagnostic-only IdealLoads outdoor-air Flow/Zone, Flow/Area, and AirChanges/Hour mass, standard-density volume, outdoor-air report rates, supply-air state, mixed-air state, and inactive economizer/heat recovery" -Description "markdown claim boundary"
...
Write-Host "IdealLoads outdoor-air AirChanges/Hour diagnostic comparison artifacts generated."
