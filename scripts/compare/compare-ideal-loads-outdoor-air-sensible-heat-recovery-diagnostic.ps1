...
$OutputRoot = Join-Path $RepoRoot ".runtime\ideal-loads-outdoor-air-sensible-heat-recovery\26.1.0"
$CaseId = "ideal_loads_outdoor_air_sensible_heat_recovery_diagnostic_001"
...
Write-Host "Generating IdealLoads outdoor-air sensible heat-recovery diagnostic comparison artifacts."
...
Assert-Contains -Text $reportText -Pattern "claim_boundary: diagnostic-only IdealLoads outdoor-air Flow/Zone mass, standard-density volume, outdoor-air report rates, supply-air state, mixed-air state, and Sensible heat recovery active-time/rate parity; DCV, economizer, Enthalpy heat recovery, humidity controls, saturation-limit branches, and broad OA conformance remain outside the claim" -Description "markdown claim boundary"
...
Assert-Contains -Text $reportText -Pattern "| ZONE ONE IDEAL LOADS | Zone Ideal Loads Heat Recovery Sensible Heating Rate | diagnostic" -Description "markdown sensible heat-recovery sensible heating row"
Assert-Contains -Text $reportText -Pattern "| ZONE ONE IDEAL LOADS | Zone Ideal Loads Heat Recovery Total Cooling Rate | diagnostic" -Description "markdown sensible heat-recovery total cooling row"
...
Assert-Contains -Text $reportText -Pattern "| ZONE ONE IDEAL LOADS | Zone Ideal Loads Heat Recovery Active Time | diagnostic" -Description "markdown sensible heat-recovery active-time row"

Write-Host "IdealLoads outdoor-air sensible heat-recovery diagnostic comparison artifacts generated."
