...
Assert-Contains -Text $reportText -Pattern "claim_boundary: conformance no-OA Humidistat dehumidification IdealLoads branch for declared variables, ReportPurchasedAir energy rows, blank fuel-efficiency rows, and hourly facility meters only" -Description "markdown claim boundary"
