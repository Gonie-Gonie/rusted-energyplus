...
Assert-Contains -Text $reportText -Pattern "claim_boundary: conformance no-OA Humidistat humidification IdealLoads branch for declared variables, ReportPurchasedAir energy rows, and blank fuel-efficiency rows only" -Description "markdown claim boundary"
