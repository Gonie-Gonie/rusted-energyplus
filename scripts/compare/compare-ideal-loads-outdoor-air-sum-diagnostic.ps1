...
$OutputRoot = Join-Path $RepoRoot ".runtime\ideal-loads-outdoor-air-sum\26.1.0"
$CaseId = "ideal_loads_outdoor_air_sum_diagnostic_001"
...
Write-Host "Generating IdealLoads outdoor-air Sum diagnostic comparison artifacts."
...
if ($LASTEXITCODE -ne 0) {
    ...
    throw "IdealLoads outdoor-air Sum diagnostic comparison failed."
}
...
Write-Host "IdealLoads outdoor-air Sum diagnostic comparison artifacts generated."
