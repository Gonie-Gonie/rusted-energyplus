...
$OutputRoot = Join-Path $RepoRoot ".runtime\ideal-loads-outdoor-air-differential-dry-bulb-economizer\26.1.0"
$CaseId = "ideal_loads_outdoor_air_differential_dry_bulb_economizer_diagnostic_001"
...
Write-Host "Generating IdealLoads outdoor-air differential dry-bulb economizer diagnostic comparison artifacts."
...
Assert-Contains -Text $reportText -Pattern "| ZONE ONE IDEAL LOADS | Zone Ideal Loads Economizer Active Time | diagnostic" -Description "markdown differential dry-bulb economizer active-time row"
...
Write-Host "IdealLoads outdoor-air differential dry-bulb economizer diagnostic comparison artifacts generated."
