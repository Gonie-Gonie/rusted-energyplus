...
Assert-Contains -Path "docs\src\current\current-status.md" -Pattern "no-OA/no-limit and numeric finite-limit IdealLoads sensible conformance plus no-OA ConstantSensibleHeatRatio cooling, ConstantSupplyHumidityRatio cooling/heating, and Humidistat dehumidification/humidification conformance" -Description "IdealLoads current-status conformance boundary"
Assert-Contains -Path "docs\src\current\current-status.md" -Pattern "broad HVAC, broad node, full IdealLoads, active DCV, broad or remaining humidity-control branches" -Description "IdealLoads current-status broad non-claim boundary"
