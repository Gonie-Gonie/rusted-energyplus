...
Assert-Contains -Path "specs\algorithm_ledger.toml" -Pattern 'claim_level = "limited-ideal-loads-no-oa-sensible-finite-limit-meter-conformance"' -Description "IdealLoads finite-limit and meter algorithm claim"
