...
Assert-Contains -Path "README.md" -Pattern 'diagnostic-only IdealLoads no-OA `ConstantSupplyHumidityRatio` heating' -Description "IdealLoads remaining humidity diagnostic README boundary"
...
Assert-Contains -Path "docs\src\current\current-status.md" -Pattern "no-OA/no-limit and numeric finite-limit IdealLoads sensible conformance plus no-OA ConstantSensibleHeatRatio and ConstantSupplyHumidityRatio cooling conformance" -Description "IdealLoads current-status conformance boundary"
