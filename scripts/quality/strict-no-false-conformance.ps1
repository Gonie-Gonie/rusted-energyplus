...
Assert-Contains -Path "README.md" -Pattern "diagnostic-only IdealLoads remaining AirChanges/Hour" -Description "IdealLoads OA diagnostic README boundary"
...
Assert-Contains -Path "docs\src\current\current-status.md" -Pattern "no-OA/no-limit and numeric finite-limit IdealLoads sensible conformance plus no-OA ConstantSensibleHeatRatio cooling, ConstantSupplyHumidityRatio cooling/heating, Humidistat dehumidification/humidification, and outdoor-air Flow/Zone/Flow/Person/Flow/Area conformance" -Description "IdealLoads current-status conformance boundary"
Assert-Contains -Path "docs\src\current\current-status.md" -Pattern "outdoor-air methods beyond Flow/Zone/Flow/Person/Flow/Area, active economizer/heat recovery" -Description "IdealLoads current-status broad non-claim boundary"
...
Assert-Contains -Path "specs\variable_coverage.toml" -Pattern "Tolerance-gated IdealLoads outdoor-air Flow/Zone, Flow/Person, and Flow/Area mass-flow conformance for ideal_loads_outdoor_air_flow_zone_conformance_candidate_001, ideal_loads_outdoor_air_flow_person_conformance_candidate_001, and ideal_loads_outdoor_air_flow_area_conformance_candidate_001" -Description "IdealLoads OA Flow/Zone Flow/Person Flow/Area variable coverage claim"
...
Assert-Contains -Path "specs\algorithm_ledger.toml" -Pattern 'claim_level = "limited-ideal-loads-outdoor-air-flow-zone-flow-person-flow-area-conformance"' -Description "IdealLoads OA Flow/Zone Flow/Person Flow/Area algorithm claim"
