...
Assert-Contains -Path "README.md" -Pattern "diagnostic-only IdealLoads no-OA Humidistat dehumidification/humidification" -Description "IdealLoads remaining humidity diagnostic README boundary"
...
Assert-Contains -Path "docs\src\current\current-status.md" -Pattern "no-OA/no-limit and numeric finite-limit IdealLoads sensible conformance plus no-OA ConstantSensibleHeatRatio cooling and ConstantSupplyHumidityRatio cooling/heating conformance" -Description "IdealLoads current-status conformance boundary"
...
Assert-Contains -Path "specs\variable_coverage.toml" -Pattern "Humidistat dehumidification latent cooling remains diagnostic-only" -Description "IdealLoads humidity variable coverage boundary"
