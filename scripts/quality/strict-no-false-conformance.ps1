...
Assert-Contains -Path "specs\milestones.toml" -Pattern "Official Dynamic Heat-Balance Diagnostic" -Description "v0.33 active boundary"
Assert-Contains -Path "specs\milestones.toml" -Pattern 'claim_level = "diagnostic-only"' -Description "v0.33 diagnostic-only boundary"
