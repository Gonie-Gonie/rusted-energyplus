...
Assert-Contains -Path "README.md" -Pattern "diagnostic-only IdealLoads remaining Maximum" -Description "IdealLoads OA diagnostic README boundary"
...
Assert-Contains -Path "specs\variable_coverage.toml" -Pattern "Tolerance-gated IdealLoads outdoor-air Flow/Zone, Flow/Person, Flow/Area, AirChanges/Hour, and Sum mass-flow conformance for ideal_loads_outdoor_air_flow_zone_conformance_candidate_001, ideal_loads_outdoor_air_flow_person_conformance_candidate_001, ideal_loads_outdoor_air_flow_area_conformance_candidate_001, ideal_loads_outdoor_air_air_changes_conformance_candidate_001, and ideal_loads_outdoor_air_sum_conformance_candidate_001" -Description "IdealLoads OA Flow/Zone Flow/Person Flow/Area AirChanges/Hour Sum variable coverage claim"
...
Assert-Contains -Path "specs\algorithm_ledger.toml" -Pattern 'claim_level = "limited-ideal-loads-outdoor-air-flow-zone-flow-person-flow-area-air-changes-sum-conformance"' -Description "IdealLoads OA Flow/Zone Flow/Person Flow/Area AirChanges/Hour Sum algorithm claim"
