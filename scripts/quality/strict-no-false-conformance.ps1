...
Assert-Contains -Path "README.md" -Pattern "diagnostic-only IdealLoads no-OA Humidistat humidification humidity-control" -Description "IdealLoads remaining humidity diagnostic README boundary"
...
Assert-Contains -Path "specs\variable_coverage.toml" -Pattern "Humidistat humidification latent heating remains diagnostic-only" -Description "IdealLoads humidification variable coverage boundary"
