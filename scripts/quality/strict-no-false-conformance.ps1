...
Assert-Contains -Path "README.md" -Pattern "diagnostic-only IdealLoads remaining active heat-recovery" -Description "IdealLoads OA diagnostic README boundary"
...
Assert-Contains -Path "README.md" -Pattern "and DifferentialEnthalpy candidates, heat-recovery, DCV, humidity" -Description "IdealLoads DifferentialEnthalpy broad non-claim README boundary"
Assert-Contains -Path "docs\src\current\current-status.md" -Pattern "no-OA/no-limit and numeric finite-limit IdealLoads sensible conformance plus no-OA ConstantSensibleHeatRatio cooling, ConstantSupplyHumidityRatio cooling/heating, Humidistat dehumidification/humidification, and outdoor-air Flow/Zone/Flow/Person/Flow/Area/AirChanges/Hour/Sum/Maximum/DifferentialDryBulb/DifferentialEnthalpy economizer conformance" -Description "IdealLoads current-status conformance boundary"
Assert-Contains -Path "docs\src\current\current-status.md" -Pattern "outdoor-air methods beyond Flow/Zone/Flow/Person/Flow/Area/AirChanges/Hour/Sum/Maximum/DifferentialDryBulb/DifferentialEnthalpy economizer, active heat recovery" -Description "IdealLoads current-status broad non-claim boundary"
...
Assert-Contains -Path "specs\variable_coverage.toml" -Pattern "Tolerance-gated IdealLoads outdoor-air Flow/Zone, Flow/Person, Flow/Area, AirChanges/Hour, Sum, Maximum, and Flow/Zone DifferentialDryBulb/DifferentialEnthalpy economizer mass-flow conformance for ideal_loads_outdoor_air_flow_zone_conformance_candidate_001, ideal_loads_outdoor_air_flow_person_conformance_candidate_001, ideal_loads_outdoor_air_flow_area_conformance_candidate_001, ideal_loads_outdoor_air_air_changes_conformance_candidate_001, ideal_loads_outdoor_air_sum_conformance_candidate_001, ideal_loads_outdoor_air_maximum_conformance_candidate_001, ideal_loads_outdoor_air_differential_dry_bulb_economizer_conformance_candidate_001, and ideal_loads_outdoor_air_differential_enthalpy_economizer_conformance_candidate_001" -Description "IdealLoads OA Flow/Zone Flow/Person Flow/Area AirChanges/Hour Sum Maximum DifferentialDryBulb DifferentialEnthalpy variable coverage claim"
...
Assert-Contains -Path "specs\algorithm_ledger.toml" -Pattern 'claim_level = "limited-ideal-loads-outdoor-air-flow-zone-flow-person-flow-area-air-changes-sum-maximum-differential-dry-bulb-differential-enthalpy-economizer-conformance"' -Description "IdealLoads OA Flow/Zone Flow/Person Flow/Area AirChanges/Hour Sum Maximum DifferentialDryBulb DifferentialEnthalpy algorithm claim"
