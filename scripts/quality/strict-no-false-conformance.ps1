...
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.6.0-readiness.md" -Pattern "diagnostic-ready" -Description "v0.6 archived readiness boundary"
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.6.0-readiness.md" -Pattern "tolerance_policy: none" -Description "v0.6 tolerance boundary"
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.7.0-readiness.md" -Pattern "planning-ready" -Description "v0.7 archived readiness boundary"
...
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.8.0-readiness.md" -Pattern "conformance-ready" -Description "v0.8 archived readiness boundary"
...
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.9.0-readiness.md" -Pattern "conformance-ready" -Description "v0.9 archived readiness boundary"
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.9.0-readiness.md" -Pattern "not a fenestration or solar-radiation claim" -Description "v0.9 claim boundary"
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.10.0-readiness.md" -Pattern "typed-graph-ready" -Description "v0.10 archived readiness boundary"
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.10.0-readiness.md" -Pattern "not an IdealLoads load-conformance claim" -Description "v0.10 claim boundary"
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.10.0-readiness.md" -Pattern "v0.11 may begin only after v0.10 hardening has landed" -Description "v0.11 hardening boundary"
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.11.0-readiness.md" -Pattern "diagnostic-ready" -Description "v0.11 archived readiness boundary"
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.11.0-readiness.md" -Pattern "not a node or HVAC numerical conformance claim" -Description "v0.11 claim boundary"
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.12.0-readiness.md" -Pattern "planning-ready" -Description "v0.12 archived readiness boundary"
...
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.13.0-readiness.md" -Pattern "plant-graph-ready" -Description "v0.13 archived readiness boundary"
...
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.14.0-readiness.md" -Pattern "planning-ready" -Description "v0.14 archived readiness boundary"
...
Assert-Contains -Path "docs\src\archive\pre-alpha\v0.15.0-readiness.md" -Pattern "diagnostic-ready" -Description "v0.15 archived readiness boundary"
...
Assert-Contains -Path "docs\src\operations\v0.16.0-readiness.md" -Pattern "versioning-cleanup-ready" -Description "v0.16 active readiness boundary"
Assert-Contains -Path "docs\src\operations\v0.16.0-readiness.md" -Pattern "does not add a new numerical conformance claim" -Description "v0.16 claim boundary"
Assert-Contains -Path "docs\src\operations\v0.16.0-readiness.md" -Pattern "algorithm_parity: false" -Description "v0.16 algorithm boundary"
...
Assert-Contains -Path "docs\src\operations\v0.17.0-readiness.md" -Pattern "schema-v2-ready" -Description "v0.17 active readiness boundary"
