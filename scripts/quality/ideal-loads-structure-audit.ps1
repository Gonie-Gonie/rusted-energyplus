...
Assert-Contains -Path $idealLoadsInitManagerScanTests -Pattern 'completed_manager_scan_survives_autosize_retry_and_topology_error' -Description "manager-sweep downstream-error prefix regression"
