...
Assert-LineLimit -Path $idealLoadsInitState -Limit 180 -Description "IdealLoads persistent initialization state"
Assert-LineLimit -Path $idealLoadsInitTransition -Limit 500 -Description "IdealLoads initialization transitions"
Assert-LineLimit -Path $idealLoadsInitTests -Limit 260 -Description "IdealLoads initialization tests"
Assert-LineLimit -Path $idealLoadsInitWarningTests -Limit 100 -Description "IdealLoads initialization warning tests"
Assert-LineLimit -Path $idealLoadsCouplingValidation -Limit 180 -Description "IdealLoads release coupling validation"
...
Assert-Contains -Path $idealLoadsInitTransition -Pattern 'UnsupportedDeclaredSystemCount' -Description "bounded single-unit init guard"
Assert-Contains -Path $idealLoadsInitTransition -Pattern 'AutosizingNotImplemented' -Description "SizePurchasedAir autosize guard"
