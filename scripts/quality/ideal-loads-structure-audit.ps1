...
Assert-LineLimit -Path $calcRoot -Limit 99 -Description "IdealLoads calc module root"
...
Assert-LineLimit -Path $idealLoadsInitWitnesses -Limit 272 -Description "IdealLoads private calculation witness accessors"
...
. (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp412-cooling-post-saturation-capacity-limit-dehumidification-supply-humidity-ratio-saturation-assignment.ps1")
...
. (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp424-cooling-supply-mass-flow-positive-guard-else-branch-entry.ps1"); . (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp425-cooling-zero-supply-mass-flow-supply-enthalpy-mixed-air-assignment.ps1"); . (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp426-cooling-zero-supply-mass-flow-supply-humidity-ratio-mixed-air-assignment.ps1"); . (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp427-cooling-zero-supply-mass-flow-supply-temperature-mixed-air-assignment.ps1"); . (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp428-cooling-zero-supply-mass-flow-sensible-output-positive-zero-assignment.ps1"); . (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp429-cooling-zero-supply-mass-flow-total-output-positive-zero-assignment.ps1"); . (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp430-heating-or-no-load-case-entry.ps1"); . (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp431-heating-mode-guard.ps1"); . (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp432-heating-operating-mode-heat-assignment.ps1"); . (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp433-heating-mode-guard-else-branch-entry.ps1"); . (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp434-heating-operating-mode-deadband-assignment.ps1"); . (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp435-heating-outdoor-air-maximum-flow-guard.ps1"); . (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp436-heating-outdoor-air-maximum-flow-body-volume-flow-assignment.ps1"); . (Join-Path $PSScriptRoot "ideal-loads-structure-audit\cp437-heating-outdoor-air-maximum-flow-first-warning-guard.ps1")
