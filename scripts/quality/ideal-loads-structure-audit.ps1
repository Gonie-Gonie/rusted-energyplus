...
Assert-LineLimit -Path $calcHumidity -Limit 300 -Description "IdealLoads calc humidity module"
Assert-LineLimit -Path $calcLimits -Limit 300 -Description "IdealLoads calc limits module"
Assert-LineLimit -Path $calcMassFlow -Limit 300 -Description "IdealLoads calc mass-flow module"
...
Assert-LineLimit -Path $calcTypes -Limit 300 -Description "IdealLoads calc shared types module"
