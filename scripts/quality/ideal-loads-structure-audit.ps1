...
Assert-Contains -Path $output -Pattern 'pub struct ResultStore' -Description "runtime result store"
Assert-Contains -Path $output -Pattern 'pub fn diagnostics\s*\(&self\)\s*->\s*RuntimeDiagnosticStore' -Description "ResultStore duplicate diagnostics"
Assert-Contains -Path $output -Pattern 'pub fn profile\s*\(&self\)\s*->\s*ResultStoreProfile' -Description "ResultStore profile snapshot"
Assert-Contains -Path $output -Pattern 'pub struct ResultStoreProfile' -Description "ResultStore profile type"
Assert-Contains -Path $output -Pattern 'RuntimeDiagnosticCode::DuplicateOutputHandle' -Description "duplicate output handle diagnostic"
Assert-Contains -Path $output -Pattern 'RuntimeDiagnosticCode::DuplicateOutputSeries' -Description "duplicate output series diagnostic"
...
Assert-Contains -Path $runtime -Pattern 'runtime_output_registry_diagnoses_unavailable_system_node_output' -Description "system-node unavailable output registry test"
Assert-Contains -Path $runtime -Pattern 'result_store_diagnostics_report_duplicate_system_node_handles' -Description "system-node duplicate result-store handle test"
