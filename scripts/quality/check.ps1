...
Invoke-DevCommand -Command "compare-calendar-schedule-hourly-exact"
Invoke-DevCommand -Command "compare-weather-effective-calendar"
Invoke-DevCommand -Command "compare-calendar-dst-fixed-date-exact"
Invoke-DevCommand -Command "compare-calendar-special-day-fixed-date-exact"
Invoke-DevCommand -Command "compare-calendar-epw-holiday-policy-exact"
Invoke-DevCommand -Command "compare-calendar-weekend-holiday-policy-exact"
Invoke-DevCommand -Command "compare-calendar-weekend-saturday-policy-exact"
Invoke-DevCommand -Command "compare-calendar-special-day-weekday-rules-exact"
Invoke-DevCommand -Command "compare-calendar-special-day-nonexistent-nth-error"
Invoke-DevCommand -Command "compare-calendar-special-day-duration-wrap-exact"
Invoke-DevCommand -Command "compare-calendar-special-day-overlap-order-exact"
Invoke-DevCommand -Command "compare-calendar-special-day-epw-idf-precedence-exact"
Invoke-DevCommand -Command "compare-weather-record-selection"
