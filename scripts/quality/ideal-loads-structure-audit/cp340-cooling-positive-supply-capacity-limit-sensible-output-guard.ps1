...
Assert-Contains -Path $cp340PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp343_lifecycle_evidence' -Description "non-direct CP340/CP341/CP342/CP343 evidence rejection"
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 281' -Description "CP340 cumulative inventory total through CP343"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| executable script records \| 281 \|' -Description "CP340 generated script count through CP343"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| internal scripts \| 41 \|' -Description "CP340 generated internal script count through CP343"
