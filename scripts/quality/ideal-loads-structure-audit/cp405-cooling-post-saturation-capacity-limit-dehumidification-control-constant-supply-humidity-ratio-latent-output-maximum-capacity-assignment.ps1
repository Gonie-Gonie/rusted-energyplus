...
) -Description "CP404-to-CP405-to-CP406-to-CP407-to-CP408-to-CP412-to-numerical binding order"
...
foreach ($pattern in @('\$cp405Call\s*=', '\$cp409Call\s*=', 'CP404-to-CP405', 'CP408-to-CP409', 'CP412-to-numerical')) {
