...
) -Description "CP404-to-CP405-to-CP406-to-CP407-to-CP408-to-numerical binding order"
...
foreach ($pattern in @('\$cp405Call\s*=', 'CP404-to-CP405', 'CP408-to-numerical')) {
...
if ([regex]::Matches($inventory, '(?m)^classification = "public"$').Count -ne 240 -or
    ...
    throw "CP405 inventory classification drift; expected 240 public and 106 internal"
}
