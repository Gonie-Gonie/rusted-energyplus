...
$nonDirectTest = Get-Cp386BraceBlock `
    -Text $pipelineText `
    -AnchorPattern 'fn\s+non_direct_runtime_rejects_cp316_through_cp397_lifecycle_evidence\s*\(' `
...
throw "CP386 inventory must be exactly 240 public and 95 internal scripts"
}
