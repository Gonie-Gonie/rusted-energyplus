...
Assert-Contains -Path $cp335PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp352_lifecycle_evidence' -Description "non-direct CP335 through CP352 evidence rejection"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| executable script records \| 290 \|' -Description "CP335 cumulative generated script count through CP352"
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| internal scripts \| 50 \|' -Description "CP335 cumulative generated internal script count through CP352"
