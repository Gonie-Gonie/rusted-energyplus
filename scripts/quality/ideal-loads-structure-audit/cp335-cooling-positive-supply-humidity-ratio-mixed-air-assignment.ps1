...
# Binding order is exact CP334 -> CP335 -> CP336 -> CP337 -> unchanged numerical DTO.
...
if (
    ...
    $numericalBindingIndexForCp335 -le $cp337BindingIndexForCp335
) {
    throw "Binding must retain exact CP334 -> CP335 -> CP336 -> CP337 -> numerical Calc order"
}
...
if (
    ...
    -not $cp337BindingCallForCp335.Success
) {
    throw "Binding must retain complete CP334, CP335, CP336, and CP337 exact release calls"
}
...
if (
    ...
    $numericalBindingIndexForCp335 -lt $cp337BindingCallEndForCp335
) {
    throw "CP334, CP335, CP336, and CP337 exact release calls must complete in source order before numerical Calc"
}
...
Assert-Contains -Path $cp335PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp337_lifecycle_evidence' -Description "non-direct CP335 through CP337 evidence rejection"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| executable script records \| 275 \|' -Description "CP335 cumulative generated script count through CP337"
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| internal scripts \| 35 \|' -Description "CP335 cumulative generated internal script count through CP337"
