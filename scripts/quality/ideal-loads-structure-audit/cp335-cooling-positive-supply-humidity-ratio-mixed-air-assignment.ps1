...
Assert-Contains -Path $cp335PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp415_lifecycle_evidence' -Description "non-direct CP335 through CP363 evidence rejection"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 353 \|' -Description "CP335 cumulative generated script count through CP403"
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 113 \|' -Description "CP335 cumulative generated internal script count through CP403"
