...
Assert-Contains -Path $cp338PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp411_lifecycle_evidence' -Description "non-direct CP338 through CP363 evidence rejection"
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 349' -Description "CP338 cumulative inventory total through CP403"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 349 \|' -Description "CP338 generated script count through CP403"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 109 \|' -Description "CP338 generated internal script count through CP403"
