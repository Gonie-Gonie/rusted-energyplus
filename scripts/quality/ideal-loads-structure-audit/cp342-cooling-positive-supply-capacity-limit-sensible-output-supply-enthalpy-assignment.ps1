...
Assert-Contains -Path $cp342PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp374_lifecycle_evidence' -Description "non-direct CP342 through CP363 evidence rejection"
...
foreach ($cp342HistoricalFirewallAudit in @(
    ...
    Assert-Contains -Path $cp342HistoricalFirewallAudit -Pattern 'non_direct_runtime_rejects_cp316_through_cp374_lifecycle_evidence' -Description "historical non-direct firewall reaches CP362"
}
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 312' -Description "CP342 cumulative inventory total through CP358"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| executable script records \| 312 \|' -Description "CP342 generated script count through CP358"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| internal scripts \| 72 \|' -Description "CP342 generated internal script count through CP358"
