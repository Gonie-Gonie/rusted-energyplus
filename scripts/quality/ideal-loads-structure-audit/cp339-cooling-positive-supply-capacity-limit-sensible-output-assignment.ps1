...
Assert-Contains -Path $cp339PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp344_lifecycle_evidence' -Description "non-direct CP339 through CP344 evidence rejection"
...
# script: 282 executable records, 240 public, 42 internal, and zero uncalled.
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 282' -Description "CP339 cumulative inventory total through CP344"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| executable script records \| 282 \|' -Description "CP339 generated script count through CP344"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| internal scripts \| 42 \|' -Description "CP339 generated internal script count through CP344"
