...
Assert-LineLimit -Path $cp339CalcRoot -Limit 95 -Description "IdealLoads calc root"
...
Assert-Contains -Path $cp339PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp416_lifecycle_evidence' -Description "non-direct CP339 through CP363 evidence rejection"
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 354' -Description "CP339 cumulative inventory total through CP403"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 354 \|' -Description "CP339 generated script count through CP403"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 114 \|' -Description "CP339 generated internal script count through CP403"
