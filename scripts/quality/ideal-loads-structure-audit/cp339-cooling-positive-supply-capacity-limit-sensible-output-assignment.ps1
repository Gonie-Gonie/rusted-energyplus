...
Assert-Contains -Path $cp339PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp349_lifecycle_evidence' -Description "non-direct CP339 through CP349 evidence rejection"
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 287' -Description "CP339 cumulative inventory total through CP349"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| executable script records \| 287 \|' -Description "CP339 generated script count through CP349"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| internal scripts \| 47 \|' -Description "CP339 generated internal script count through CP349"
