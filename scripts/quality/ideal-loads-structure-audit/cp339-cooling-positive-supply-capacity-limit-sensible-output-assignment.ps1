...
Assert-Contains -Path $cp339PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp412_lifecycle_evidence' -Description "non-direct CP339 through CP363 evidence rejection"
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 350' -Description "CP339 cumulative inventory total through CP403"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 350 \|' -Description "CP339 generated script count through CP403"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 110 \|' -Description "CP339 generated internal script count through CP403"
