...
Assert-Contains -Path $cp339PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp341_lifecycle_evidence' -Description "non-direct CP339 through CP341 evidence rejection"
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 279' -Description "CP339 cumulative inventory total through CP341"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| executable script records \| 279 \|' -Description "CP339 generated script count through CP341"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| internal scripts \| 39 \|' -Description "CP339 generated internal script count through CP341"
