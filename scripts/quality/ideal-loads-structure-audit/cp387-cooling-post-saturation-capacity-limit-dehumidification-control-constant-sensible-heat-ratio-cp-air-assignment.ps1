...
$nonDirectTest = Get-Cp387BraceBlock -Text $pipelineText -AnchorPattern 'fn\s+non_direct_runtime_rejects_cp316_through_cp404_lifecycle_evidence\s*\(' -Description "cumulative non-direct regression"
...
throw "CP387 inventory must be exactly 240 public and 102 internal scripts"
}
