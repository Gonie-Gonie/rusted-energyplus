...
Assert-Contains -Path $prefix -Pattern 'cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_cp_air_assignment_committed_latest_snapshot_is_consistent\s*\(' -Description "bounded CP387 committed predecessor proof"
Assert-NotContains -Path $prefix -Pattern 'completed_direct_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_cp_air_assignment_is_consistent\s*\(' -Description "recursive CP387 predecessor completion"
...
$nonDirectTest = Get-Cp388BraceBlock -Text $pipelineText -AnchorPattern 'fn\s+non_direct_runtime_rejects_cp316_through_cp440_lifecycle_evidence\s*\(' -Description "cumulative non-direct regression"
...
throw "CP388 inventory must be exactly 240 public and 136 internal scripts"
}
