...
$nonDirectTest = Get-Cp388BraceBlock -Text $pipelineText -AnchorPattern 'fn\s+non_direct_runtime_rejects_cp316_through_cp434_lifecycle_evidence\s*\(' -Description "cumulative non-direct regression"
