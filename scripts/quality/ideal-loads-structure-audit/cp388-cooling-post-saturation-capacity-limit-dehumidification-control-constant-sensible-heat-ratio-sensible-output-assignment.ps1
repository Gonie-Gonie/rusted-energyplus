...
$nonDirectTest = Get-Cp388BraceBlock -Text $pipelineText -AnchorPattern 'fn\s+non_direct_runtime_rejects_cp316_through_cp407_lifecycle_evidence\s*\(' -Description "cumulative non-direct regression"
...
throw "CP388 inventory must be exactly 240 public and 105 internal scripts"
}
