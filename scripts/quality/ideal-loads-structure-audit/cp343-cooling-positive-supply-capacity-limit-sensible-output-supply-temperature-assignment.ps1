...
Assert-Contains -Path $cp343PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp368_lifecycle_evidence' -Description "non-direct CP343 through CP363 evidence rejection"
...
foreach ($cp343HistoricalFirewallAudit in @(
    ...
    Assert-Contains -Path $cp343HistoricalFirewallAudit -Pattern 'non_direct_runtime_rejects_cp316_through_cp368_lifecycle_evidence' -Description "historical non-direct firewall reaches CP362"
}
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 306' -Description "CP343 cumulative inventory total through CP358"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| executable script records \| 306 \|' -Description "CP343 generated script count through CP358"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| internal scripts \| 66 \|' -Description "CP343 generated internal script count through CP358"
