...
Assert-PatternsInOrder -Path $binding -Patterns @(
    ...
    'let\s+coupling\s*='
) -Description "CP398-to-CP399-to-CP400-to-CP401-to-CP402-to-CP403-to-CP404-to-CP405-to-CP406-to-CP407 binding order"
...
if ([regex]::Matches($inventory, '(?m)^classification = "public"$').Count -ne 240 -or
    ...
    throw "CP399 inventory classification drift; expected 240 public and 105 internal"
}
