...
if (
    ...
    $cp376BindingIndexForCp360 -le $cp375BindingIndexForCp360 -or $cp377BindingIndexForCp360 -le $cp376BindingIndexForCp360 -or $cp378BindingIndexForCp360 -le $cp377BindingIndexForCp360 -or $cp379BindingIndexForCp360 -le $cp378BindingIndexForCp360 -or $cp360NumericalIndex -le $cp379BindingIndexForCp360) {
...
Assert-Contains -Path $cp360PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp379_lifecycle_evidence' -Description "cumulative non-direct firewall"
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 317' -Description "CP360 script total"
