...
Assert-Contains -Path $cp346PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp411_lifecycle_evidence' -Description "pipeline cumulative non-direct firewall"
...
foreach ($historical in @(
    ...
    Assert-Contains `
        -Path "scripts\quality\ideal-loads-structure-audit\$historical" `
        -Pattern 'non_direct_runtime_rejects_cp316_through_cp411_lifecycle_evidence' `
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 349' -Description "CP346 script inventory total"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 349 \|' -Description "generated CP346 script total"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 109 \|' -Description "generated internal script total"
