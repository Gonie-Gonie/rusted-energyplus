...
Assert-Contains -Path $cp346PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp410_lifecycle_evidence' -Description "pipeline cumulative non-direct firewall"
...
foreach ($historical in @(
    ...
    Assert-Contains `
        -Path "scripts\quality\ideal-loads-structure-audit\$historical" `
        -Pattern 'non_direct_runtime_rejects_cp316_through_cp410_lifecycle_evidence' `
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 348' -Description "CP346 script inventory total"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 348 \|' -Description "generated CP346 script total"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 108 \|' -Description "generated internal script total"
