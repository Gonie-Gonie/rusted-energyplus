...
Assert-Contains -Path $cp336PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp354_lifecycle_evidence' -Description "non-direct CP336 through CP354 evidence rejection"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| executable script records \| 292 \|' -Description "CP336 cumulative generated script count through CP354"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| internal scripts \| 52 \|' -Description "CP336 cumulative generated internal script count through CP354"
