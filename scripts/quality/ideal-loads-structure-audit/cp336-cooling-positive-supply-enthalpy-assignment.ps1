...
Assert-Contains -Path $cp336PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp401_lifecycle_evidence' -Description "non-direct CP336 through CP363 evidence rejection"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| executable script records \| 339 \|' -Description "CP336 cumulative generated script count through CP401"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| internal scripts \| 99 \|' -Description "CP336 cumulative generated internal script count through CP401"
