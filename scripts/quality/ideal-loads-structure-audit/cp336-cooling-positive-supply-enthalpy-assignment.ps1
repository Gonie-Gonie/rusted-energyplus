...
Assert-Contains -Path $cp336PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp414_lifecycle_evidence' -Description "non-direct CP336 through CP363 evidence rejection"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 352 \|' -Description "CP336 cumulative generated script count through CP403"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 112 \|' -Description "CP336 cumulative generated internal script count through CP403"
