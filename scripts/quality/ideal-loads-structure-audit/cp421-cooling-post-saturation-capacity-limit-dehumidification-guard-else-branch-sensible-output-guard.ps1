...
Assert-Contains -Path $adapterTests -Pattern 'cp421_is_preserved_before_cp422_in_the_current_120_snapshot_binding' -Description 'current 120-snapshot binding regression'
