...
Assert-Contains -Path $adapterTests -Pattern 'cp421_is_preserved_before_cp422_in_the_current_125_snapshot_binding' -Description 'current 123-snapshot binding regression'
