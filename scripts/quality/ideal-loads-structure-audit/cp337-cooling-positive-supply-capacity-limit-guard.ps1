...
Assert-Contains -Path $cp337PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp345_lifecycle_evidence' -Description "non-direct CP337 through CP345 evidence rejection"
...
# Generated script totals are 283 executable, 240 public, 43 internal, and zero
# uncalled.
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 283' -Description "CP337 cumulative inventory total through CP345"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| executable script records \| 283 \|' -Description "CP337 cumulative generated script count through CP345"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| internal scripts \| 43 \|' -Description "CP337 cumulative generated internal script count through CP345"
