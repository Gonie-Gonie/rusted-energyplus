...
Assert-Contains -Path $cp337PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp340_lifecycle_evidence' -Description "non-direct CP337 through CP340 evidence rejection"
...
# Generated script totals are 278 executable, 240 public, 38 internal, and zero
# uncalled.
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 278' -Description "CP337 cumulative inventory total through CP340"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| executable script records \| 278 \|' -Description "CP337 cumulative generated script count through CP340"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| internal scripts \| 38 \|' -Description "CP337 cumulative generated internal script count through CP340"
