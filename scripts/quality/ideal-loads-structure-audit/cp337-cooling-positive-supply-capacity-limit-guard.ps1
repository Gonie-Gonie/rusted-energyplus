...
Assert-Contains -Path $cp337PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp348_lifecycle_evidence' -Description "non-direct CP337 through CP348 evidence rejection"
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 286' -Description "CP337 cumulative inventory total through CP348"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| executable script records \| 286 \|' -Description "CP337 cumulative generated script count through CP348"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| internal scripts \| 46 \|' -Description "CP337 cumulative generated internal script count through CP348"
