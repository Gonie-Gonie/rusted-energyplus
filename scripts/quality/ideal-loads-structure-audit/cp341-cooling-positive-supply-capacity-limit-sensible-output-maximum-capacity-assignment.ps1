...
Assert-Contains -Path $cp341PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp341_lifecycle_evidence' -Description "non-direct CP341 evidence rejection"
...
# 279 executable records, 240 public, 39 internal, and zero uncalled.
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 279' -Description "CP341 cumulative inventory total"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| executable script records \| 279 \|' -Description "CP341 generated script count"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| internal scripts \| 39 \|' -Description "CP341 generated internal script count"
