...
function Assert-Cp345BindingContract {
    ...
    if ((
        ...
        -not $cp422Call.Success -or -not $cp423Call.Success -or -not $cp424Call.Success -or -not $cp425Call.Success -or -not $numerical.Success -or
        ...
        ) -or $cp422Call.Index -lt ($cp421Call.Index + $cp421Call.Length) -or $cp423Call.Index -lt ($cp422Call.Index + $cp422Call.Length) -or $cp424Call.Index -lt ($cp423Call.Index + $cp423Call.Length) -or $cp425Call.Index -lt ($cp424Call.Index + $cp424Call.Length) -or $numerical.Index -lt ($cp425Call.Index + $cp425Call.Length)) {
...
Assert-Contains -Path $cp345PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp425_lifecycle_evidence' -Description "pipeline cumulative non-direct CP362 firewall regression"
...
foreach ($audit in @(
    ...
    Assert-Contains -Path $audit -Pattern 'non_direct_runtime_rejects_cp316_through_cp425_lifecycle_evidence' -Description "historical non-direct firewall reaches CP362"
}
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 363' -Description "CP345 cumulative inventory total through CP403"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 363 \|' -Description "CP346 generated script total through CP403"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 123 \|' -Description "CP346 generated internal script total through CP403"
