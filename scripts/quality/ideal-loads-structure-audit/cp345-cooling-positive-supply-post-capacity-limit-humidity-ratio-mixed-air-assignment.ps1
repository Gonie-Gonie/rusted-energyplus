...
function Assert-Cp345BindingContract {
    ...
    if ((
        ...
        -not $cp422Call.Success -or -not $cp423Call.Success -or -not $cp424Call.Success -or -not $cp425Call.Success -or -not $cp426Call.Success -or -not $cp427Call.Success -or -not $cp428Call.Success -or -not $cp429Call.Success -or -not $cp430Call.Success -or -not $numerical.Success -or
...
Assert-Contains -Path $cp345PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp430_lifecycle_evidence' -Description "pipeline cumulative non-direct CP362 firewall regression"
...
foreach ($audit in @(
    ...
    Assert-Contains -Path $audit -Pattern 'non_direct_runtime_rejects_cp316_through_cp430_lifecycle_evidence' -Description "historical non-direct firewall reaches CP362"
}
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 368' -Description "CP345 cumulative inventory total through CP403"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 368 \|' -Description "CP346 generated script total through CP403"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 128 \|' -Description "CP346 generated internal script total through CP403"
