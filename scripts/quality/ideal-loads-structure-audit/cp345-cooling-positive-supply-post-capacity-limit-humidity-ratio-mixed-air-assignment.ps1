...
$cp345SourceStatementPattern = 'PurchAir\.SupplyHumRat\s*=\s*PurchAir\.MixedAirHumRat\s*;'
...
function Assert-Cp345BindingContract {
    ...
    $cp376Call = [regex]::Match($body, '(?s)let calculation_cooling_supply_humidity_ratio_pre_saturation_original_assignment =\s*advance_cooling_supply_humidity_ratio_pre_saturation_original_assignment\([^;]+?\)\?;'); $cp377Call = [regex]::Match($body, '(?s)let calculation_cooling_supply_humidity_ratio_saturation_assignment =\s*advance_cooling_supply_humidity_ratio_saturation_assignment\([^;]+?\)\?;'); $cp378Call = [regex]::Match($body, '(?s)let calculation_cooling_supply_humidity_ratio_saturation_limit_assignment =\s*advance_cooling_supply_humidity_ratio_saturation_limit_assignment\([^;]+?\)\?;'); $cp379Call = [regex]::Match($body, '(?s)let calculation_cooling_supply_enthalpy_post_saturation_assignment =\s*advance_cooling_supply_enthalpy_post_saturation_assignment\([^;]+?\)\?;'); $cp380Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_guard =\s*advance_cooling_post_saturation_capacity_limit_guard\([^;]+?\)\?;'); $cp381Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_guard =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_guard\([^;]+?\)\?;'); $cp382Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_total_output_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_total_output_assignment\([^;]+?\)\?;'); $cp383Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_total_output_guard =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_total_output_guard\([^;]+?\)\?;'); $cp384Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_total_output_maximum_capacity_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_total_output_maximum_capacity_assignment\([^;]+?\)\?;'); $cp385Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_total_output_supply_enthalpy_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_total_output_supply_enthalpy_assignment\([^;]+?\)\?;'); $cp386Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_switch =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_switch\([^;]+?\)\?;'); $cp387Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_cp_air_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_cp_air_assignment\([^;]+?\)\?;'); $cp388Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_sensible_output_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_sensible_output_assignment\([^;]+?\)\?;'); $cp389Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_assignment\([^;]+?\)\?;'); $cp390Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_mixed_air_limit =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_temperature_mixed_air_limit\([^;]+?\)\?;')
    $cp391Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_overdrying_limit\([^;]+?\)\?;'); $cp392Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_supply_humidity_ratio_assignment\([^;]+?\)\?;'); $cp393Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_case_break =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_sensible_heat_ratio_case_break\([^;]+?\)\?;'); $cp394Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_entry =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_entry\([^;]+?\)\?;'); $cp395Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_supply_humidity_ratio_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_supply_humidity_ratio_assignment\([^;]+?\)\?;'); $cp396Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_break =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_humidistat_case_break\([^;]+?\)\?;'); $cp397Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_none_case_entry =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_none_case_entry\([^;]+?\)\?;'); $cp398Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_case_entry =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_case_entry\([^;]+?\)\?;'); $cp399Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_cp_air_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_cp_air_assignment\([^;]+?\)\?;'); $cp400Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_sensible_output_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_sensible_output_assignment\([^;]+?\)\?;')
    $cp401Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_assignment\([^;]+?\)\?;')
    $cp402Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_guard =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_guard\([^;]+?\)\?;'); $cp403Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_supply_temperature_mixed_air_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_supply_temperature_mixed_air_assignment\([^;]+?\)\?;'); $cp404Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_supply_humidity_ratio_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_supply_humidity_ratio_assignment\([^;]+?\)\?;'); $cp405Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_maximum_capacity_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_maximum_capacity_assignment\([^;]+?\)\?;'); $cp406Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_capacity_guard_else_branch_entry =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_capacity_guard_else_branch_entry\([^;]+?\)\?;'); $cp407Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_supply_temperature_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_supply_temperature_assignment\([^;]+?\)\?;')
    $cp408Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_supply_temperature_mixed_air_limit =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_latent_output_supply_temperature_mixed_air_limit\([^;]+?\)\?;'); $cp409Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_case_break =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_constant_supply_humidity_ratio_case_break\([^;]+?\)\?;'); $cp410Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_control_default_case_break =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_control_default_case_break\([^;]+?\)\?;'); $cp411Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_supply_humidity_ratio_pre_saturation_original_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_supply_humidity_ratio_pre_saturation_original_assignment\([^;]+?\)\?;'); $cp412Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_supply_humidity_ratio_saturation_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_supply_humidity_ratio_saturation_assignment\([^;]+?\)\?;'); $cp413Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_supply_humidity_ratio_saturation_guard =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_supply_humidity_ratio_saturation_guard\([^;]+?\)\?;'); $cp414Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_supply_temperature_saturation_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_supply_temperature_saturation_assignment\([^;]+?\)\?;'); $cp415Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_supply_temperature_saturation_mixed_air_limit =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_supply_temperature_saturation_mixed_air_limit\([^;]+?\)\?;'); $cp416Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_supply_humidity_ratio_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_supply_humidity_ratio_assignment\([^;]+?\)\?;'); $cp417Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_supply_enthalpy_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_supply_enthalpy_assignment\([^;]+?\)\?;'); $cp418Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_guard_else_branch_entry =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_guard_else_branch_entry\([^;]+?\)\?;'); $cp419Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_guard_else_branch_cp_air_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_guard_else_branch_cp_air_assignment\([^;]+?\)\?;'); $cp420Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_guard_else_branch_sensible_output_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_guard_else_branch_sensible_output_assignment\([^;]+?\)\?;'); $cp421Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_guard_else_branch_sensible_output_guard =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_guard_else_branch_sensible_output_guard\([^;]+?\)\?;')
    $cp422Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_guard_else_branch_sensible_output_maximum_capacity_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_guard_else_branch_sensible_output_maximum_capacity_assignment\([^;]+?\)\?;'); $cp423Call = [regex]::Match($body, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_guard_else_branch_sensible_output_supply_temperature_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_guard_else_branch_sensible_output_supply_temperature_assignment\([^;]+?\)\?;'); $cp424Call = [regex]::Match($body, '(?s)let calculation_cooling_supply_mass_flow_positive_guard_else_branch_entry =\s*advance_cooling_supply_mass_flow_positive_guard_else_branch_entry\([^;]+?\)\?;'); $cp425Call = [regex]::Match($body, '(?s)let calculation_cooling_zero_supply_mass_flow_supply_enthalpy_mixed_air_assignment =\s*advance_cooling_zero_supply_mass_flow_supply_enthalpy_mixed_air_assignment\([^;]+?\)\?;'); $cp426Call = [regex]::Match($body, '(?s)let calculation_cooling_zero_supply_mass_flow_supply_humidity_ratio_mixed_air_assignment =\s*advance_cooling_zero_supply_mass_flow_supply_humidity_ratio_mixed_air_assignment\([^;]+?\)\?;'); $cp427Call = [regex]::Match($body, '(?s)let calculation_cooling_zero_supply_mass_flow_supply_temperature_mixed_air_assignment =\s*advance_cooling_zero_supply_mass_flow_supply_temperature_mixed_air_assignment\([^;]+?\)\?;'); $cp428Call = [regex]::Match($body, '(?s)let calculation_cooling_zero_supply_mass_flow_sensible_output_positive_zero_assignment =\s*advance_cooling_zero_supply_mass_flow_sensible_output_positive_zero_assignment\([^;]+?\)\?;'); $cp429Call = [regex]::Match($body, '(?s)let calculation_cooling_zero_supply_mass_flow_total_output_positive_zero_assignment =\s*advance_cooling_zero_supply_mass_flow_total_output_positive_zero_assignment\([^;]+?\)\?;'); $cp430Call = [regex]::Match($body, '(?s)let calculation_heating_or_no_load_case_entry =\s*advance_heating_or_no_load_case_entry\([^;]+?\)\?;'); $cp431Call = [regex]::Match($body, '(?s)let calculation_heating_mode_guard =\s*advance_heating_mode_guard\([^;]+?\)\?;'); $cp432Call = [regex]::Match($body, '(?s)let calculation_heating_operating_mode_heat_assignment =\s*advance_heating_operating_mode_heat_assignment\([^;]+?\)\?;'); $cp433Call = [regex]::Match($body, '(?s)let calculation_heating_mode_guard_else_branch_entry =\s*advance_heating_mode_guard_else_branch_entry\([^;]+?\)\?;'); $cp434Call = [regex]::Match($body, '(?s)let calculation_heating_operating_mode_deadband_assignment =\s*advance_heating_operating_mode_deadband_assignment\([^;]+?\)\?;'); $cp435Call = [regex]::Match($body, '(?s)let calculation_heating_outdoor_air_maximum_flow_guard =\s*advance_heating_outdoor_air_maximum_flow_guard\([^;]+?\)\?;'); $cp436Call = [regex]::Match($body, '(?s)let calculation_heating_outdoor_air_maximum_flow_body_volume_flow_assignment =\s*advance_heating_outdoor_air_maximum_flow_body_volume_flow_assignment\([^;]+?\)\?;'); $cp437Call = [regex]::Match($body, '(?s)let calculation_heating_outdoor_air_maximum_flow_first_warning_guard =\s*advance_heating_outdoor_air_maximum_flow_first_warning_guard\([^;]+?\)\?;'); $cp438Call = [regex]::Match($body, '(?s)let calculation_heating_outdoor_air_maximum_flow_first_warning_counter_increment =\s*advance_heating_outdoor_air_maximum_flow_first_warning_counter_increment\([^;]+?\)\?;'); $cp439Call = [regex]::Match($body, '(?s)let calculation_heating_outdoor_air_maximum_flow_first_warning_call =\s*advance_heating_outdoor_air_maximum_flow_first_warning_call\([^;]+?\)\?;'); $cp440Call = [regex]::Match($body, '(?s)let calculation_heating_outdoor_air_maximum_flow_continue_warning_call =\s*advance_heating_outdoor_air_maximum_flow_continue_warning_call\([^;]+?\)\?;'); $cp441Call = [regex]::Match($body, '(?s)let calculation_heating_outdoor_air_maximum_flow_continue_warning_timestamp_call =\s*advance_heating_outdoor_air_maximum_flow_continue_warning_timestamp_call\([^;]+?\)\?;'); $numerical = [regex]::Match(
        $body,
    ...
    if ((
        ...
        -not $cp376Call.Success -or -not $cp377Call.Success -or -not $cp378Call.Success -or -not $cp379Call.Success -or -not $cp380Call.Success -or -not $cp381Call.Success -or -not $cp382Call.Success -or -not $cp383Call.Success -or -not $cp384Call.Success -or -not $cp385Call.Success -or -not $cp386Call.Success -or -not $cp387Call.Success -or -not $cp388Call.Success -or -not $cp389Call.Success -or -not $cp390Call.Success -or -not $cp391Call.Success -or -not $cp392Call.Success -or -not $cp393Call.Success -or -not $cp394Call.Success -or -not $cp395Call.Success -or -not $cp396Call.Success -or -not $cp397Call.Success -or -not $cp398Call.Success -or -not $cp399Call.Success -or -not $cp400Call.Success -or -not $cp401Call.Success -or -not $cp402Call.Success -or -not $cp403Call.Success -or -not $cp404Call.Success -or -not $cp405Call.Success -or -not $cp406Call.Success -or -not $cp407Call.Success -or -not $cp408Call.Success -or -not $cp409Call.Success -or -not $cp410Call.Success -or -not $cp411Call.Success -or -not $cp412Call.Success -or -not $cp413Call.Success -or -not $cp414Call.Success -or -not $cp415Call.Success -or -not $cp416Call.Success -or -not $cp417Call.Success -or -not $cp418Call.Success -or -not $cp419Call.Success -or -not $cp420Call.Success -or -not $cp421Call.Success -or
        -not $cp422Call.Success -or -not $cp423Call.Success -or -not $cp424Call.Success -or -not $cp425Call.Success -or -not $cp426Call.Success -or -not $cp427Call.Success -or -not $cp428Call.Success -or -not $cp429Call.Success -or -not $cp430Call.Success -or -not $cp431Call.Success -or -not $cp432Call.Success -or -not $cp433Call.Success -or -not $cp434Call.Success -or -not $cp435Call.Success -or -not $cp436Call.Success -or -not $cp437Call.Success -or -not $cp438Call.Success -or -not $cp439Call.Success -or -not $cp440Call.Success -or -not $cp441Call.Success -or -not $numerical.Success -or
        ...
        $cp376Call.Index -lt ($cp375Call.Index + $cp375Call.Length) -or $cp377Call.Index -lt ($cp376Call.Index + $cp376Call.Length) -or $cp378Call.Index -lt ($cp377Call.Index + $cp377Call.Length) -or $cp379Call.Index -lt ($cp378Call.Index + $cp378Call.Length) -or $cp380Call.Index -lt ($cp379Call.Index + $cp379Call.Length) -or $cp381Call.Index -lt ($cp380Call.Index + $cp380Call.Length) -or $cp382Call.Index -lt ($cp381Call.Index + $cp381Call.Length) -or $cp383Call.Index -lt ($cp382Call.Index + $cp382Call.Length) -or $cp384Call.Index -lt ($cp383Call.Index + $cp383Call.Length) -or $cp385Call.Index -lt ($cp384Call.Index + $cp384Call.Length) -or $cp386Call.Index -lt ($cp385Call.Index + $cp385Call.Length) -or $cp387Call.Index -lt ($cp386Call.Index + $cp386Call.Length) -or $cp388Call.Index -lt ($cp387Call.Index + $cp387Call.Length) -or $cp389Call.Index -lt ($cp388Call.Index + $cp388Call.Length) -or $cp390Call.Index -lt ($cp389Call.Index + $cp389Call.Length) -or $cp391Call.Index -lt ($cp390Call.Index + $cp390Call.Length) -or $cp392Call.Index -lt ($cp391Call.Index + $cp391Call.Length) -or $cp393Call.Index -lt ($cp392Call.Index + $cp392Call.Length) -or $cp394Call.Index -lt ($cp393Call.Index + $cp393Call.Length) -or $cp395Call.Index -lt ($cp394Call.Index + $cp394Call.Length) -or $cp396Call.Index -lt ($cp395Call.Index + $cp395Call.Length) -or $cp397Call.Index -lt ($cp396Call.Index + $cp396Call.Length) -or $cp398Call.Index -lt ($cp397Call.Index + $cp397Call.Length) -or $cp399Call.Index -lt ($cp398Call.Index + $cp398Call.Length) -or $cp400Call.Index -lt ($cp399Call.Index + $cp399Call.Length) -or $cp401Call.Index -lt ($cp400Call.Index + $cp400Call.Length) -or $cp402Call.Index -lt ($cp401Call.Index + $cp401Call.Length) -or $cp403Call.Index -lt ($cp402Call.Index + $cp402Call.Length) -or $cp404Call.Index -lt ($cp403Call.Index + $cp403Call.Length) -or $cp405Call.Index -lt ($cp404Call.Index + $cp404Call.Length) -or $cp406Call.Index -lt ($cp405Call.Index + $cp405Call.Length) -or $cp407Call.Index -lt ($cp406Call.Index + $cp406Call.Length) -or $cp408Call.Index -lt ($cp407Call.Index + $cp407Call.Length) -or $cp409Call.Index -lt ($cp408Call.Index + $cp408Call.Length) -or $cp410Call.Index -lt ($cp409Call.Index + $cp409Call.Length) -or $cp411Call.Index -lt ($cp410Call.Index + $cp410Call.Length) -or $cp412Call.Index -lt ($cp411Call.Index + $cp411Call.Length) -or $cp413Call.Index -lt ($cp412Call.Index + $cp412Call.Length) -or $cp414Call.Index -lt ($cp413Call.Index + $cp413Call.Length) -or $cp415Call.Index -lt ($cp414Call.Index + $cp414Call.Length) -or $cp416Call.Index -lt ($cp415Call.Index + $cp415Call.Length) -or $cp417Call.Index -lt ($cp416Call.Index + $cp416Call.Length) -or $cp418Call.Index -lt ($cp417Call.Index + $cp417Call.Length) -or $cp419Call.Index -lt ($cp418Call.Index + $cp418Call.Length) -or $cp420Call.Index -lt ($cp419Call.Index + $cp419Call.Length) -or $cp421Call.Index -lt ($cp420Call.Index + $cp420Call.Length) -or $numerical.Index -lt ($cp421Call.Index + $cp421Call.Length)
        ) -or $cp422Call.Index -lt ($cp421Call.Index + $cp421Call.Length) -or $cp423Call.Index -lt ($cp422Call.Index + $cp422Call.Length) -or $cp424Call.Index -lt ($cp423Call.Index + $cp423Call.Length) -or $cp425Call.Index -lt ($cp424Call.Index + $cp424Call.Length) -or $cp426Call.Index -lt ($cp425Call.Index + $cp425Call.Length) -or $cp427Call.Index -lt ($cp426Call.Index + $cp426Call.Length) -or $cp428Call.Index -lt ($cp427Call.Index + $cp427Call.Length) -or $cp429Call.Index -lt ($cp428Call.Index + $cp428Call.Length) -or $cp430Call.Index -lt ($cp429Call.Index + $cp429Call.Length) -or $cp431Call.Index -lt ($cp430Call.Index + $cp430Call.Length) -or $cp432Call.Index -lt ($cp431Call.Index + $cp431Call.Length) -or $cp433Call.Index -lt ($cp432Call.Index + $cp432Call.Length) -or $cp434Call.Index -lt ($cp433Call.Index + $cp433Call.Length) -or $cp435Call.Index -lt ($cp434Call.Index + $cp434Call.Length) -or $cp436Call.Index -lt ($cp435Call.Index + $cp435Call.Length) -or $cp437Call.Index -lt ($cp436Call.Index + $cp436Call.Length) -or $cp438Call.Index -lt ($cp437Call.Index + $cp437Call.Length) -or $cp439Call.Index -lt ($cp438Call.Index + $cp438Call.Length) -or $cp440Call.Index -lt ($cp439Call.Index + $cp439Call.Length) -or $cp441Call.Index -lt ($cp440Call.Index + $cp440Call.Length) -or $numerical.Index -lt ($cp441Call.Index + $cp441Call.Length)) {
        throw "Binding must execute CP344 through CP431 in source order before unchanged numerical coupling"
    }
    foreach ($interval in @(
            [PSCustomObject]@{
            ...
            [PSCustomObject]@{ Start = $cp376Call.Index + $cp376Call.Length; End = $cp377Call.Index; Description = "CP376-to-CP377" }, [PSCustomObject]@{ Start = $cp377Call.Index + $cp377Call.Length; End = $cp378Call.Index; Description = "CP377-to-CP378" }, [PSCustomObject]@{ Start = $cp378Call.Index + $cp378Call.Length; End = $cp379Call.Index; Description = "CP378-to-CP379" }, [PSCustomObject]@{ Start = $cp379Call.Index + $cp379Call.Length; End = $cp380Call.Index; Description = "CP379-to-CP380" }, [PSCustomObject]@{ Start = $cp380Call.Index + $cp380Call.Length; End = $cp381Call.Index; Description = "CP380-to-CP381" }, [PSCustomObject]@{ Start = $cp381Call.Index + $cp381Call.Length; End = $cp382Call.Index; Description = "CP381-to-CP382" }, [PSCustomObject]@{ Start = $cp382Call.Index + $cp382Call.Length; End = $cp383Call.Index; Description = "CP382-to-CP383" }, [PSCustomObject]@{ Start = $cp383Call.Index + $cp383Call.Length; End = $cp384Call.Index; Description = "CP383-to-CP384" }, [PSCustomObject]@{ Start = $cp384Call.Index + $cp384Call.Length; End = $cp385Call.Index; Description = "CP384-to-CP385" }, [PSCustomObject]@{ Start = $cp385Call.Index + $cp385Call.Length; End = $cp386Call.Index; Description = "CP385-to-CP386" }, [PSCustomObject]@{ Start = $cp386Call.Index + $cp386Call.Length; End = $cp387Call.Index; Description = "CP386-to-CP387" }, [PSCustomObject]@{ Start = $cp387Call.Index + $cp387Call.Length; End = $cp388Call.Index; Description = "CP387-to-CP388" }, [PSCustomObject]@{ Start = $cp388Call.Index + $cp388Call.Length; End = $cp389Call.Index; Description = "CP388-to-CP389" }, [PSCustomObject]@{ Start = $cp389Call.Index + $cp389Call.Length; End = $cp390Call.Index; Description = "CP389-to-CP390" }, [PSCustomObject]@{ Start = $cp390Call.Index + $cp390Call.Length; End = $cp391Call.Index; Description = "CP390-to-CP391" }, [PSCustomObject]@{ Start = $cp391Call.Index + $cp391Call.Length; End = $cp392Call.Index; Description = "CP391-to-CP392" }, [PSCustomObject]@{ Start = $cp392Call.Index + $cp392Call.Length; End = $cp393Call.Index; Description = "CP392-to-CP393" }, [PSCustomObject]@{ Start = $cp393Call.Index + $cp393Call.Length; End = $cp394Call.Index; Description = "CP393-to-CP394" }, [PSCustomObject]@{ Start = $cp394Call.Index + $cp394Call.Length; End = $cp395Call.Index; Description = "CP394-to-CP395" }, [PSCustomObject]@{ Start = $cp395Call.Index + $cp395Call.Length; End = $cp396Call.Index; Description = "CP395-to-CP396" }, [PSCustomObject]@{ Start = $cp396Call.Index + $cp396Call.Length; End = $cp397Call.Index; Description = "CP396-to-CP397" }, [PSCustomObject]@{ Start = $cp397Call.Index + $cp397Call.Length; End = $cp398Call.Index; Description = "CP397-to-CP398" }, [PSCustomObject]@{ Start = $cp398Call.Index + $cp398Call.Length; End = $cp399Call.Index; Description = "CP398-to-CP399" }, [PSCustomObject]@{ Start = $cp399Call.Index + $cp399Call.Length; End = $cp400Call.Index; Description = "CP399-to-CP400" }, [PSCustomObject]@{ Start = $cp400Call.Index + $cp400Call.Length; End = $cp401Call.Index; Description = "CP400-to-CP401" }, [PSCustomObject]@{ Start = $cp401Call.Index + $cp401Call.Length; End = $cp402Call.Index; Description = "CP401-to-CP402" }, [PSCustomObject]@{ Start = $cp402Call.Index + $cp402Call.Length; End = $cp403Call.Index; Description = "CP402-to-CP403" }, [PSCustomObject]@{ Start = $cp403Call.Index + $cp403Call.Length; End = $cp404Call.Index; Description = "CP403-to-CP404" }, [PSCustomObject]@{ Start = $cp404Call.Index + $cp404Call.Length; End = $cp405Call.Index; Description = "CP404-to-CP405" }, [PSCustomObject]@{ Start = $cp405Call.Index + $cp405Call.Length; End = $cp406Call.Index; Description = "CP405-to-CP406" }, [PSCustomObject]@{ Start = $cp406Call.Index + $cp406Call.Length; End = $cp407Call.Index; Description = "CP406-to-CP407" }, [PSCustomObject]@{ Start = $cp407Call.Index + $cp407Call.Length; End = $cp408Call.Index; Description = "CP407-to-CP408" }, [PSCustomObject]@{ Start = $cp408Call.Index + $cp408Call.Length; End = $cp409Call.Index; Description = "CP408-to-CP409" }, [PSCustomObject]@{ Start = $cp409Call.Index + $cp409Call.Length; End = $cp410Call.Index; Description = "CP409-to-CP410" }, [PSCustomObject]@{ Start = $cp410Call.Index + $cp410Call.Length; End = $cp411Call.Index; Description = "CP410-to-CP411" }, [PSCustomObject]@{ Start = $cp411Call.Index + $cp411Call.Length; End = $cp412Call.Index; Description = "CP411-to-CP412" }, [PSCustomObject]@{ Start = $cp412Call.Index + $cp412Call.Length; End = $cp413Call.Index; Description = "CP412-to-CP413" }, [PSCustomObject]@{ Start = $cp413Call.Index + $cp413Call.Length; End = $cp414Call.Index; Description = "CP413-to-CP414" }, [PSCustomObject]@{ Start = $cp414Call.Index + $cp414Call.Length; End = $cp415Call.Index; Description = "CP414-to-CP415" }
        )) {
        $code = $body.Substring($interval.Start, $interval.End - $interval.Start)
        $code = [regex]::Replace($code, '(?s)/\*.*?\*/|(?m)//.*$', ''); $code = [regex]::Replace($code, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_supply_temperature_saturation_mixed_air_limit =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_supply_temperature_saturation_mixed_air_limit\([^;]+?\)\?;', ''); $code = [regex]::Replace($code, '(?s)let calculation_cooling_post_saturation_capacity_limit_dehumidification_supply_humidity_ratio_assignment =\s*advance_cooling_post_saturation_capacity_limit_dehumidification_supply_humidity_ratio_assignment\([^;]+?\)\?;', '')
    ...
    foreach ($terminalInterval in @([PSCustomObject]@{ Start = $cp414Call.Index + $cp414Call.Length; End = $cp415Call.Index; Description = "CP414-to-CP415" }, [PSCustomObject]@{ Start = $cp415Call.Index + $cp415Call.Length; End = $cp416Call.Index; Description = "CP415-to-CP416" }, [PSCustomObject]@{ Start = $cp416Call.Index + $cp416Call.Length; End = $cp417Call.Index; Description = "CP416-to-CP417" }, [PSCustomObject]@{ Start = $cp417Call.Index + $cp417Call.Length; End = $cp418Call.Index; Description = "CP417-to-CP418" }, [PSCustomObject]@{ Start = $cp418Call.Index + $cp418Call.Length; End = $cp419Call.Index; Description = "CP418-to-CP419" }, [PSCustomObject]@{ Start = $cp419Call.Index + $cp419Call.Length; End = $cp420Call.Index; Description = "CP419-to-CP420" }, [PSCustomObject]@{ Start = $cp420Call.Index + $cp420Call.Length; End = $cp421Call.Index; Description = "CP420-to-CP421" }, [PSCustomObject]@{ Start = $cp421Call.Index + $cp421Call.Length; End = $cp422Call.Index; Description = "CP421-to-CP422" }, [PSCustomObject]@{ Start = $cp422Call.Index + $cp422Call.Length; End = $cp423Call.Index; Description = "CP422-to-CP423" }, [PSCustomObject]@{ Start = $cp423Call.Index + $cp423Call.Length; End = $cp424Call.Index; Description = "CP423-to-CP424" }, [PSCustomObject]@{ Start = $cp424Call.Index + $cp424Call.Length; End = $cp425Call.Index; Description = "CP424-to-CP425" }, [PSCustomObject]@{ Start = $cp425Call.Index + $cp425Call.Length; End = $cp426Call.Index; Description = "CP425-to-CP426" }, [PSCustomObject]@{ Start = $cp426Call.Index + $cp426Call.Length; End = $cp427Call.Index; Description = "CP426-to-CP427" }, [PSCustomObject]@{ Start = $cp427Call.Index + $cp427Call.Length; End = $cp428Call.Index; Description = "CP427-to-CP428" }, [PSCustomObject]@{ Start = $cp428Call.Index + $cp428Call.Length; End = $cp429Call.Index; Description = "CP428-to-CP429" }, [PSCustomObject]@{ Start = $cp429Call.Index + $cp429Call.Length; End = $cp430Call.Index; Description = "CP429-to-CP430" }, [PSCustomObject]@{ Start = $cp430Call.Index + $cp430Call.Length; End = $cp431Call.Index; Description = "CP430-to-CP431" }, [PSCustomObject]@{ Start = $cp431Call.Index + $cp431Call.Length; End = $cp432Call.Index; Description = "CP431-to-CP432" }, [PSCustomObject]@{ Start = $cp432Call.Index + $cp432Call.Length; End = $cp433Call.Index; Description = "CP432-to-CP433" }, [PSCustomObject]@{ Start = $cp433Call.Index + $cp433Call.Length; End = $cp434Call.Index; Description = "CP433-to-CP434" }, [PSCustomObject]@{ Start = $cp434Call.Index + $cp434Call.Length; End = $cp435Call.Index; Description = "CP434-to-CP435" }, [PSCustomObject]@{ Start = $cp435Call.Index + $cp435Call.Length; End = $cp436Call.Index; Description = "CP435-to-CP436" }, [PSCustomObject]@{ Start = $cp436Call.Index + $cp436Call.Length; End = $cp437Call.Index; Description = "CP436-to-CP437" }, [PSCustomObject]@{ Start = $cp437Call.Index + $cp437Call.Length; End = $cp438Call.Index; Description = "CP437-to-CP438" }, [PSCustomObject]@{ Start = $cp438Call.Index + $cp438Call.Length; End = $cp439Call.Index; Description = "CP438-to-CP439" }, [PSCustomObject]@{ Start = $cp439Call.Index + $cp439Call.Length; End = $cp440Call.Index; Description = "CP439-to-CP440" }, [PSCustomObject]@{ Start = $cp440Call.Index + $cp440Call.Length; End = $cp441Call.Index; Description = "CP440-to-CP441" }, [PSCustomObject]@{ Start = $cp441Call.Index + $cp441Call.Length; End = $numerical.Index; Description = "CP441-to-numerical" })) { $terminalCode = $body.Substring($terminalInterval.Start, $terminalInterval.End - $terminalInterval.Start); $terminalCode = [regex]::Replace($terminalCode, '(?s)/\*.*?\*/|(?m)//.*$', ''); if ($terminalCode -match '(?<![A-Za-z0-9_])(?:\b[A-Za-z_][A-Za-z0-9_:]*|\.[A-Za-z_][A-Za-z0-9_]*)!?\s*\(') { throw "No intermediary helper call may execute in the $($terminalInterval.Description) interval" } }
...
Assert-Contains -Path $cp345PipelineRoot -Pattern 'non_direct_runtime_rejects_cp316_through_cp441_lifecycle_evidence' -Description "pipeline cumulative non-direct CP362 firewall regression"
...
foreach ($audit in @(
    ...
    Assert-Contains -Path $audit -Pattern 'non_direct_runtime_rejects_cp316_through_cp441_lifecycle_evidence' -Description "historical non-direct firewall reaches CP362"
}
...
Assert-Contains -Path "specs\script_inventory.toml" -Pattern 'script_count = 379' -Description "CP345 cumulative inventory total through CP403"
...
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 379 \|' -Description "CP346 generated script total through CP403"
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| public scripts \| 240 \|' -Description "CP346 generated public script total"
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| 139 \|' -Description "CP346 generated internal script total through CP403"
Assert-Contains -Path "docs\src\generated\script-index.md" -Pattern '\| scripts without callers \| 0 \|' -Description "CP346 generated uncalled script total"
